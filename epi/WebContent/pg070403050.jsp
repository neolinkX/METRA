...
<html>
<%
  pg070403050CFG  clsConfig = new pg070403050CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070403050.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070403050.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  String cCveOrdenar  = "cDscServPrestado|";  // modificar
  String cDscFiltrar  = "Descripción|";    // modificar
  String cCveFiltrar  = "cDscServPrestado|";  // modificar
                            ...
                            <tr>
                              <td colspan="14" class="ETablaT">Accidentes Registrados</td>
                               ...
                               if (bs != null){
                                   ...
                                   out.print("</tr>");
                                   out.print("<tr>");
                                   out.print("<td class=\"ETablaT\">Servicio Prestado</td>");
                                   ...
                                   while(bs.nextRow()){
                                     ...
                                     if(!vAccidentes.isEmpty()){
                                       for(int i=0;i<vAccidentes.size();i++){
                                         ...
                                         if (VINVRegistro.getICveUniMed() == new Integer(bs.getFieldValue("iCveServPrestado", "").toString()).intValue()){
