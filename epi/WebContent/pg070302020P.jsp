  ...
  if (request.getParameter("opc") != null){
     ...
     switch(new Integer(request.getParameter("opc")).intValue()) {
        case 1:
           ...
           //int iModulo1 = Integer.parseInt(request.getParameter("val3"));
           ...
           out.println("form.iCveMotivo[0].text='';");
       ...
       if (vcModulo.size() > 0){
        ...
        Vector vcPersonal;
        //System.out.println("Médico REcolector: " + request.getParameter("val1") + "," + request.getParameter("val2") + "," + request.getParameter("val3"));
        int iCveProceso = Integer.parseInt(request.getParameter("val1"));
        ...
        int iModulo1 = Integer.parseInt(request.getParameter("val3"),10);
         vcPersonal = new TDGRLUMUsuario().getUniMedMod(iCveProceso,iUniMed,iModulo1);
           out.println("form = window.parent.parent.FRMCuerpo.FRMDatos.document.forms[0];");
       j = 0;
       if (vcPersonal.size() > 0){
           out.println("form.iCveUsuRecolec.length=1;");
           out.println("form.iCveUsuRecolec[0].text=" + "\"" + "Seleccione..." + "\"" + ";");
           out.println("form.iCveUsuRecolec[0].value=" + "\"0\"" + ";");
           for (int i = 0; i < vcPersonal.size(); i++){
              j = j + 1;
              vGRLUMUsuario = (TVGRLUMUsuario) vcPersonal.get(i);
              out.println("i=form.iCveUsuRecolec.length + 1;");
              out.println("form.iCveUsuRecolec.length=i;");
              out.println("form.iCveUsuRecolec[" + j  + "].text=" + "\"" + vGRLUMUsuario.getCNombre() + " " + vGRLUMUsuario.getCApPaterno() + " " + vGRLUMUsuario.getCApMaterno() + "\"" +";");
              out.println("form.iCveUsuRecolec[" + j + "].value="+ "\"" + vGRLUMUsuario.getICveUsuario()  + "\"" +";");
           }
        }else{
           out.println("form.iCveUsuRecolec.length=1;");
           out.println("form.iCveUsuRecolec[0].text=" + "\"" + "Datos no disponibles" + "\"" + ";");
           out.println("form.iCveUsuRecolec[0].value=" + "\"0\"" + ";");
        }
