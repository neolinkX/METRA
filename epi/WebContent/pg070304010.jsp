<%/**
 * Title: Analisis Confirmatorio del Modulo de Toxicologia.
 * Description: Generación de Lotes Confirmatorios.
...
<html>
<%
  pg070304010CFG  clsConfig = new pg070304010CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070304010.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070304010.jsp\" target=\"FRMCuerpo"); // modificar
  vEntorno.setUrlLogo("Acerca");
  vEntorno.setBtnPrincVisible(true);
  vEntorno.setArchFCatalogo("FFiltro");
  vEntorno.setArchAyuda(vEntorno.getNombrePagina());

  String cCatalogo    = "pg070304010.jsp";       // modificar
  ...
  function llenaSLT(opc,val1,val2,val3,objDes){
     if(objDes!=''){
        if(objDes.name!=''){
           ...
           window.parent.FRMOtroPanel.location="pg070304010P.jsp?opc=" + opc + "&val1=" + val1 + "&val2=" + val2 + "&val3=" + val3 + "&objDes=" + objDes.name + '&hdAccion=' + document.forms[0].action;
        } else {
  ...
  <tr>
      <td valign="top">
         ...
         <table border="1" class="ETablaInfo" align="center">
           <tr>
             <td colspan="9" class="ETablaT">Búsqueda del Lote Confirmatorio &sup1; </td>
           </tr><tr>
             ...
             <td class="ECampo">
                ...
                <% if (request.getParameter("SLSLoteConfirmativo") != null){
                    ...
                    if (cvLoteConfirmativo.compareToIgnoreCase("") == 0)
                       out.print("<option selected value=\"" + "0"  + "\">" + "Lote Nuevo" + "</option>");
                    else
...
&nbsp;
          <table border="1" class="ETablaInfo" align="center"><% // Inicio de Datos %>
            <tr>
              <td colspan="7" class="ETablaT">Confirmación de Presuntos Positivos</td>
            </tr>
            <tr>
             ...
             <% // modificar según listado
               ...
               if (bs != null){
                   ...
                   while(bs.nextRow()){
                     ...
                     if (bs.getFieldValue("lAsignado", "&nbsp;").toString().compareToIgnoreCase("0") == 0){
                       out.print(vEti.ToggleMov("ETablaC", "TBXSel-" + bs.getFieldValue("iAnio", "&nbsp;").toString()           + "-"
                       ...
                       out.print(vEti.CampoSinCelda("input",6,6,"FILDilucion-" + bs.getFieldValue("iAnio", "&nbsp;").toString()           + "-"
                                                                               + bs.getFieldValue("iCveLaboratorio", "&nbsp;").toString() + "-"
                                                                               + bs.getFieldValue("iCveLoteCualita", "&nbsp;").toString() + "-"
                                                                               + bs.getFieldValue("iCveExamCualita", "&nbsp;").toString() + "-"
                                                                               + bs.getFieldValue("iCveAnalisis", "&nbsp;").toString()    + "-"
                                                                               + bs.getFieldValue("iCveSustancia", "&nbsp;").toString()
                                 , dfNumber.format(new Double(bs.getFieldValue("dDilucion", "&nbsp;").toString())),3,"","",true,true));
                       out.print("</td>");
                     } else {
                       out.print(vEti.Texto("ETablaR", "Seleccionado"));
                       out.print(vEti.Texto("ETablaR", dfNumber.format(new Double(bs.getFieldValue("dDilucion", "&nbsp;").toString()))));
                     }
                     out.print("</tr>");
                   }
               }
