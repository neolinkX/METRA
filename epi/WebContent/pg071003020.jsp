...
<html>
<%
  pg071003020CFG  clsConfig = new pg071003020CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg071003020.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg071003020.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  String cAsignar    = "pg071003033.jsp";       // modificar
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
      ...
      <td valign="top">
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            <tr>
                              <td colspan="5" class="ETablaT">Áreas
                              </td>
                            </tr>
                               <%
                               ...
                               if (bs != null){
                                   ...
                                   while(bs.nextRow()){
                                     ...
                                     if(lDetalle){
                                       ...
                                       out.print(vEti.clsAnclaTexto("EAncla","Detalle","JavaScript:fIrDetalle('" + bs.getFieldValue("iCveArea") + "');", ""));
                                       out.print("</td>");
                                     }
                                     if(lAsignar){
                                       out.print("<td class=\"ECampo\">");
