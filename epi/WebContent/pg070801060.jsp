 ...
 * Description: Listado de Tipos de Movimiento
 * Copyright: 2004
...
<html>
<%
  pg070801060CFG  clsConfig = new pg070801060CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070801060.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070801060.jsp\" target=\"FRMCuerpo"); // modificar
  vEntorno.setUrlLogo("Acerca");
  vEntorno.setBtnPrincVisible(true);
  vEntorno.setArchFCatalogo("FFiltro");
  vEntorno.setArchAyuda(vEntorno.getNombrePagina());

  String cCatalogo    = "pg070801060.jsp";       // modificar
  String cDetalle     = "pg070801061.jsp";       // modificar
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
      ...
      <td valign="top">
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            ...
                            %>
                            <tr>
                              <td class="ETablaT" colspan="5">Tipos de Movimiento</td>
                            </tr>
                            <tr>
                            ...
                            %>
                                ...
                                while(bs.nextRow()){
                                    out.println("<tr>");
                                    out.print(vEti.Texto("ETabla",""+ bs.getFieldValue("iCveTpoMovimiento", "&nbsp;")));
                                    ...
                                    if (clsConfig.getLPagina(cDetalle)){
                                          ...
                                          out.print(vEti.clsAnclaTexto("EAncla","Detalle","JavaScript:fIrCatalogo('" + bs.getFieldValue("iCveTpoMovimiento","") + "'" + ");","Ir a..."));
                                          out.print("</td>");
                                     }
