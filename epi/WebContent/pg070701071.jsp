...
<html>
<%
  pg070701071CFG  clsConfig = new pg070701071CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setNombrePagina("pg070701071.jsp");                    // modificar
  vEntorno.setArchFuncs("FValida");
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070701071.jsp\" target=\"FRMCuerpo"); // modificar
...
<script language="JavaScript">
  ...
  //  al directorio funciones de wwwrooting en un archivo con extensión js (vg. pg070701071.js)
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                              <td colspan="6" class="ETablaT">Tipo de Mantenimiento
                               ...
                               if (lNuevo){ // Modificar de acuerdo al catálogo específico
                                 ...
                                 out.println("</tr>");
                                 out.println("<tr>");
                                 out.print(vEti.EtiCampo("EEtiqueta", "Descripción:", "ECampo", "text", 50, 50, "cDscTpoMantto", "", 3, "", "fMayus(this);", true, true, lCaptura));
                                 out.println("</tr>");
                                 out.println("<tr>");
                                 ...
                                 if (bs != null){
                                   ...
                                   out.println("</tr>");
                                   out.println("<tr>");
                                   out.print(vEti.EtiCampo("EEtiqueta", "Descripción:", "ECampo", "text", 50, 50, "cDscTpoMantto", ""+bs.getFieldValue("cDscTpoMantto", "&nbsp;"), 3, "", "fMayus(this);", true, true, lCaptura));
                                   out.println("</tr>");
                                   out.println("<tr>");
