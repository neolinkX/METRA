     ...
     switch(new Integer(request.getParameter("opc")).intValue()) {
        ...
        case 4:{
           if (request.getParameter("val1")!=null){
               ...
               Vector vExCuali = new Vector();
               vExCuali = DALMConcepto.FindByCustomWhere(" WHERE ALMConcepto.iCveTpoMovimiento = " + request.getParameter("val1") +
               ...
               if (vExCuali.size() > 0){
                  ...
                  for (int i = 0; i < vExCuali.size(); i++){
                           j = j + 1;
                     VALMConcepto = (TVALMConcepto) vExCuali.get(i);
                     out.println("i=form." + ObjetoDes + ".length + 1;");
                     out.println("form." + ObjetoDes + ".length=i;");
                     out.println("form." + ObjetoDes + "[" + j  + "].text=" + "\"" + VALMConcepto.getCDscConcepto() + "\"" +";");
                     out.println("form." + ObjetoDes + "[" + j + "].value="+ "\"" + VALMConcepto.getICveConcepto() + "\"" +";");
                  }
               }else{
                  out.println("form." + ObjetoDes + "[0].text=" + "\"" + "Seleccione..." + "\"" + ";");
                  out.println("form." + ObjetoDes + "[0].value=" + "\"0\"" + ";");
