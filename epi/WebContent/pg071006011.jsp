...
<script language="JavaScript">
  ...
  //  al directorio funciones de wwwrooting en un archivo con extensión js (vg. pg071006011.js)
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                              <td colspan="6" class="ETablaT">Requisito
                               ...
                               if (lNuevo){ // Modificar de acuerdo al catálogo específico
                                 ...
                                 out.println("<td class=\"EEtiqueta\">Descripción:<br><p class=\"EPieR\">Caract. disponibles:<br><input type=\"text\" size=\"5\" name=\"iNoLetras\" value=\"\" disabled></p></td>");
                                 out.println("<td>");
                                 ...
                                 out.println("<tr>");
                                 out.print(vEti.EtiCampo("EEtiqueta", "Descripción Breve:", "ECampo", "text", 75, 100, "cDscReqBreve", "", 3, "", "fMayus(this);", true, true, lCaptura));
                                 out.println("</tr>");
                                 ...
                                 if(request.getParameter("hdBoton").compareTo("Modificar")==0){
                                   ...
                                   out.print("<tr>");
                                   out.print(vEti.Texto("EEtiqueta", "Descripción:"));
                                   out.print("<td class='EEtiqueta'>");
                                 ...
                                 out.println("<tr>");
                                 out.print(vEti.EtiCampo("EEtiqueta", "Descripción Breve:", "ECampo", "text", 75, 100, "cDscReqBreve", ""+bs.getFieldValue("cDscReqBreve", "&nbsp;"), 3, "", "fMayus(this);", true, true, lCaptura));
                                 out.println("</tr>");
