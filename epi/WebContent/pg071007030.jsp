...
<html>
<%
  pg071007030CFG  clsConfig = new pg071007030CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();   
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg071007030.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg071007030.jsp\" target=\"FRMCuerpo"); // modificar
  vEntorno.setUrlLogo("Acerca");
  vEntorno.setBtnPrincVisible(true);
  vEntorno.setArchFCatalogo("FFiltro");
  vEntorno.setArchAyuda(vEntorno.getNombrePagina());

  String cDetalle    = "pg071007031.jsp";       // modificar
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
      ...
      <td valign="top">
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            <tr>
                              <td colspan="5" class="ETablaT">Procesos
                              </td>
                            </tr>
                               <%
                              // modificar según listado
                               if (bs != null){
                                   ...
                                   out.print("<tr>");
                                   out.print("<td class=\"ETablaT\">Ejercicio</td>");
                                   out.print("<td class=\"ETablaT\">Concepto</td>");
                                   out.print("<td class=\"ETablaT\">Referencia</td>");
                                   if(lDetalle)
                                   ...
                                   while(bs.nextRow()){
                                     out.print("<tr>");
                                     out.print(vEti.Texto("ETablaR", bs.getFieldValue("iEjercicio", "&nbsp;").toString()));
                                     out.print(vEti.Texto("ECampo", bs.getFieldValue("cDscConcepto", "&nbsp;").toString()));
                                     out.print(vEti.Texto("ECampo", bs.getFieldValue("iRefNumerica", "&nbsp;").toString()));
                                     if(lDetalle){
                                       out.print("<td class=\"ECampo\">");
                                       out.print(vEti.clsAnclaTexto("EAncla","Detalle","JavaScript:fIrDetalle('" + bs.getFieldValue("iCveProceso") + "');", ""));
                                       out.print("</td>");
                                     }
                                     out.print("</tr>");
                                   }
