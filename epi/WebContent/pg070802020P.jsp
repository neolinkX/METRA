...
*/
               vExCuali = DALMTpoArticulo.FindByCustomWhere(" where ALMTpoArticulo.lActivo = 1 " );
               ...
               if (vExCuali.size() > 0){
                  ...
                  for (int i = 0; i < vExCuali.size(); i++){
                     ...
                     out.println("i=form." + ObjetoDes + ".length + 1;");
                           ...
                           out.println("form." + ObjetoDes + "[" + j  + "].text=" + "\"" +  VALMTpoArticulo.getIIDPartida()  + "-" +VALMTpoArticulo.getCDscBreve() + "\"" +";");
