  ...
  if (request.getParameter("opc") != null){
     ...
     switch(new Integer(request.getParameter("opc")).intValue()) {
        ...
        case 3:
           ...
           vcEQMTpoEquipo = dEQMTpoEquipo.FindByAll(" where iCveClasificacion = " + request.getParameter("val1") + " "," order by iCveTpoEquipo ");
           out.println("form = window.parent.parent.FRMCuerpo.FRMDatos.document.forms[0];");
           if (vcEQMTpoEquipo.size()>0){
              ...
              for (int i = 0; i < vcEQMTpoEquipo.size(); i++){
                 ...
                 out.println("i=form." + ObjetoDes + ".length + 1;");
                 out.println("form." + ObjetoDes + ".length=i;");
                 out.println("form." + ObjetoDes + "[" + j  + "].text=" + "\"" + vEQMTpoEquipo.getCDscBreve() + "\"" +";");
                 out.println("form." + ObjetoDes + "[" + j + "].value="+ "\"" + vEQMTpoEquipo.getICveTpoEquipo() + "\"" +";");
              }
           }else{
              out.println("form." + ObjetoDes + ".length=1;");
              out.println("form." + ObjetoDes + "[0].text=" + "\"" + "Datos no disponibles" + "\"" + ";");
