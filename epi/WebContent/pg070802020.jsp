  ...
  <tr>
         ...
         <table border="1" class="ETablaInfo" align="center">
           ...
           <tr>
             ...
             <td class="ECampo"><%=  new TCreaBoton().clsCreaBoton(vEntorno, 3, "Buscar",
                              ...
                              "Buscar los Artículos","javascript:fSubmitForm1('Buscar');", vParametros) %></td>
           </tr>
         </table>
      </td>
      </tr>
      ...
      <td valign="top">
                          <table border="1" class="ETablaInfo" align="center"><% // Inicio de Datos %>
                             ...
                             %>
                            <tr>
                              <td colspan="7" class="ETablaT">Artículos por Almacén</td>
                            </tr>
                            <tr>
                             ...
                             <% // modificar según listado
                               ...
                               if (bs != null){
                                   ...
                                   while(bs.nextRow()){
                                        ...
                                        for (int i=0;i<vAlmxArt.size();i++) {
                                           ...
                                           if (new Integer(VALMArtxAlm.getiCveArticulo()).toString().compareToIgnoreCase(bs.getFieldValue("iCveArticulo", "&nbsp;").toString()) == 0){
                                              if (VALMArtxAlm.getdExistencia() == 0){
                                                 out.print(vEti.ToggleMov("ETablaC", "TBXSel-" + bs.getFieldValue("iCveArticulo", "&nbsp;").toString(),"1" ,"", 59, true, "Sí", "No", true));
                                                 lHabilitado = true;
                                              }
                                              else {
                                                 out.print(vEti.ToggleMov("ETablaC", "TBXSel-" + bs.getFieldValue("iCveArticulo", "&nbsp;").toString(),"1" ,"", 59, true, "Sí", "No", false)); // era false.
                                     ...
                                     if (!lPinto){
                                        out.print(vEti.ToggleMov("ETablaC", "TBXSel-" + bs.getFieldValue("iCveArticulo", "&nbsp;").toString(),"0" ,"", 59, true, "Sí", "No", true));
                                        lHabilitado = true;
                                     }
                                     if (lHabilitado)
                                   ...
                                   out.print(vEti.Texto("ETablaR", dfNumber.format(new Double(dvExistencia))));
                                    if (!vUbicacion.isEmpty()){
                                      for (int i=0;i<vUbicacion.size();i++){
                                        ...
                                        if (new Integer(VALMUbicacion.getiCveArticulo()).toString().compareToIgnoreCase(bs.getFieldValue("iCveArticulo", "&nbsp;").toString()) == 0 &&
                                            !lPinto2){
                                          out.print("<td class=\"ECampo\">");
                                          out.print(vEti.clsAnclaTexto("EAncla","Área y Sección Asignada","JavaScript:fListado('" + bs.getFieldValue("iCveArticulo","") + "'" + ");",""));
                                          out.print("</td>");
                                          out.print("</tr>");
                                          lPinto2 = true;
                                        }
                                    ...
                                    if (!lPinto2) {
                                      if (!lPinto)
                                        ...
                                        out.print("<td class=\"ECampo\">");
                                        out.print(vEti.clsAnclaTexto("EAncla","Sin Ubicación","JavaScript:fListado('" + bs.getFieldValue("iCveArticulo","") + "'" + ");",""));
                                        out.print("</td>");
                                        out.print("</tr>");
                                      }
                                   }
