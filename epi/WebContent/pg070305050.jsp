...
<html>
<%
  pg070305050CFG  clsConfig = new pg070305050CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070305050.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070305050.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  <tr>
     <td valign="top">
        <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
          <tr><td colspan="8" class="ETablaT">B&uacute;squeda del Lote Cualitativo</td></tr>
          ...
          <tr>
             <%
                  ...
                  out.println(vEti.EtiCampo("EEtiqueta","Número de Examen:", "ETabla\" colspan=\"2","text",4,4,"iCveExamCualita","",0,"","",true,true, true, request));
             %></tr>
            <tr><%
      ...
      <td valign="top">&nbsp;
                          ...
                          <% if (bs != null){ %>
                            <tr>
                              ...
                              <td class="ETablaT">Analizado</td>
                              <td class="ETablaT">Autorizado</td>
                              <td class="ETablaT">Muestras</td>
                              <td class="ETablaT" colspan="2">Muestras</td>
                            </tr>
                             ...
                             for(int i=0; i < clsConfig.VRegistros.size(); i++){
                                ...
                                out.print(vEti.Texto("ETablaR",  String.valueOf(Lote.VECualita.getICveExamCualita() )));
                                out.print(vEti.Texto("ETablaC",  Lote.getDtGeneracion()           != null? Fecha.getFechaDDMMYYYY(Lote.getDtGeneracion(),"/") : "-" ));
                                out.print(vEti.Texto("ETablaC",  Lote.VECualita.getDtEntrega()    != null? Fecha.getFechaDDMMYYYY(Lote.VECualita.getDtEntrega(),   "/") : "-" ));
                                out.print(vEti.Texto("ETablaC",  Lote.VECualita.getDtProcesado()  != null? Fecha.getFechaDDMMYYYY(Lote.VECualita.getDtProcesado(), "/") : "-" ));
                                out.print(vEti.Texto("ETablaC",  Lote.VECualita.getDtAutorizado() != null? Fecha.getFechaDDMMYYYY(Lote.VECualita.getDtAutorizado(),"/") : "-" ));
                                out.print(vEti.Texto("ETablaR",  String.valueOf(Lote.getIAnalizados())));
                                out.print("<td class=\"ETabla\">");
                                out.print(vEti.clsAnclaTexto("EAncla","Detalle","JavaScript:fIrpagina('" + Lote.VECualita.getIAnio() + "', '" + Lote.VECualita.getICveLaboratorio() + "', '" + Lote.VECualita.getICveLoteCualita() + "', '" + Lote.VECualita.getICveExamCualita() + "', 'pg070305051.jsp');", ""));
                                out.print("</td>");
                                out.print("</tr>");
                             }
                            %>
