...
<%
  ...
  vEntorno.setNombrePagina("pg070101010.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070101010.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
      ...
      <td valign="top">
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            <tr>
                              <td colspan="6" class="ETablaT">Especialidades
                              </td>
                            </tr>
                             <% // modificar según listado
                               ...
                               if (bs != null){
                                   ...
                                   out.print("<td class=\"ETablaT\" colspan=\"4\">Activo</td>");
                                   out.print("</tr>");
                                   bs.start();
                                   while(bs.nextRow()){
                                     out.print("<tr>");
                                     out.print(vEti.Texto("ETablaR", bs.getFieldValue("iCveEspecialidad", "&nbsp;").toString()));
                                     out.print(vEti.Texto("ETabla", bs.getFieldValue("cDscEspecialidad", "&nbsp;").toString()));
                                     ...
                                     if(lDetalle){
                                       ...
                                       out.print(vEti.clsAnclaTexto("EAncla","Detalle","JavaScript:fIrDetalle('" + bs.getFieldValue("iCveEspecialidad") + "');", ""));
                                       out.print("</td>");
                                     }
                                     if(lDiagnostico){
                                       out.print("<td class=\"ETabla\">");
                                       out.print(vEti.clsAnclaTexto("EAncla","Diagnóstico","JavaScript:fIrDiagnostico('" + bs.getFieldValue("iCveEspecialidad") + "');", ""));
                                       out.print("</td>");
                                     }
                                     if(lRecomendacion){
                                       out.print("<td class=\"ETabla\">");
