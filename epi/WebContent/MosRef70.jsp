<%-- 
    Document   : MosRef70
    Created on : 14/05/2012, 09:45:14 PM
    Author     : AG
--%>
...
if(request.getParameter("iorden") != null){
  ...
  String condicion = " ICVEEXPEDIENTE = "+expediente+" AND INUMEXAMEN = "+examen+" AND ICVEDOCUMENTO = 1 AND ICVESERVICIO = "+servicio+" AND ICVERAMA = "+rama+" and iorden = "+request.getParameter("iorden")+"";
  try {
...
%>                   
            ...
            <form name="formulario" method="post" action="MosRef70.jsp">
                    ...
                    <input type="hidden" name="iorden" value="<%=request.getParameter("iorden")%>">
                        ...
                        <img src="<%=vParametros.getPropEspecifica("RutaImgServer")%>torax.jpg" alt="torax" name="torax" id="torax"
...
<%
      ...
      Vector resultados = new Vector();
        ...
        String condicion = " ICVEEXPEDIENTE = "+expediente+" AND INUMEXAMEN = "+examen+" AND ICVEDOCUMENTO = 1 AND ICVESERVICIO = "+servicio+" " ;
        try {
                resultados = dEXPSERVPRef.FindByAll(condicion);
        }
        catch (Exception e) {
           ...
           <script> 
            ...
            <body bgcolor="" topmargin="0" leftmargin="0" >
                <form name="formulario" method="post" action="MosRef70.jsp">
                    ...
                    <table width="400" border="1">
                    <tr>
                        <td bgcolor="#088A08"><span class="Estilo6">Consulta de puntos de referencia de Tórax</span><br></td>
                    </tr>
                    <%
                    for(int i=0;i<resultados.size();i++){
                        vEXPSERVPRef = (TVEXPSERVPRef) resultados.get(i);
