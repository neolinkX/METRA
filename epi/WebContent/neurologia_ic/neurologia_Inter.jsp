      ...
      <div class="m-portlet__head-caption">
         <div class="m-portlet__head-title">
            <span class="m-portlet__head-icon">
              <img src="<%=vParametros.getPropEspecifica("RutaImgServerExp")%>interconsultas/neuro2.svg" width="20" class="svg-inject signal-strong">
            </span>
...
<%@ include file="/neurologia_ic/preguntasNeurologia_ic.jsp"%>
  </div>
