...
<% //Variables
  ...
  TDEXPSERVPRef dEXPSERVPRef = new TDEXPSERVPRef();
           ...
           if(request.getParameter("hx1") != null){
               ...
               <%}else{ %>
                           alert("El punto de referencia de aputación de mano derecha ha sido guardado exitosamente\n");
                   <%}%>
                            window.close();
                    }    
...
%>               
            ...
            function fCerrar(){
                    form = document.forms[0];
                    cVMsg = '';
                    alert("El punto de referencia de amputacion de mano derecha ha sido guardado\n");
                    window.close();
            }    
            ...
            <tr bgcolor="#088A08">
                <td width="572"><div align="center"><span class="Estilo4">AMPUTACI&Oacute;N DE MANO DERECHA</span></div></td> 
            </tr>
            <tr bgcolor="#FBFBEF">
                <td><div align="justify" class="Estilo3">AMPUTACI&Oacute;N DE MANO DERECHA: EN EL DIBUJO SE DETERMINARÁ EL LUGAR EN DÓNDE SE ENCUENTRA UBICADA LA ALTERACI&Oacute;N O ANORMALIDAD ENCONTRADA, UNA VEZ QUE SEA SELECCIONADA EN AUTOM&Aacute;TICO EL SISTEMA DETERMINAR&Aacute; LAS COORDENADAS ANAT&Oacute;MICAS.</div></td>
            </tr>
            </table>
            <br>  
            ...
            <div style="float: left; width: 67%;">
                ...
                <img src="<%=vParametros.getPropEspecifica("RutaImgServer")%>ManoD.jpg" width="349" height="401" id="photo" />    </div>
            </div>
            ...
            <div style="float: left; width: 32%;">
                ...
                <div id="preview" style="width: 100px; height: 100px; overflow: hidden;">
                    <img src="<%=vParametros.getPropEspecifica("RutaImgServer")%>ManoD.jpg" style="width: 100px; height: 100px;" />
                </div>
                </div>

                <table style="margin-top: 1em;">
                <form name="formulario" method="post" action="CapRef54AMD.jsp">
                <thead>
                    <tr>
