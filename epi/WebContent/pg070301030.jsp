...
<html>
<%
  pg070301030CFG  clsConfig = new pg070301030CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070301030.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070301030.jsp\" target=\"FRMCuerpo"); // modificar
  vEntorno.setUrlLogo("Acerca");
  vEntorno.setBtnPrincVisible(true);
  vEntorno.setArchFCatalogo("FFiltro");
  vEntorno.setArchAyuda(vEntorno.getNombrePagina());

  String cCatalogo    = "pg070301031.jsp";       // modificar
                             ...
                             <% // modificar según listado
                               if (bs != null){
                                 ...
                                 <tr>
                                   ...
                                   <td class="ETablaT">Descripción del Tipo</td>
                                  <td class="ETablaT" colspan="2">Descripción del Motivo</td>
                                 </tr>
                                   <%
                                   bs.start();
                                   while(bs.nextRow()){
                                     out.print("<tr>");
                                     out.print(vEti.Texto("ETablaR", bs.getFieldValue("iCveMotRecep", "&nbsp;").toString()));
                                     ...
                                     out.print(vEti.Texto("ETabla", bs.getFieldValue("cDscMotRecep", "&nbsp;").toString()));
                                     if (clsConfig.getLPagina(cCatalogo)){
                                       out.print("<td class=\"ECampo\">");
                                       out.print(vEti.clsAnclaTexto("EAncla","Detalle","JavaScript:fIrCatalogo('" + bs.getFieldValue("iCveMotRecep", "") + "', '" + bs.getFieldValue("iCveMotRecep", "") + "', 'pg070301031.jsp');", "Ir a..."));
                                       out.print("</td>");
                                     }
                                     out.print("</tr>");
                                   }
