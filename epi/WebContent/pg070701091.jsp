...
<html>
<%
  pg070701091CFG  clsConfig = new pg070701091CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setNombrePagina("pg070701091.jsp");                    // modificar
  vEntorno.setArchFuncs("FValida");
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070701091.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  String cCveOrdenar  = "iCveEtapaSolic|cDscEtapaSolic|iOrden|";  // modificar
  String cDscFiltrar  = "Clave|Descripción|Orden|";    // modificar
  String cCveFiltrar  = "iCveEtapaSolic|cDscEtapaSolic|iOrden|";  // modificar
...
<script language="JavaScript">
  ...
  //  al directorio funciones de wwwrooting en un archivo con extensión js (vg. pg070701091.js)
...
<form method="<%= vEntorno.getMetodoForm() %>" action="<%= vEntorno.getActionForm() %>">
  ...
  <%
     if (bs != null){ // Agregar tanto Hds como variables dependiendo del campo llave.
       ...
       cClave  = ""+bs.getFieldValue("iCveEtapaSolic", "");
     }
  %>
  ...
  <input type="hidden" name="iCveEtapaSolic" value="<%=cClave%>">
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                              <td colspan="6" class="ETablaT">Etapa de Solicitud
                              </td>
                               <%
                               if (lNuevo){ // Modificar de acuerdo al catálogo específico
                                 ...
                                 out.println("</tr>");
                                 out.println("<tr>");
                                 out.print(vEti.EtiCampo("EEtiqueta", "Descripción:", "ECampo", "text", 50, 100, "cDscEtapaSolic", "", 3, "", "fMayus(this);", true, true, lCaptura));
                                 out.println("</tr>");
                                 out.println("<tr>");
                                 ...
                                 if (bs != null){
                                   out.println("<tr>");
                                   out.print(vEti.EtiCampo("EEtiqueta", "Clave:", "ECampo", "text", 4, 4, "iCveEtapaSolic", ""+bs.getFieldValue("iCveEtapaSolic", "&nbsp;"), 3, "", "", true, true, false));
                                   out.println("</tr>");
                                   out.println("<tr>");
                                   out.print(vEti.EtiCampo("EEtiqueta", "Descripción:", "ECampo", "text", 50, 100, "cDscEtapaSolic", ""+bs.getFieldValue("cDscEtapaSolic", "&nbsp;"), 3, "", "fMayus(this);", true, true, lCaptura));
                                   out.println("</tr>");
                                   out.println("<tr>");
