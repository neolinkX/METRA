...
session.setAttribute("servicio","10");    /////////////////////////MODIFICAR LA CLAVE DEL SERVICIO (TABLA MEDSERVICIO)/////////////////////////////////////////////
  ...
  <div class="m-portlet__head" style="background:#f7f8fa">
     <div class="m-portlet__head-caption">
       <div class="m-portlet__head-title">
          ...
          <img src="img/interconsultas/cardiologia.svg" width="20" class="svg-inject signal-strong">
          </span>
          <h3 class="m-portlet__head-text m--font-primary">
             Gabinete Cardiolog&iacute;a
          </h3>
       </div>
     </div>
...
%>
  ...
  <div class="form-group m-form__group">
      <button type="button" id="electrocardiograma" class="btn btn-primary">
         Electrocardiograma
      </button>
      <button type="button" id="interpretacion" class="btn btn-primary">
         Interpretaci&oacute;n
      </button>
  </div>
  <div id="contCardiologia"></div>
</div>

<script>
   var episodio = $('#id_episodio_left').val();
   $("#electrocardiograma").click(function(){ carga_archivo('contCardiologia','cardiologia/PreguntasCardiologia.jsp?hdrama=1'); });
   $("#interpretacion").click(function(){ carga_archivo('contCardiologia','cardiologia/PreguntasCardiologia.jsp?hdrama=2'); });   
</script>
