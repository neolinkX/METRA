...
<html>
<%
  pg070101101CFG  clsConfig = new pg070101101CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setNombrePagina("pg070101101.jsp");                    // modificar
  vEntorno.setArchFuncs("FValida");
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070101101.jsp\" target=\"FRMCuerpo"); // modificar
...
<!--<SCRIPT LANGUAGE="JavaScript" SRC="C:\sct\MedprevInt\medprev\Archivos\funciones\pg070101101.js"></SCRIPT>-->
...
<form method="<%= vEntorno.getMetodoForm() %>" action="<%= vEntorno.getActionForm() %>">
  ...
  <input type="hidden" name="iCveMdoTrans2" value="<% if (request.getParameter("iCveMdoTrans2") != null) out.print(request.getParameter("iCveMdoTrans2"));%>">
  <input type="hidden" name="iCveCategoria2" value="<% if (request.getParameter("iCveCategoria2") != null) out.print(request.getParameter("iCveCategoria2"));%>">
  <%
     ...
     if (bs != null){ // Agregar tanto Hds como variables dependiendo del campo llave.
       ...
       //System.out.println(bs.getFieldValue("iCveServicio",""));
       //System.out.println(bs.getFieldValue("iCveRama",""));
       //System.out.println(bs.getFieldValue("iCveSintoma",""));
     }
 ...
 %>
  ...
  <input type="hidden" name="hdRama" value="<%if(cClave.compareTo("")==0) out.print(request.getParameter("iCveRama")); else out.print(cClave);%>">
   -->
   <input type="hidden" name="iCveSintoma" value="<%if(request.getParameter("hdSintoma")!=null) out.print(request.getParameter("hdSintoma")); else out.print(cClave);%>">
  <input type="hidden" name="hdSintoma" value="<%if(request.getParameter("hdSintoma")!=null) out.print(request.getParameter("hdSintoma")); else out.print(cClave);%>">
  <input type="hidden" name="hdServicio" value="<%if(request.getParameter("iCveServicio")!=null) out.print(request.getParameter("iCveServicio")); else out.print(cClave);%>">
  <input type="hidden" name="hdServicio2" value="<%if(request.getParameter("hdCampoClave")!=null) out.print(request.getParameter("hdCampoClave")); else out.print(cClave);%>">
  <input type="hidden" name="hdRama" value="<%if(request.getParameter("iCveRama")!=null) out.print(request.getParameter("iCveRama")); else out.print(cClave);%>">
  <input type="hidden" name="iCveSintoma2" value="<%if(request.getParameter("iCveSintoma")!=null) out.print(request.getParameter("iCveSintoma")); else out.print(cClave);%>">
  ...
  <input type="hidden" name="iCveRegla" value="<%if(cClave.compareTo("")==0) out.print(request.getParameter("iCveRegla")); else out.print(cClave);%>">
  ...
  -->
  <input type="hidden" name="lLogica" value="<%if(request.getParameter("lLogica")!=null) out.print(request.getParameter("lLogica")); else out.print(cClave);%>">
  <input type="hidden" name="lLogico" value="<%if(request.getParameter("lLogica")!=null) out.print(request.getParameter("lLogica")); else out.print(cClave);%>">
  <input type="hidden" name="iCveRegla" value="<%if(request.getParameter("iCveRegla")!=null) out.print(request.getParameter("iCveRegla")); else out.print(cClave);%>">
  <input type="hidden" name="iCveTpoResp" value="<%if(request.getParameter("iCveTpoResp")!=null) out.print(request.getParameter("iCveTpoResp")); else out.print(cClave);%>">
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                              <tr>
                              <td colspan="4" class="ETablaT">Configuración de la Regla
                              </td>
                            </tr>
                            <%
                            ...
                            <% 
                                           ...
                                           /* 
                                            ...
                                            out.println("<tr>");
                                            out.println(vEti.EtiAreaTextoCS("EEtiqueta","Leyenda de alerta:","ECampo",50,5,5,"cAlerta","",0,"","",false,true,lCaptura));
                                            ...
                                            //out.println(vEti.EtiAreaTextoCS("EEtiqueta","Descripcion de la alerta:","ECampo",50,5,5,"cdscRegla","",0,"","",false,true,lCaptura));
                                            //out.print(vEti.EtiCampoCS("EEtiqueta","Descripcion de la alerta","ECampo","text",300,300,4,"cdscRegla", "",0,"","",false,true,lCaptura));
                                            out.println("</tr>");
 ...
 *                                                      */
                                                     ...
                                                     %>
                                                        ...
                                                        <%
                                                        out.println("<tr>");
                                                        out.println("<td colspan=\"4\" class=\"ETablaT\">SELECCIONA LOS SERVICIOS QUE SE HABILITARAN A CONSECUENCIA DE LA REGLA PARA APLICAR INTERCONSULTA.");
                                                        out.println("</td>");
                                                        out.println("</tr>");

                                                        out.println("<tr>");
                                                        out.println("<td colspan=\"1\" class=\"ETablaT\">Servicios");
                                                        out.println("</td>");
                                                        out.println("<td colspan=\"1\" class=\"ETablaT\"> ");
                                                        out.println("</td>");
                                                        out.println("<td colspan=\"1\" class=\"ETablaT\">Servicios habilitados para interconsulta.");
                                                        out.println("</td>");
                                                        out.println("</tr>");
                                                        ...
                                                        String SQLS = "	where lactivo = 1 ";
                                                        String ORDS = " order by cDscServicio ";
                                                        try{
                                                                vcMEDServicio = dMEDServicio.FindByAll(SQLS, ORDS);
                                                        }catch(Exception e){
                                                                vcMEDServicio  = new Vector();
                                                        }

                                                        if(vcMEDServicio.size() > 0)
                                                         //Imprimimos Servicios
                                                              out.println("<td class=\"ECampo\"  colspan=\"1\" >");
                                                              out.println("<SELECT id=\"LServicio\" size=\"10\" multiple> ");

                                                                for(int i = 0;i < vcMEDServicio.size(); i++){
                                                                        vMEDServicio = (TVMEDServicio) vcMEDServicio.get(i);
                                                                        out.println("<OPTION value=\""+vMEDServicio.getICveServicio()+"\">");
                                                                        out.println(vMEDServicio.getCDscServicio());
                                                                        out.println("</OPTION>");
                                                                }
                                                                out.println("</SELECT>");
                                                                out.println("</TD>");

                                                                out.println("<td class=\"ECampo\"  colspan=\"1\" valign=\"center\">");
                                                                out.println("<a href=\"#\" onclick=\"listbox_moveacross('LServicio', 'HServicio')\">&gt;&gt;</a>");
                                                                out.println("<br/>");
                                                                out.println("<a href=\"#\" onclick=\"listbox_moveacross('HServicio', 'LServicio')\">&lt;&lt;</a>");
                                                                out.println("</td>");


                                                                out.println("<td class=\"ECampo\"  colspan=\"1\" >");
                                                                out.println("<SELECT id=\"HServicio\" size=\"10\" multiple> ");
                                                                out.println("</SELECT>");
                                                                out.println("</TD>");
                                       ...
                                       %>
                                           <!--    </tr> -->
                                                        ...
                                                        <%
                                                        out.println("<tr>");
                                                        out.println("<td colspan=\"4\" class=\"ETablaT\">SELECCIONE LAS CATEGORÍAS A LAS QUE APLICARA LA REGLA");
                                                        out.println("</td>");
                                                        out.println("</tr>");

                                                        out.println("<tr>");
                                                        out.println("<td colspan=\"1\" class=\"ETablaT\">Modo de Transporte");
                                                        out.println("</td>");
                                                        out.println("<td colspan=\"1\" class=\"ETablaT\">Categorías");
                                                        out.println("</td>");
                                                        out.println("<td colspan=\"1\" class=\"ETablaT\"> ");
                                                        out.println("</td>");
                                                        out.println("<td colspan=\"1\" class=\"ETablaT\">Categorías a las que se aplicara la Regla");
                                                        out.println("</td>");
                                                        out.println("</tr>");
                                                        ...
                                                        int Trans = 0;
                                                        try{
                                                                vcGRLMdoTrans = dGRLMdoTrans.findByAll(SQLT, ORDT);
                                                        }catch(Exception e){
                                                                vcGRLMdoTrans  = new Vector();
                                                        }
                                                        ...
                                                        if(vcGRLMdoTrans.size() > 0)
                                                            for(int i = 0;i < vcGRLMdoTrans.size(); i++){
                                                               ...
                                                               vGRLMdoTrans = (TVGRLMdoTrans) vcGRLMdoTrans.get(i);
                                                                ...
                                                                String ORDC = "";
                                                                try{
                                                                        vcGRLCategoria = dGRLCategoria.FindByAll(vGRLMdoTrans.getCICveMdoTrans());
                                                                }catch(Exception e){
                                                                        vcGRLCategoria  = new Vector();
                                                                }
                                                         //Imprimimos el modo de transporte
                                                              out.println(vEti.Texto("EEtiqueta",""+vGRLMdoTrans.getCDscMdoTrans()+":"));
                                                              out.println("<td class=\"ECampo\"  colspan=\"1\" >");
                                                              out.println("<SELECT id=\"TI"+vGRLMdoTrans.getCDscMdoTrans()+"\" size=\"10\" multiple> ");

                                                                for(int j = 0;j < vcGRLCategoria.size(); j++){
                                                                        vGRLCategoria = (TVGRLCategoria) vcGRLCategoria.get(j);
                                                                        out.println("<OPTION value=\""+vGRLCategoria.getICveCategoria()+"\">");
                                                                        out.println(vGRLCategoria.getCDscCategoria());
                                                                        out.println("</OPTION>");
                                                                }
                                                                out.println("</SELECT>");
                                                                out.println("</TD>");
                                                                ...
                                                                out.println("<td class=\"ECampo\"  colspan=\"1\" valign=\"center\">");
                                                                out.println("<a href=\"#\" onclick=\"listbox_moveacross('TI"+vGRLMdoTrans.getCDscMdoTrans()+"', 'TH"+vGRLMdoTrans.getCDscMdoTrans()+"')\">&gt;&gt;</a>");
                                                                out.println("<br/>");
                                                                out.println("<a href=\"#\" onclick=\"listbox_moveacross('TH"+vGRLMdoTrans.getCDscMdoTrans()+"', 'TI"+vGRLMdoTrans.getCDscMdoTrans()+"')\">&lt;&lt;</a>");
                                                                out.println("</td>");


                                                                out.println("<td class=\"ECampo\"  colspan=\"1\" >");
                                                                out.println("<SELECT id=\"TH"+vGRLMdoTrans.getCDscMdoTrans()+"\" size=\"10\" multiple> ");
                                                                /*for(int j = 0;j < vcGRLCategoria.size(); j++){
                                                                        vGRLCategoria = (TVGRLCategoria) vcGRLCategoria.get(j);
                                                                        out.println("<OPTION value=\"TC-"+vGRLMdoTrans.getCDscMdoTrans()+"-"+vGRLCategoria.getICveCategoria()+"-\">");
                                                                        out.println(vGRLCategoria.getCDscCategoria());
                                                                        out.println("</OPTION>");
                                                                }*/
                                                                out.println("</SELECT>");
                                                               ...
                                                               Trans = vGRLMdoTrans.getICveMdoTrans();
                                                               out.println("</td>");
                                                               out.println("</tr>");
                                                            }
                                       %>
                                ...
                                if(bs.getFieldValue("Logica").equals("1")){
                                    ...
                                    out.println("<tr>");
                                    out.print(vEti.EtiCampoCS("EEtiqueta","Leyenda de alerta:","ECampo","text",10,10,4,"cAlerta", bs.getFieldValue("cAlerta","&nbsp;").toString(),0,"","fMayus(this);",false,true,false));
                                    out.println("</tr>");
/*
                                    out.println("<tr>");
                                    out.print(vEti.EtiCampoCS("EEtiqueta","Descripcion de la alerta:","ECampo","text",10,10,4,"cdscRegla", bs.getFieldValue("cdscRegla","&nbsp;").toString(),0,"","fMayus(this);",false,true,false));
                                    out.println("</tr>");
  */                                  
