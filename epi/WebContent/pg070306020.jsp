...
<%
  ...
  String cDscOrdenar  = "Clave|Descripción Breve|Lote|Tipo Calibrador|Fecha de Preparación|";    // modificar
  String cCveOrdenar  = "C.iCveCtrolCalibra|C.cDscBreve|C.cLote|C.iCveEmpleoCalib|C.dtPreparacion|";  // modificar
  String cDscFiltrar  = "Clave|Descripción Breve|Lote|Fecha de Preparación|Fecha de Autorización|";    // modificar
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            ...
                            <%
                               if (bs != null){
                                  ...
                                  out.println("<td class=\"ETablaT\">Preparación</td>");
                                  out.println("<td class=\"ETablaT\">Autorización</td>");
                                  out.println("<td class=\"ETablaT\">Situación</td>");
