...
<%
	...
	String CodigoValida = "";
	session.setAttribute("servicio", "54");
	String cRama = "1";
   ...
   <div class="m-portlet__body">
				...
				<div class="form-group m-form__group row">
					<%
								...
								if (contadortipodiv >= 0) {
									System.out.println("-1Sintoma = " + vEXPResultados.getICveSintoma() + " Dato = "
											+ vEXPResultados.getICveTpoResp());

									if (vEXPResultados.getICveTpoResp() == 1) {
										seagrego = true;
										System.out.println("vEXPResultados.getICveTpoResp() ="+vEXPResultados.getICveTpoResp() );
					%>
	...
	<%
									...
									if (vEXPResultados.getICveTpoResp() == 3) {
										System.out.println("-3 vEXPResultados.getICveTpoResp() ="+vEXPResultados.getICveTpoResp() );
					%>
						<!-- <label for="int_fiebre" class="col-3 col-form-label"> <%=vEXPResultados.getCPregunta()%>
						</label> 
						    <div class="col-2">
					        ...
					        -->
							  ...
							  <div class="form-group m-form__group row">
							    ...
							    <div class="col-5">
							        <input type="number" step="0.01" class="form-control m-input" id="<%=CampoFinal%>" name="<%=CampoFinal%>">
