...
<%@ include file="/persona/datosServicios.jsp"%>
   ...
   <form id="frm_interrogatorio13" name="frm_interrogatorio" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed">
...
function guarda_signos_vitales(){
  ...
  modalConfirm(function (){
    $.ajax({
        ...
        type: 'POST',
        data: $("#frm_interrogatorio13").serialize(),
        dataType: 'json',
