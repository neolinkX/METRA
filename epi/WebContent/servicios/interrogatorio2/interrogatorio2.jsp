           ...
           <div class="col-3">
              <ul class="nav nav-pills flex-column m-tabs-line--2x m-tabs-line--primary" role="tablist">
                 <li class="nav-item m-tabs__item">
                    <a class="nav-link active load_tab_content" data-toggle="tab" data-container="interroga_1" data-url_content="historiaclinica/interrogatorioSintomas" href="#interroga_1">1. Síntomas generales</a>
                      
                 </li>
                 <li class="nav-item m-tabs__item">
                    <a class="nav-link load_tab_content"  data-toggle="tab" data-container="interroga_2" data-url_content="historiaclinica/interrogatorioOjos" href="#interroga_2">2. Ojos y visión</a>
                 </li>
                 <li class="nav-item m-tabs__item">
                    <a class="nav-link load_tab_content" data-toggle="tab" data-container="interroga_3" data-url_content="historiaclinica/interrogatorioOidosAudicion" href="#interroga_3">3. Oídos y audición</a>
                 </li>
                 <li class="nav-item m-tabs__item">
                 ...
                 <li class="nav-item m-tabs__item">
                    <a class="nav-link load_tab_content" data-toggle="tab" data-container="interroga_12" data-url_content="historiaclinica/interrogatorioHema" href="#interroga_12">12. Hematopoyético</a>
                 </li>
                 <li class="nav-item m-tabs__item">
                    <a class="nav-link load_tab_content" data-toggle="tab" data-container="interroga_13" data-url_content="historiaclinica/interrogatorioMusculo" href="#interroga_13">13. Musculoesquelético</a>
                 </li>
                 <li class="nav-item m-tabs__item">
                    <a class="nav-link load_tab_content" data-toggle="tab" data-container="interroga_14" data-url_content="historiaclinica/interrogatorioNeuro" href="#interroga_14">14. Neurológicos</a>
                 </li>
                 <li class="nav-item m-tabs__item">
