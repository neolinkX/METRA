...
<%
  ...
  vEntorno.setNombrePagina("pg070104021.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070104021.jsp\" target=\"FRMCuerpo"); // modificar
...
// Fin de Despliegue
                                   out.print("<tr>");
                                   out.print("<td class='ETablaT' colspan='4'>Diagnósticos</td>");
                                   out.print("</tr>");
                                   ...
                                   out.print("<tr>");
                                   out.print("<td class='ETablaT' colspan='4'>Nota Médica</td>");
                                   out.print("</tr>");
