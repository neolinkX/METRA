<% /**
 * Title:         Registro y Comportamiento del Reactivo y Soluciones para Análisis Presuntivo
 * Description:   Reporte
 * Copyright:     2006
...
<html>
<%
  pg0703060150CFG  clsConfig = new pg0703060150CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg0703060150.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg0703060150.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  function generaXLS(tipo) {
    ...
    if (lICveLaboratorio == true &&
        ...
        if (tipo == 1) {
            ...
            " <body>"+
            "<form method=\"post\" action=\"servXLSpg0703060150?iCveLaboratorio=" + form.iCveLaboratorio.value + "&dtFechaI=" + form.dtFechaI.value + "&dtFechaF=" + form.dtFechaF.value + "&checkSolucion=" + getCheckValue(form.checkSolucion) + "&checkReactivo=" + getCheckValue(form.checkReactivo) + "\"" +
  ...
  <tr>
     ...
     <td valign="top">
        ...
        <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
          <tr><td colspan="8" class="ETablaT">Registro y Comportamiento del Reactivo y Soluciones para An&aacute;lisis Presuntivo</td></tr>
