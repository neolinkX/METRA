...
<html>
<%
  pg070501070CFG  clsConfig = new pg070501070CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070501070.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070501070.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
      ...
      <td valign="top">
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            <tr>
                              <td colspan="5" class="ETablaT">Periodos de las Plantillas
                              </td>
                            </tr>
                               <%
                               out.println("<tr>");
                               out.println("<td class=\"ETablaTR\">Año:</td>");
                               out.println("<td class=\"ETabla\" colspan=\"4\">");
                              ...
                              // modificar según listado
                               if (bs != null){
                                   ...
                                   out.print("<td class=\"ETablaT\">Plantilla</td>");
                                   ...
                                   while(bs.nextRow()){
                                     out.print("<tr>");
                                     out.print(vEti.Texto("ETablaR", bs.getFieldValue("iCvePeriodPla", "&nbsp;").toString()));
                                     out.print(vEti.Texto("ECampo", bs.getFieldValue("cDscPeriodPla", "&nbsp;").toString()));
                                     out.print(vEti.Texto("ECampo", bs.getFieldValue("cDscTpoPlantilla", "&nbsp;").toString()));
                                     ...
                                     if(clsConfig.getLPagina(cDetalle)){
                                       ...
                                       out.print(vEti.clsAnclaTexto("EAncla","Detalle","JavaScript:fIrDetalle('" + bs.getFieldValue("iAnio") + "', '" + bs.getFieldValue("iCvePeriodPla") + "');", ""));
                                       out.print("</td>");
                                     }
                                     out.print("</tr>");
                                   }
