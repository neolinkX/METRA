...
<html>
<%
  pg070104034CFG  clsConfig = new pg070104034CFG();                 // modificar
  ...
  vEntorno.setNombrePagina("pg070104034.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070104034.jsp\" target=\"FRMCuerpo"); // modificar
  vEntorno.setUrlLogo("Acerca");
  vEntorno.setBtnPrincVisible(true);
  vEntorno.setArchFCatalogo("FFiltro");
  vEntorno.setArchAyuda(vEntorno.getNombrePagina());

  String cCatalogo    = "pg070104034.jsp";       // modificar
...
<%
                                  ...
                                  if(lCaptura) {
                                    ...
                                    out.println("</td>");
                                    out.println("<td class=\"ECampo\" colspan=\"1\"><textarea "+(lCaptura?"":"readonly")+" cols=\"50\" rows=\"4\"  name=\"cMtvoSolicitud\" OnKeyPress=\"fChgArea(this);\" OnChange=\"fChgArea(this);\" OnBlur=\"fMayus(this);\">");
                                  if(!lCaptura) {
