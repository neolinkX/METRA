                            ...
                            %>
                             ...
                             <%
                               if (lNuevo){ // Nuevo Registro
                                    ...
                                    out.print("<tr>"+vEti.EtiCampo("EEtiqueta","Descripción:","ECampo","text",100,100,"cDscTpoMovimiento","",0,"","fMayus(this);",false,true,lCaptura)+"</tr>");
                                    ...
                                    // Operación Aritmetica - lSuma
                                    out.println("<tr>"+vEti.Texto("EEtiqueta","Operación Aritmética:"));
...
/* Modificacion */              }
                                 ...
                                 if (bs != null){
                                    ...
                                    // Descripcion - cDscTpoMovimiento
                                    out.print("<tr>"+vEti.EtiCampo("EEtiqueta","Descripción:","ECampo","text",100,100,"cDscTpoMovimiento", bs.getFieldValue("cDscTpoMovimiento","").toString(),0,"","fMayus(this);",false,true,lCaptura)+"</tr>");
