...
<html>
<%
  pg070202030CFG  clsConfig = new pg070202030CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070202030.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070202030.jsp\" target=\"FRMCuerpo"); // modificar
...
<SCRIPT LANGUAGE="JavaScript">
  ...
  function fOnLoad(){
    ...
    document.forms[0].iMeses.selectedIndex = iMes - 1;
  }
</SCRIPT>
  ...
  <tr><td valign="top">
            <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
              ...
              <tr>
                <%
                  ...
                  if(cModulo.equals("null")){
                    cModulo = ""+((TVGRLModulo) vcModulo.get(0)).getICveModulo();
                  }*/
                %>
              </tr>
              <tr>
              ...
              <td colspan="6" align="center">
                <%
                out.print(vEti.clsAnclaTexto("EAncla","Reporte","JavaScript:fBuscar1();", "Reporte...",""));
                %>
              </td></tr>
            </table>
  </td></tr>
