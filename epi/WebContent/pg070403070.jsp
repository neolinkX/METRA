...
<html>
<%
  pg070403070CFG  clsConfig = new pg070403070CFG();                 // modificar
  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070403070.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070403070.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  String cCveOrdenar  = "cDscCausa|";  // modificar
  String cDscFiltrar  = "Descripción|";    // modificar
  String cCveFiltrar  = "cDscCausa|";  // modificar
                            ...
                            <tr>
                              <td colspan="5" class="ETablaT">Filtros para el Reporte</td>
                               ...
                               <% TDGRLMdoTrans DGRLMdoTrans = new TDGRLMdoTrans();
                                  ...
                                  try{
                                    vTpoCausa = DINVTpoCausa.FindByAll(""," order by cDscTpoCausa");
                                  } catch (Exception ex){
                                    ex.printStackTrace();
                                  }
                                  ...
                                  out.println("</tr>");
                                  out.print("<tr>");
                                  out.print("<td class=\"ETablaTR\">Tipo de Causa:</td>");
                                  out.print("<td class=\"ETabla\">");
                                  out.print("<select name=\"iCveTpoCausa\">");
                                  if (!vTpoCausa.isEmpty()){
                                    for(int i=0;i<vTpoCausa.size();i++){
                                      TVINVTpoCausa VINVTpoCausa = new TVINVTpoCausa();
                                      VINVTpoCausa = (TVINVTpoCausa) vTpoCausa.get(i);
                                      if (request.getParameter("iCveTpoCausa") != null){
                                        if (request.getParameter("iCveTpoCausa").toString().compareToIgnoreCase(new Integer(VINVTpoCausa.getICveTpoCausa()).toString()) == 0)
                                          out.print("<option value=\"" + VINVTpoCausa.getICveTpoCausa() + "\" selected>" + VINVTpoCausa.getCDscTpoCausa() + "</option>");
                                        else
                                          out.print("<option value=\"" + VINVTpoCausa.getICveTpoCausa() + "\" >" + VINVTpoCausa.getCDscTpoCausa() + "</option>");
                                      } else
                                        out.print("<option value=\"" + VINVTpoCausa.getICveTpoCausa() + "\" >" + VINVTpoCausa.getCDscTpoCausa() + "</option>");
                                    }
                                  }
                            ...
                            <tr>
                              <td colspan="14" class="ETablaT">Accidentes Registrados</td>
                               ...
                               if (bs != null){
                                   ...
                                   out.print("</tr>");
                                   out.print("<tr>");
                                   out.print("<td class=\"ETablaT\">Causa</td>");
                                   ...
                                   if (request.getParameter("iAnio")        != null &&
                                       ...
                                       request.getParameter("iCveTpoCausa") != null)
                                       vAccidentes = clsConfig.getValores(new Integer(request.getParameter("iAnio").toString()).intValue(),
                                                                          ...
                                                                          new Integer(request.getParameter("iCveTpoCausa").toString()).intValue());
                                   ...
                                   while(bs.nextRow()){
                                     ...
                                     if(!vAccidentes.isEmpty()){
                                       for(int i=0;i<vAccidentes.size();i++){
                                         ...
                                         if (VINVRegistro.getICveCausa() == new Integer(bs.getFieldValue("iCveCausa", "").toString()).intValue()){
                                     ...
                                     out.print("<tr>");
                                     out.print(vEti.Texto("ETabla", bs.getFieldValue("cDscCausa", "&nbsp;").toString()));
