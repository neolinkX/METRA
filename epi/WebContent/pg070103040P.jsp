...
<%  int    iOpc   = request.getParameter("iOpc") != null && request.getParameter("iOpc").length() > 0 ? Integer.parseInt(request.getParameter("iOpc").toString()) : 0;
    ...
    switch  (iOpc){
      case 2: // Módulo
              ...
              int iCveUniMed = request.getParameter("iCveUniMed") != null && request.getParameter("iCveUniMed").length() > 0 ? Integer.parseInt(request.getParameter("iCveUniMed").toString()) : 0;
