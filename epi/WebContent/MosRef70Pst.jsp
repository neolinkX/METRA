<%-- 
    Document   : MosRef70Pst
    Created on : 10/07/2012, 08:36:10 PM 
    Author     : AG SA   
--%>  
...
if(request.getParameter("iorden") != null){
  ...
  String condicion = " ICVEEXPEDIENTE = "+expediente+" AND INUMEXAMEN = "+examen+" AND ICVEDOCUMENTO = 2 AND ICVESERVICIO = "+servicio+" AND ICVERAMA = "+rama+" and iorden = "+request.getParameter("iorden")+"";
  try {
...
%>                   
            ...
            <form name="formulario" method="post" action="MosRef70Pst.jsp">
                    ...
                    <input type="hidden" name="iorden" value="<%=request.getParameter("iorden")%>">
                        ...
                        $(function () {
                            $('#torax').imgAreaSelect({ x1: <%=x1%>, y1: <%=y1%>, x2:<%=x2%>, y2: <%=y2%> });
                        });
                        </script>
                        ...
                        <tr>
                            <td bgcolor="#088A08"><span class="Estilo6">Punto<%=iorden%> de referencia de Tórax</span><br></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FBFBEF">&nbsp;<span class="Estilo5">
                        <img src="<%=vParametros.getPropEspecifica("RutaImgServer")%>torax_p.jpg" alt="torax" name="torax" id="torax"
...
<%         
      ...
      %>
                ...
                <table width="400" border="1">  
                <tr>
                    <td bgcolor="#088A08"><span class="Estilo6">No existen puntos de referencia de Tórax</span><br></td>
                </tr>
...
<%
      ...
      Vector resultados = new Vector();
        ...
        String condicion = " ICVEEXPEDIENTE = "+expediente+" AND INUMEXAMEN = "+examen+" AND ICVEDOCUMENTO = 2 AND ICVESERVICIO = "+servicio+ " AND ICVERAMA = "+rama+" ";
        try {
                resultados = dEXPSERVPRef.FindByAll(condicion);
        }
        catch (Exception e) {
           ...
           <script> 
            ...
            <body bgcolor="" topmargin="0" leftmargin="0" >
                <form name="formulario" method="post" action="MosRef70Pst.jsp">
                    ...
                    <table width="400" border="1">
                    <tr>
                        <td bgcolor="#088A08"><span class="Estilo6">Consulta de puntos de referencia de Tórax Posterior</span><br></td>
                    </tr>
                    <%
                    for(int i=0;i<resultados.size();i++){
                        vEXPSERVPRef = (TVEXPSERVPRef) resultados.get(i);
