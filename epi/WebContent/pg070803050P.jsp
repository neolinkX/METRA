  ...
  if (request.getParameter("opc") != null){
     ...
     switch(new Integer(request.getParameter("opc")).intValue()) {
       ...
       case 3:
        ...
        break;
        case 4:
           if (request.getParameter("val2")!=null && request.getParameter("val3")!=null){
               TDALMArticulo DALMArticulo = new TDALMArticulo();
               TVALMArticulo VALMArticulo = new TVALMArticulo();
               Vector vExCuali = new Vector();
               vExCuali = DALMArticulo.FindByCustomWhere(" where ALMArticulo.iCveTpoArticulo = " + request.getParameter("val2") +
