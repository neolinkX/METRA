...
<jsp:useBean id="imgs" class="gob.sct.medprev.ImagesFFH" scope="session"/>
...
%>
    <table background="<%= vParametros.getPropEspecifica("RutaImg") %>fondo01.jpg" border="0" width="50%" align="center" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
        ...
        <tr align="center">
            <td class="EEtiquetaC" colspan="3">Número de expedinete</td>
        </tr>
        ...
        <tr bgcolor="#FFFFFF" align="center">
            <td class="ETablaR"><img src="pg070103044.jsp?index=0" border="0" width="130" height="160"></td>
            <td class="ETablaR"><img src="pg070103044.jsp?index=1" border="0" width="130" height="160"></td>
            <td class="ETablaR"><img src="pg070103044.jsp?index=2" border="0" width="130" height="160"></td>
        </tr>
        <%}%>
    </table>
<%}else{%>
