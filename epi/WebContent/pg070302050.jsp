<%/**
 * Title:       Envíos al Laboratorio
 * Description: Listado de Envíos al Laboratorio
 * Copyright:   2004
...
//                                out.println(vEti.SelectOneRowSinTD("iCveUniMed", "",dUMUsuario.getUniMedxUsu2(vUsuario.getICveusuario()," AND iCveProceso != 3 "),"iCveUniMed", "cDscUniMed", request, "0", true));
      ...
      <td valign="top">
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            <tr>
                              <td colspan="13" class="ETablaT">Envíos
                              </td>
                            </tr>
                            <tr>
                              <td rowspan="2" class="ETablaT">Envío</td>
                              <td rowspan="2" class="ETablaT">Unidad<br>Médica</td>
                              <td colspan="4" class="ETablaT">Información del Envío</td>
                              <td colspan="3" class="ETablaT">Información de la Recepción</td>
                          ...
                          <% if (bs != null){ %>
                             <% // modificar según listado
                                   ...
                                   while(bs.nextRow()){
                                     ...
                                     out.print(vEti.clsAnclaTexto("EAncla","Muestras del Envío","JavaScript:fIrpg070302041('" + bs.getFieldValue("iAnio", "") + "', '" + bs.getFieldValue("iCveUniMed", "") + "', '" + bs.getFieldValue("iCveEnvio", "") + "', 'pg070302041.jsp');", ""));
                                     out.print("</td>");
