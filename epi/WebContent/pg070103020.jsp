...
<SCRIPT LANGUAGE="JavaScript">
  ...
  // window.location="http://aplicaciones3.sct.gob.mx/elic/CDPagNva.jsp?cPagina=CD/frmmi.js&cPagNva=pg13032100000.js";
   var opciones="toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=900, height=450, top=20, left=20";
  window.open("http://app.sct.gob.mx/elic/CDPagNva.jsp?cPagina=CD/frmmi.js&cPagNva=pg13032100000.js","",opciones);
