...
session.setAttribute("servicio","61");    /////////////////////////MODIFICAR LA CLAVE DEL SERVICIO (TABLA MEDSERVICIO)/////////////////////////////////////////////
      ...
      <div class="m-portlet__head-caption">
         <div class="m-portlet__head-title">
            <span class="m-portlet__head-icon">
              <img src="<%=vParametros.getPropEspecifica("RutaImgServerExp")%>interconsultas/minterna.svg" width="20" class="svg-inject signal-strong">
            </span>
            <h3 class="m-portlet__head-text m--font-primary">
               EVALUACION DE MEDICINA INTERNA NOM024
            </h3>
         </div>
      </div>
...
<%@ include file="/medicinaInterna_ic/preguntasMedicinaInterna_ic.jsp"%>
  </div>
