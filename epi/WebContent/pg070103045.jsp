...
<%
  pg070103045CFG  clsConfig = new pg070103045CFG();                 // modificar
  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setNombrePagina("pg070103045.jsp");                    // modificar
  vEntorno.setArchFuncs("FValida");
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070103045.jsp\" target=\"FRMCuerpo"); // modificar
...
<!--<SCRIPT LANGUAGE="JavaScript" SRC="C:\sct\MedprevInt\medprev\archivos\funciones\pg070103045.js"></SCRIPT>-->
...
function mostrardiv() {
form = document.forms[0];
<%if(!request.getParameter("hdBoton").equals("Detalle")) {%>
                                ...
                                if (lNuevo){
                                  ...
                                  if (bs != null){
                                    ...
                                    /*if(request.getParameter("iCveUniMed").equals("107")){
                                    	...
                                    	out.print(vEti.EtiCampo("EEtiqueta","Primer Apellido:","ECampo","text",25,25,"cApPaterno", bs.getFieldValue("cApPaterno","&nbsp;").toString(),0,"","fMayus(this);",false,true,lCaptura));
                                    	out.print(vEti.EtiCampo("EEtiqueta","Segundo Apellido:","ECampo","text",25,25,"cApMaterno", bs.getFieldValue("cApMaterno","&nbsp;").toString(),0,"","fMayus(this);",false,true,lCaptura));
                                   // }
                                   ...
                                   /* if(request.getParameter("iCveUniMed").equals("107")){
                                    	...
                                    	out.print(vEti.EtiCampo("EEtiqueta","Nombre(s):","ECampo","text",30,30,"cNombre", bs.getFieldValue("cNombre","&nbsp;").toString(),0,"","fMayus(this);",false,true,lCaptura));	
                                    //}
                                    if (request.getParameter("hdBoton").compareTo("Modificar") != 0 ){
                                    	//out.print(vEti.EtiCampo("EEtiqueta","Sexo:","ECampo","text",10,10,"cGenero", bs.getFieldValue("cSexo","&nbsp;").toString(),0,"","fMayus(this);",false,true,lCaptura));
                                    	...
                                    	%>
	                                    	<input type="hidden" name="cApPaterno2" value="<%=bs.getFieldValue("cApPaterno","&nbsp;").toString() %>">
	                                    	<input type="hidden" name="cApMaterno2" value="<%=bs.getFieldValue("cApMaterno","&nbsp;").toString() %>">
	                                    	<input type="hidden" name="cNombre2" value="<%=bs.getFieldValue("cNombre","&nbsp;").toString() %>">
	                                    	<input type="hidden" name="cRFC2" value="<%=bs.getFieldValue("cRFC","&nbsp;").toString() %>">
	                                    	<input type="hidden" name="cCURP2" value="<%=bs.getFieldValue("cCURP","&nbsp;").toString() %>">
	                                    	<input type="hidden" name="cExpediente2" value="<%=bs.getFieldValue("iCveExpediente","&nbsp;").toString() %>">
                                    	<%
                                    ...
                                    out.println("</tr>");
                                    out.println("<tr>");
                                    out.print(vEti.EtiCampoCS("EEtiqueta","Fecha Nacimiento:","ECampo","text",10,10,4,"dtNacimiento", bs.getFieldValue("cDscFecNacimiento","").toString(),0,"","fMayus(this);",false,true,lCaptura));
                                    out.println("</tr>");
                                    out.println("<tr>");
                                    /*if(request.getParameter("iCveUniMed").equals("107")){
                                    	...
                                    	out.print(vEti.EtiCampo("EEtiqueta","Homoclave:","ECampo","text",3,3,"cHomoclave", bs.getFieldValue("cHomoclave","&nbsp;").toString(),0,"","fMayus(this);",false,true,lCaptura));
                                    //}
                                    out.println("</tr>");
                                    out.println("<tr>");
                                    /*if(request.getParameter("iCveUniMed").equals("107")){
                                    	...
                                    	out.print(vEti.EtiCampoCS("EEtiqueta","CURP:","ECampo","text",18,18,4,"cCURP", bs.getFieldValue("cCURP","&nbsp;").toString(),0,"fValidaCURP(this);","fMayus(this);",false,true,lCaptura));
                                    //}
                                    ...
                                    out.println("<tr>");
                                    if (request.getParameter("hdBoton").compareTo("Modificar") != 0 ){
                                    	out.print(vEti.EtiCampo("EEtiqueta","NACORIGEN (Nacionalidad):","ECampo","text",10,10,"iCvePaisNac", bs.getFieldValue("cDscPaisNac","&nbsp;").toString(),0,"","fMayus(this);",false,true,lCaptura));
                                    	//out.print(vEti.EtiCampo("EEtiqueta","NACORIGEN (Nacionalidad):","ECampo","text",10,10,"iCvePaisNac", dPaisNac.FindBySAllNacionalidad(Integer.parseInt(bs.getFieldValue("iCvePaisNac","&nbsp;").toString())),0,"","fMayus(this);",false,true,lCaptura));
	                                    ...
	                                    //out.println("<td>");
	                                    //out.println(vEti.SelectOneRowSinTD("iCvePaisNac","llenaSLT(2,this.value,'','',document.forms[0].iCveEstadoNac);", dPaisNac.FindByAllNacionalidad(), "iCvePais", "cNombre",request, bs.getFieldValue("iCvePaisNac","&nbsp;").toString() , true));
                                    ...
                                    out.println("</tr>");
                                    out.println("<tr>");
                                    out.print(vEti.EtiCampo("EEtiqueta","Correo Electrónico:","ECampo","text",50,50,"cCorreoElec", bs.getFieldValue("cCorreoElec","&nbsp;").toString(),0,"","",false,true,lCaptura));
	
                                    /*
                                    if (request.getParameter("hdBoton").compareTo("Modificar") != 0 ){
                                       if (bs.getFieldValue("lDonadorOrg","&nbsp;").toString().compareTo("1") == 0)
                                          out.print(vEti.EtiCampo("EEtiqueta","Donador de órganos:","ECampo","text",10,10,"lDonadorOrg","SI",0,"","fMayus(this);",false,true,lCaptura));
                                       else
                                          out.print(vEti.EtiCampo("EEtiqueta","Donador de órganos:","ECampo","text",10,10,"lDonadorOrg","NO",0,"","fMayus(this);",false,true,lCaptura));
                                    }
                                    else{
                                      out.println(vEti.Texto("EEtiqueta","Donador de órganos:"));
                                      out.println("<td>");
                                      if (bs.getFieldValue("lDonadorOrg","&nbsp;").toString().compareTo("1") == 0)
                                    ...
                                    */
                                    ...
                                    out.println("<tr>");
                                    if (lCaptura) {
                                       out.println("<td class=\"EEtiqueta\">Señas Particulares:<br><input type=\"text\" size=\"5\" name=\"iNoLetras\" value=\"\" disabled></td>");
                                    ...
                                    out.println(vEti.EtiAreaTextoCS("EEtiqueta","Señas Particulares:","ECampo",50,5,4,"cSenasPersonal",bs.getFieldValue("cSenasPersonal","&nbsp;").toString(),0,"","",false,true,lCaptura));
                                    out.println("</tr>");
                                    ...
                                    out.println("</tr>");
                                    out.println("<tr>");
                                    out.print(vEti.EtiCampoCS("EEtiqueta","Dirección Aviso:","ECampo","text",80,150,4,"cDirecAviso", bs.getFieldValue("cDirecAviso","&nbsp;").toString(),0,"","fMayus(this);",false,true,lCaptura));
                                    out.println("</tr>");
                                    out.println("<tr>");
                                    ...
                                    /*out.println(vEti.TextoCS("ETablaSTC","Adicionales",4));
                                          ...
                                          if (!lCaptura){
                                        	  /* out.println("<tr>");
                                                ...
                                                out.println("</tr>");
                                                out.println("<tr>");
                                                out.print(vEti.EtiCampoCS("EEtiqueta","Grupo Étnico:","ECampo","text",10,10,4,"iCveGpoEtnico", bs.getFieldValue("cGpoEtnico","&nbsp;").toString(),0,"","fMayus(this);",false,true,lCaptura));
                                                out.println("</tr>");
                                                out.println("<tr>");
                                                ...
                                                out.println("</tr>");
                                                out.println("<tr>");
                                                out.print(vEti.EtiCampoCS("EEtiqueta","Tipo Sanguíneo:","ECampo","text",10,10,4,"iCveTpoSangre", bs.getFieldValue("cTpoSangre","&nbsp;").toString(),0,"","fMayus(this);",false,true,lCaptura));
                                                out.println("</tr>");
                                                out.println("<tr>");
                                                out.print(vEti.EtiCampoCS("EEtiqueta","Nivel socioeconómico:","ECampo","text",10,10,4,"iCveNivelSEC", bs.getFieldValue("cNivelSec","&nbsp;").toString(),0,"","fMayus(this);",false,true,lCaptura));
                                                out.println("</tr>");
                                                out.println("<tr>");
                                                out.print(vEti.EtiCampoCS("EEtiqueta","Afiliación o preferencia <br>por un partido político:","ECampo","text",10,10,4,"iCveParPol", bs.getFieldValue("cDscParPol","&nbsp;").toString(),0,"","fMayus(this);",false,true,lCaptura));
                                                out.println("</tr>");
                                                out.println("<tr>");
                                                ...
                                                out.println(vEti.SelectOneRowSinTD("iCveVivienda","", dGRLVIVIENDA.FindByAll(), "iCveVivienda", "cConcepto",request, bs.getFieldValue("iCveVivienda","&nbsp;").toString() , true));
                                                out.println("</td>");
                                                out.println("</tr>");
                                                ...
                                                out.println("<td>");
                                                out.println(vEti.SelectOneRowSinTD("iCveGrupoD","llenaSLT(8,this.value,'','',document.forms[0].iCveSubgrupoD);", dGRLDISCAPACIDAD.FindByAllG(), "iCveGrupoD", "cDscGrupoD", request, bs.getFieldValue("iCveGrupoD","&nbsp;").toString(), true));
                                                //out.println(vEti.SelectOneRowSinTD("iCveGrupoD","llenaSLT(8,this.value,'','',document.forms[0].iCveSubgrupoD);", dGRLDISCAPACIDAD.FindByAllG(), "iCveGrupoD", "cDscGrupoD", request, bs.getFieldValue("iCveGrupoD","&nbsp;").toString(), true));
                                                out.println("</td>");
                                                out.println("</tr>");
                                                out.println("<tr>");
                                                ...
                                                //out.println("</SELECT>");
                                                out.println(vEti.SelectOneRowSinTD("iCveSubgrupoD","llenaSLT(9,document.forms[0].iCveGrupoD.value,this.value,'',document.forms[0].iCveDiscapacidad);", dGRLDISCAPACIDAD.FindByAllS(" where icvegrupo = " + bs.getFieldValue("iCveGrupoD","").toString()), "iCveSubGrupoD", "cDscSubGrupoD", request, bs.getFieldValue("iCveSubGrupoD","&nbsp;").toString(), true));
                                                out.println("</td>");
                                                out.println("</tr>");
                                                out.println("<tr>");
                                                ...
                                                //out.println("</SELECT>");
                                                out.println(vEti.SelectOneRowSinTD("iCveDiscapacidad", "", dGRLDISCAPACIDAD.FindByAllD(bs.getFieldValue("iCveGrupoD","").toString(),bs.getFieldValue("iCveSubGrupoD","").toString()), "iCveDiscapacidad", "cDscDiscapacidad", request, bs.getFieldValue("iCveDiscapacidad","&nbsp;").toString(),true));
                                                out.println("</td>");
                                                out.println("</tr>");
                                                ...
                                                out.println("<td class='ECampo' colspan='3' >");
                                                out.println(vEti.SelectOneRowSinTD("iCveGpoEtnico", "", dGRLGPOETNICO.FindByAll(), "iCveGpoEtnico", "cGpoEtnico", request, bs.getFieldValue("iCveGpoEtnico","&nbsp;").toString(),true));
                                                out.println("</td>");
                                                out.println("</tr>");
                                                ...
                                                out.println("<td>");
                                                out.println(vEti.SelectOneRowSinTD("iCveGrupo","llenaSLT(10,this.value,'','',document.forms[0].iCveSubgrupo);", dGRLRELIGION.FindByAllG(), "iCveGrupo", "cGrupo", request, bs.getFieldValue("iCveGrupoR","&nbsp;").toString(), true));
                                                out.println("</td>");
                                                ...
                                                //out.println("</SELECT>");
                                                out.println(vEti.SelectOneRowSinTD("iCveSubgrupo","llenaSLT(11,document.forms[0].iCveGrupo.value,this.value,'',document.forms[0].iCveReligiones);", dGRLRELIGION.FindByAllS(" where icvegrupo = " + bs.getFieldValue("iCveGrupoR","").toString()), "iCveSubGrupo", "cSubGrupo", request, bs.getFieldValue("iCveSubGrupoR","&nbsp;").toString(), true));
                                                out.println("</td>");
                                                out.println("</tr>");
                                                out.println("<tr>");
                                                ...
                                                //out.println("</SELECT>");
                                                out.println(vEti.SelectOneRowSinTD("iCveReligiones", "", dGRLRELIGION.FindByAllD(bs.getFieldValue("iCveGrupoR","").toString(),bs.getFieldValue("iCveSubGrupoR","").toString()), "iCveReligion", "cCodDsc", request, bs.getFieldValue("iCveReligion","&nbsp;").toString(),true));
                                                out.println("</td>");
                                                out.println("</tr>");
                                                ...
                                                out.println("<td class='ECampo' colspan='3' >");
                                                out.println(vEti.SelectOneRowSinTD("iCveTpoSangre", "", dGRLTPOSANGRE.FindByAll(), "iCveTpoSangre", "cTpoSangre", request, bs.getFieldValue("iCveTpoSangre","&nbsp;").toString(),true));
                                                out.println("</td>");
                                                out.println("</tr>");

                                                out.println("<tr>");
                                                TDGRLNIVELSEC dGRLNIVELSEC = new TDGRLNIVELSEC();
                                                out.println(vEti.Texto("EEtiqueta","Nivel socioeconómico"));
                                                out.println("<td class='ECampo' colspan='3' >");
                                                out.println(vEti.SelectOneRowSinTD("iCveNivelSEC", "", dGRLNIVELSEC.FindByAll(), "iCveNivelSEC", "cNivelSEC", request, bs.getFieldValue("iCveNivelSEC","&nbsp;").toString(),true));
                                                out.println("</td>");
                                                out.println("</tr>");

                                                out.println("<tr>");
                                                TDGRLPARPOL dGRLPARPOL = new TDGRLPARPOL();
                                                out.println(vEti.Texto("EEtiqueta","Afiliación o preferencia <br>por un partido político"));
                                                out.println("<td class='ECampo' colspan='3' >");
                                                //System.out.println("Partido Politico No.: " + bs.getFieldValue("iCveParPOL","&nbsp;").toString());
                                                out.println(vEti.SelectOneRowSinTD("iCveParPol", "", dGRLPARPOL.FindByAll(), "iCveParPol", "cDscParPol", request, bs.getFieldValue("iCveParPOL","&nbsp;").toString(),true));
                                                out.println("</td>");
                                                out.println("</tr>");
                                                ...
                                                out.println("<td class='ECampo' colspan='3' >");
                                                out.println(vEti.SelectOneRowSinTD("iCveECivil", "", dGRLECIVIL.FindByAll(), "iCveECivil", "cECivil", request, bs.getFieldValue("iCveECivil","&nbsp;").toString(),true));
                                                out.println("</td>");
                                                out.println("</tr>"); 
                                          		*/
                                          }
...
<%
                                    ...
                                    if(Correctos.elementAt(0).toString().compareTo("0") == 0){
                                       ...
                                       out.println("País de Nacimiento<br>");
                                       out.println("</tr>");
                                       contador ++;
                                    }
                                    ...
                                    if(Correctos.elementAt(3).toString().compareTo("0") == 0){
                                       out.println("<tr><td class=\"EEtiqueta\"><div align=\"left\">");
                                       out.println("País de la dirección<br>");
                                       out.println("</tr>");
                                       contador ++; 
                                   ...
                                   if(Correctos.elementAt(4).toString().compareTo("0") == 0){
                                       out.println("<tr><td class=\"EEtiqueta\"><div align=\"left\">");
                                       out.println("Estado de la dirección<br>");
                                       out.println("</tr>");
                                       contador ++;
                                    }
                                    if(Correctos.elementAt(5).toString().compareTo("0") == 0){
                                       out.println("<tr><td class=\"EEtiqueta\"><div align=\"left\">");
                                       out.println("Municipio de la dirección<br>");
                                       out.println("</tr>");
                                       contador ++;
                                    }
                                    if(Correctos.elementAt(6).toString().compareTo("0") == 0 || Correctos.elementAt(2).toString().compareTo("0") == 0){
                                        ...
                                        out.println("<tr><td class=\"EEtiqueta\"><div align=\"left\">");
                                        out.println("Se actualizaron de forma automática los datos erróneos<br>");
                                        out.println("</tr>");
