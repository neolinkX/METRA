...
;(function ($, window, document, undefined) {
    ...
    WCPEditor.prototype.presentCreateNewModal = function() {
        ...
        modalBody += '  <label for="wcp-editor-input-create-new">Nombre: </label>';
        modalBody += '  <input type="text" id="wcp-editor-input-create-new">';
        modalBody += '  <div id="wcp-editor-create-new-error">Ingrese un nombre para el mapa</div>';
        modalBody += '</div>';
    ...
    WCPEditor.prototype.presentLoadModal = function() {
        ...
        this.presentLoadingScreenWithText('Cargndo elementos guardados...');
    ...
    WCPEditor.prototype.presentDeleteSaveConfirmationModal = function() {
        var modalOptions = {
            ...
            body: '¿Esta seguro de eliminar permanentemente este mapa?'
        };
