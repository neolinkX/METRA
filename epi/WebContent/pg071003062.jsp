...
<html>
<%
  pg071003062CFG  clsConfig = new pg071003062CFG();                 // modificar
...
// U N I D A D   M E D I C A
            ...
            out.print("<tr>");
              ...
              out.println(vEti.SelectOneRowSinTD("iCveUniMed","{forma = document.forms[0]; forma.target='FRMDatos'; forma.hdBoton.value='Primero'; forma.submit();}",vcGRLUMUsuario,"iCveUniMed","cDscUniMed",request,"0",true,true));
              out.print("</td>");
              out.print("</tr>");
