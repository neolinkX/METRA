...
<html>
<%
  pg070103046CFG  clsConfig = new pg070103046CFG();                 // modificar
  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setNombrePagina("pg070103046.jsp");                    // modificar
  vEntorno.setArchFuncs("FValida");
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070103046.jsp\" target=\"FRMCuerpo"); // modificar
...
<form method="<%= vEntorno.getMetodoForm() %>" action="<%= vEntorno.getActionForm() %>">
  ...
  <input type="hidden" name="hdBoton">
                              ...
                              <%
                                ...
                                ////Validando si solo tiene acceso a unidades para terceros
                                boolean AccesoSoloATerceros = clsConfig.AccesoSoloATerceros();
                                
                                
                                if (lNuevo){
                                	out.println("<input type=\"hidden\" name=\"AccesoSoloATerceros\" value=\"false\">");
                                    out.println("<tr>");
                                    ...
                                    out.println(vEti.Texto("EEtiqueta","MUN (Municipio):"));
                                    out.println("<td class='ECampo'>");
                                    out.println("<SELECT NAME='iCveMunicipio' SIZE='1' onChange=\"llenaSLT(5,document.forms[0].iCvePais.value,document.forms[0].iCveEstado.value,this.value,'',document.forms[0].iCveMunicipio);\" ");
                                    out.println("</SELECT>");
                                    out.println("</td>");
                                    out.println("</tr>");
                                    out.println("<tr>");
                                    out.println("<tr>");
                                    out.println(vEti.Texto("EEtiqueta","LOC1 (Población):"));
                                    out.println("<td class='ECampo'>");
                                    ...
                                    out.println("</tr>");
                                	  ...
                                	  /*if(AccesoSoloATerceros){
                                      	//System.out.println("tercero");
                                      	out.println("<input type=\"hidden\" name=\"AccesoSoloATerceros\" value=\"true\">");
                                      	out.println("<tr>");
