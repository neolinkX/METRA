...
session.setAttribute("servicio","64");    /////////////////////////MODIFICAR LA CLAVE DEL SERVICIO (TABLA MEDSERVICIO)/////////////////////////////////////////////
      ...
      <div class="m-portlet__head-caption">
         <div class="m-portlet__head-title">
            <span class="m-portlet__head-icon">
              <img src="<%=vParametros.getPropEspecifica("RutaImgServerExp")%>interconsultas/ppsicologicas.svg" width="20" class="svg-inject signal-strong">
            </span>
            <h3 class="m-portlet__head-text m--font-primary">
              EVALUACIÓN PSICOLOGÍA Y PSIQUIATRÍA NOM024
            </h3>
         </div>
      </div>
...
<%@ include file="/evalPsiquiatria_ic/preguntasEvalPsiquiatria_ic.jsp"%>
  </div>
