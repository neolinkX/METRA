...
<html>
<%
  pg070802051CFG  clsConfig = new pg070802051CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070802051.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070802051.jsp\" target=\"FRMCuerpo"); // modificar
  vEntorno.setUrlLogo("Acerca");
  vEntorno.setBtnPrincVisible(true);
  vEntorno.setArchFCatalogo("FFiltro");
  vEntorno.setArchAyuda(vEntorno.getNombrePagina());

  String cCatalogo    = "pg070802051.jsp";       // modificar
      ...
      <td valign="top"><input type="hidden" name="hdBoton" value="">
         <table border="1" class="ETablaInfo" align="center">
           <tr>
             ...
             <td class="ECampo">
                <select name="SLSAlmacen" size="1" onChange="llenaSLT(1,document.forms[0].SLSAlmacen.value,'','',document.forms[0].SLSTipoArticulo,document.forms[0].SLSFamilia,document.forms[0].SLSInventario1);">
             ...
             <td class="ECampo">
                <select name="SLSInventario1" size="1">
                <% if (request.getParameter("SLSInventario1") != null){
                      if (request.getParameter("SLSInventario1") != "")
                          cvInventario = request.getParameter("SLSInventario1");
                    }
                          ...
                          <table border="1" class="ETablaInfo" align="center"><% // Inicio de Datos %>
                            ...
                            <tr>
                             ...
                             <% // modificar según listado
                               ...
                               if (bs != null){
                                   out.print("<tr>");
                                   out.print("<td class=\"ETablaT\">Autorización:</td>");
                                   out.print("<td class=\"ETabla\">");
                                   if (!vInventarios.isEmpty()){
                                     if (request.getParameter("dtAutorizacion") != null)
                                       out.print(vEti.CampoSinCelda("input",10,10,"dtAutorizacion",request.getParameter("dtAutorizacion") ,3,"","",true,true));
                                     else
                                       out.print(vEti.CampoSinCelda("input",10,10,"dtAutorizacion" ,"",3,"","",true,true));
                                   } else
                                       out.print(vEti.CampoSinCelda("input",10,10,"dtAutorizacion" ,"",3,"","",true,true));
                                   out.print("</td>");
                                   out.print("<td class=\"ETablaT\">Usuario:</td>");
                                   out.println("<td class=\"ETablaR\">");
                                   out.print(vEti.SelectOneRowSinTD("SLSAutorizacion", "", vcPersonal,"iCveUsuario", "cNomCompleto", request, ""));
                                   out.println("</td>");
                                   out.print("</tr>");
                               }
                            %>
                            ...
                            <tr>
                              ...
                              <td class="ETablaT">Existencia Física</td>
                            </tr>
                             <% // modificar según listado
                                } else {
                                  out.print("<tr>");
                               ...
                               if (bs != null){
                                   ...
                                   while(bs.nextRow()){
                                     ...
                                     if (bs.getFieldValue("lLote", "&nbsp;").toString().compareToIgnoreCase("1") == 0){
                                         if (bs.getFieldValue("cLote", "&nbsp;") != null)
                                         ...
                                         if (bs.getFieldValue("iCveArticulo", "&nbsp;").toString().compareToIgnoreCase(new Integer(VALMDtlleInve.getiCveArticulo()).toString()) == 0){
                                            if (bs.getFieldValue("lLote", "&nbsp;").toString().compareToIgnoreCase("1") == 0){
                                               if (bs.getFieldValue("iCveLote", "&nbsp;").toString().compareToIgnoreCase(new Integer(VALMDtlleInve.getiCveLote()).toString()) == 0){
                                                   out.print(vEti.Texto("ETablaR", dfNumber.format(new Double(VALMDtlleInve.getdEFisica()))));
