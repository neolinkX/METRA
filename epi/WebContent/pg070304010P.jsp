     ...
     switch(new Integer(request.getParameter("opc")).intValue()) {
        case 1:
           if (request.getParameter("val1")!=null){
               ...
               vExCuali = dTOXLoteCuantita.FindByAll( " where TOXLoteCuantita.iAnio           = " + request.getParameter("val1") +
                                                      "   and TOXLoteCuantita.iCveLaboratorio = " + request.getParameter("val2") +
                                                      "   and TOXLoteCuantita.iCveSustancia   = " + request.getParameter("val3") +
