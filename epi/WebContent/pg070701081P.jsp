     ...
     switch(new Integer(request.getParameter("opc")).intValue()) {
        case 1:
           if (request.getParameter("val1")!=null){
               ...
               vcEntidadFed = dEntidadFed.FindByAll(" where iCvePais = " + request.getParameter("val1"));
        ...
        case 2:
           if (request.getParameter("val1")!=null && request.getParameter("val2")!=null){
               ...
               vcMunicipio = dMunicipio.FindByAll("" + request.getParameter("val1"), "" + request.getParameter("val2"));
               out.println("form = window.parent.parent.FRMCuerpo.FRMDatos.document.forms[0];");
               out.println("form." + ObjetoDes + ".length=1;");
    ...
    <tr>
      <td align="center" width="100%" valign="middle">
        <table border="0" width="100%" height="100%" background="<%=cRutaImg%>fondoSTitulo<%=cTipoImg%>">
          <TR>
            <td class="ETituloTPag" align="center" width="100%" valign="middle"><%=cTitulo.toUpperCase()%>
            </TD>
          </TR>
        </TABLE>
      </td>
