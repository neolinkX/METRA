...
<%
	...
	session.setAttribute("servicio", "25");
	session.setAttribute("rama", "1");
	boolean seagrego = false;
	TDEXPExamCat cat2 = new TDEXPExamCat();
	String cnombrerama = cat2.SentenciaSQL("Select cdscrama from medrama where icveservicio = "+session.getAttribute("servicio")+" and icverama = "+request.getParameter("hdrama"));
		...
		<div class="m-portlet__head-caption">
			<div class="m-portlet__head-title">
				<span class="m-portlet__head-icon"> <img
					src="<%=vParametros2.getPropEspecifica("RutaImgServerExp")%>servicios/minterna.svg"
			...
			<div class="m-form__content">
				...
				<div class="row">
					...
					<div class="form-group m-form__group row">
						<!--<label for="svs_presion_sistolica" class="col-3 col-form-label">-->
						<label for="svs_presion_sistolica">
				...
				<%
					contadortipodiv = 0;
							...
							if (vEXPResultados.getLObligatorio() == 1) {
								...
								CodigoValida2 = CodigoValida2 + CampoFinal + ":{ required: false, min: 0, max: 299 }";
							}
...
function guarda_signos_vitales(){
  ...
  modalConfirm(function (){
    $.ajax({
      url: 'somatometria/guarda_signosVitales/'+$('#id_episodio_left').val(),
      type: 'POST',
