...
session.setAttribute("servicio","25");    /////////////////////////MODIFICAR LA CLAVE DEL SERVICIO (TABLA MEDSERVICIO)/////////////////////////////////////////////
      ...
      <div class="m-portlet__head-caption">
         <div class="m-portlet__head-title">
            <span class="m-portlet__head-icon">
              <img src="<%=vParametros.getPropEspecifica("RutaImgServerExp")%>interconsultas/ortopedia2.svg" width="20" class="svg-inject signal-strong">
            </span>
...
<%@ include file="/ortopedia_ic/preguntasOrtopedia_ic.jsp"%>
  </div>
