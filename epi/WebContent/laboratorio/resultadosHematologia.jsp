        ...
        <div class="m-section">
            ...
            <div class="form-group m-form__group row">
              <label for="hem_cmhb" class="col-3 col-form-label">
                  ConcentraciÃ³n Media de HB (CMHB)
                </label>
              <div class="col-4">
            ...
            <div class="form-group m-form__group row">
              <label for="hem_mch" class="col-3 col-form-label">
                  ConcentraciÃ³n Media de Hemoglobina (MCH)
              </label>
              <div class="col-4">
            ...
            <div class="form-group m-form__group row">
              <label for="hem_ade" class="col-3 col-form-label">
                  Ancho de DistribuciÃ³n Eritrocitaria (ADE)
              </label>
              <div class="col-4">
            ...
            <div class="form-group m-form__group row">
              <label for="hem_adp" class="col-3 col-form-label">
                Ancho de Distribuci&oactue;n Plaquetaria (ADP)
              </label>
              <div class="col-4">
