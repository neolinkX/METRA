...
%>                   
            ...
            <form name="formulario" method="post" action="MosRef54.jsp">
                    ...
                    <input type="hidden" name="iorden" value="<%=request.getParameter("iorden")%>">
                        ...
                        <tr>
                            <td bgcolor="#088A08"><span class="Estilo6">Punto<%=iorden%> de referencia de Abdomen</span><br></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FBFBEF">&nbsp;<span class="Estilo5">
                        <img src="<%=vParametros.getPropEspecifica("RutaImgServer")%>abdomen.jpg" alt="abdomen" name="abdomen" id="abdomen"
...
<%         
      ...
      %>
                ...
                <table width="400" border="1">  
                <tr>
                    <td bgcolor="#088A08"><span class="Estilo6">No existen puntos de referencia de Abdomen</span><br></td>
                </tr>
...
<%
      ...
      Vector resultados = new Vector();
        ...
        String condicion = " ICVEEXPEDIENTE = "+expediente+" AND INUMEXAMEN = "+examen+" AND ICVEDOCUMENTO = 1 AND ICVESERVICIO = "+servicio+" AND  ICVERAMA = "+rama+"" ;
        try {
                resultados = dEXPSERVPRef.FindByAll(condicion);
        }
        catch (Exception e) {
           ...
           <script> 
            ...
            <body bgcolor="" topmargin="0" leftmargin="0" >
                <form name="formulario" method="post" action="MosRef54.jsp">
                    ...
                    <table width="400" border="1">
                    <tr>
                        <td bgcolor="#088A08"><span class="Estilo6">Consulta de puntos de referencia de Abdomen</span><br></td>
                    </tr>
                    <%
                    for(int i=0;i<resultados.size();i++){
                        vEXPSERVPRef = (TVEXPSERVPRef) resultados.get(i);
