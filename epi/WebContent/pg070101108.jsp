...
<html>
<%
  pg070101108CFG  clsConfig = new pg070101108CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setNombrePagina("pg070101108.jsp");                    // modificar
  vEntorno.setArchFuncs("FValida");
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070101108.jsp\" target=\"FRMCuerpo"); // modificar
...
<!--<SCRIPT LANGUAGE="JavaScript" SRC="C:\sct\MedprevInt\medprev\Archivos\funciones\pg070101108.js"></SCRIPT>-->
...
<form method="<%= vEntorno.getMetodoForm() %>" action="<%= vEntorno.getActionForm() %>">
  ...
  <input type="hidden" name="SintomaDep2" value="<% if (request.getParameter("SintomaDep2") != null) out.print(request.getParameter("SintomaDep2"));%>">
  <%
 ...
 %>
  ...
  <input type="hidden" name="hdSintoma" value="<%=request.getParameter("hdCampoClave")%>">
  <input type="hidden" name="iCveSintoma" value="<%=request.getParameter("hdCampoClave")%>">
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
                    ...
                    if (request.getParameter("SintomaDep2") != null){
                                    
                                                                                                                                                                               
////////////////////////////////////////////////////////////////////
                                   String Dependiente = "";
                                   try{
                                       Dependiente = dMEDSintoma.Sentencia(" SELECT CPREGUNTA FROM MEDSINTOMAS WHERE ICVESERVICIO = "+ request.getParameter("iCveServicio")
                                                             + " AND ICVERAMA = "+request.getParameter("iCveRama")
                                                             + "  AND ICVESINTOMA = "+request.getParameter("SintomaDep2"));
                                   }catch(Exception ex){
                                       Dependiente = "";
                                   }
                                   ...
                                   String TpoRespD = "";
                                   try{
                                       TpoRespD = dMEDSintoma.Sentencia(" SELECT ICVETPORESP FROM MEDSINTOMAS WHERE ICVESERVICIO = "+ request.getParameter("iCveServicio")
                                                             + " AND ICVERAMA = "+request.getParameter("iCveRama")
                                                             + "  AND ICVESINTOMA = "+request.getParameter("SintomaDep2"));
                                   }catch(Exception ex){
                                       TpoRespD = "";
                                    ...
                                    out.println("</tr>");
                                    out.println("<td class=\"EEtiqueta\">Dependiente de la pregunta:</td>");
                                    out.println("<td class=\"ECampo\" colspan=\"4\">"+Dependiente+"</td>");
                                    out.println("</tr>");
                                    
                                    if(TpoRespD.equals("1")){
                                        %>
                            ...
                            <% 
                                            ...
                                            */
                                            ...
                                            out.println("<input type=\"hidden\" name=\"cAlerta\" value=\"\">");
                                            out.println("<input type=\"hidden\" name=\"lDictamenF\" value=\"\">");
                 ...
                 *                                          out.println("<td class=\"ECampo\"  colspan=\"4\" >Si");
                                                           ...
                                                           String cWhere = " icveservicio = "+ request.getParameter("iCveServicio")+ " and "+
                                                                            ...
                                                                            if(request.getParameter("SintomaDep2") != null)
                                                                                    cWhere = cWhere +" icvesintoma = " + request.getParameter("SintomaDep2");
                                                                             else{
                                                                                    if(request.getParameter("SintomaDep2") != null)
                                                                                               cWhere = cWhere +" icvesintoma = " + request.getParameter("SintomaDep2");
                                                                                      else
                                      ...
                                      if(TpoRespD.equals("3") || TpoRespD.equals("5")){
                                                    %>
                                                        <input type="hidden" name="iCveSintoma" 
                                                               value="<%if(cClave.compareTo("")==0) out.print(request.getParameter("iCveSintoma")); else out.print(cClave);%>">
                                                    <%  
 ...
 *                                                  */
                                      ...
                                      if(TpoRespD.equals("2") || TpoRespD.equals("4") || TpoRespD.equals("7")){
                                                    %>
                                                        <input type="hidden" name="iCveSintoma" 
                                                               value="<%if(cClave.compareTo("")==0) out.print(request.getParameter("iCveSintoma")); else out.print(cClave);%>">
                                                    <%  
 ...
 *                                                      */
 ...
 <br><br>
                                                   ...
                                                   <%
                                                        out.println("<tr>");
                                                        out.println("<td colspan=\"4\" class=\"ETablaT\">SELECCIONA EL SÍNTOMA AL QUE SE ASOCIARA UNA DEPENDENCIA.");
                                                        out.println("</td>");
                                                        out.println("</tr>");
                                                        ...
                                                        String SQLS = " where lactivo = 1 and icveservicio = "+request.getParameter("iCveServicio")
                                                                     +" and icverama = "+request.getParameter("iCveRama")
                                                                     +" and ICVESINTOMA NOT IN ("+request.getParameter("iCveSintoma")+")  order by iCveSintoma";
                                                        String ORDS = " order by cDscServicio ";
                                                        try{
                                                                vcMEDSintoma = dMEDSintoma.FindByAllDep(SQLS);
                                                        }catch(Exception e){
                                                                vcMEDSintoma  = new Vector();
                                                        }

                                                        if(vcMEDSintoma.size() > 0){
                                                         //Imprimimos Servicios
                                                              out.println("<td class=\"ECampo\"  colspan=\"1\" >");
                                                              out.println("<SELECT id=\"LSintoma\" size=\"10\" > ");

                                                                for(int i = 0;i < vcMEDSintoma.size(); i++){
                                                                        vMEDSintoma = (TVMEDSintoma) vcMEDSintoma.get(i);
                                                                        out.println("<OPTION value=\""+vMEDSintoma.getICveSintoma()+"\">");
                                                                        out.println(vMEDSintoma.getCPregunta());
                                                                        out.println("</OPTION>");
                                                                }
                                                                out.println("</SELECT>");
                                                                out.println("</TD>");
                                                                ...
                                                                out.println("<td class=\"ECampo\"  colspan=\"1\" valign=\"center\">");
                                                                //out.println("<a href=\"#\" onclick=\"listbox_moveacross2('LSintoma', 'HSintoma')\">&gt;&gt;</a>");
                                                                out.println("<a href=\"#\" onclick=\"listbox_moveacross2('LSintoma', 'HSintoma');fIrCatalogo2();\">&gt;&gt;</a>");
                                                                out.println("<br/>");
                                                                out.println("<a href=\"#\" onclick=\"listbox_moveacross2('HSintoma', 'LSintoma')\">&lt;&lt;</a>");
                                                                out.println("</td>");


                                                                out.println("<td class=\"ECampo\"  colspan=\"1\" >");
                                                                out.println("<SELECT id=\"HSintoma\" size=\"10\" > ");
                                                                out.println("</SELECT>");
                                                                out.println("</TD>");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////                                    
                                ...
                                if(bs.getFieldValue("Logica").equals("1")){
                                  ...
                                  //        System.out.println("Activo = "+bs.getFieldValue("lActivo"));
                                  //        System.out.println("Dictamen = "+bs.getFieldValue("lDictamenF"));
                                    out.println("<td>");
