<%/**
 * Title: Habilita
 * Description: Habilita Expedientes
 * Copyright: 2011
 * @author Carlos Robles
 * @version 1.0
 * Clase:pg070107071CFG
 */%>
...
<html>
<%
  pg070107071CFG  clsConfig = new pg070107071CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setNombrePagina("pg070107071.jsp");                    // modificar
  vEntorno.setArchFuncs("FValida");
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070107071.jsp\" target=\"FRMCuerpo"); // modificar
...
<!--<SCRIPT LANGUAGE="JavaScript" SRC="C:\sct\MedprevInt\medprev\Archivos\funciones\pg070107071.js"></SCRIPT>-->
...
<input type="hidden" name="hdComputerName" value="">
  ...
  <input type="hidden" name="hdBoton">
                            ...
                            %>
                             <input type="hidden" name="hdHoy" value="<%=dtFecha.getFechaDDMMYYYY(dtFecha.TodaySQL(),"/")%>" >
                                ...
                                <%if (bs != null || lNuevo){%>
                                 ...
                                 <tr>
                                 <td colspan="4" class="ETablaT">Habilita Expediente
                                 </td>
                                 </tr>
                                 <tr>
                               ...
                               <%
                                 if (lNuevo){
                                   ...
                                   if (request.getParameter("hdiCvePersonal") != null && request.getParameter("hdiCvePersonal").compareTo("") != 0  ) 
                                   {
                                    ...
                                    TDMEDInhabilita dInhabilita = new TDMEDInhabilita();
                                    Vector vcPersonal = new Vector();
                                    Vector vcValidaInha = new Vector();
                                    vcValidaInha = dInhabilita.FindInhabilitaByAll(" iCvePersonal = "+ request.getParameter("hdiCvePersonal"));
                                    ...
                                    if (vcValidaInha.size() > 0) {
                                        ...
                                        out.println(vEti.Texto("EEtiquetaL","Habilita"));
                                        ...
                                        out.println("<tr>");
                                        out.println(vEti.TextoCS("EEtiquetaC",".:Para habilitar este expediente dar clic en botón Guardar:.",4));
                                        //out.println(vEti.Texto("EEtiquetaL","Habilita"));
                                        out.println("</tr>");
    /*
                                        out.println("<tr>");
    ...
    */	
                                    	...
                                    	out.println("<tr>");
                                        out.println(vEti.TextoCS("EEtiquetaC",".:Este expediente no necesita habilitarse:.",4));
                                        //out.println(vEti.Texto("EEtiquetaL","Habilita"));
                                        out.println("</tr>");
                                    }
                                 ...
                                 // Alta al nuevo Usuario
                                       ...
                                       if(bs != null){
                                          ...
                                          out.println(vEti.TextoCS("ETablaSTC","El Expediente " +bs.getFieldValue("iCvePersonal","&nbsp;").toString()+
                                                                   " ha quedado habilitado para realizar exámenes Psicofísico Integral.",4));
                                          out.println("</tr>");/*
