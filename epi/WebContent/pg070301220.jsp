...
<html>
<%
  pg070301220CFG  clsConfig = new pg070301220CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070301220.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070301220.jsp\" target=\"FRMCuerpo"); // modificar
                               ...
                               if (bs != null){
                                   ...
                                   while(bs.nextRow()){
                                       ...
                                       if (clsConfig.getLPagina(cCatalogo)){
                                           ...
                                           out.print(vEti.clsAnclaTexto("EAncla","Detalle","JavaScript:fIrCatalogo('" +  bs.getFieldValue("iCveCorte","") + "'," + "'pg070301220');","Ir a..."));
                                           out.print("</td>");
                                       }
                                   }
                               }
