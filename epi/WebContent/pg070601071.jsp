...
<html>
<%
  pg070601071CFG  clsConfig = new pg070601071CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setNombrePagina("pg070601071.jsp");                    // modificar
  vEntorno.setArchFuncs("FValida");
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070601071.jsp\" target=\"FRMCuerpo"); // modificar
...
<script language="JavaScript">
  ...
  //  al directorio funciones de wwwrooting en un archivo con extensión js (vg. pg070601071.js)
                               ...
                               if (lNuevo){ // Modificar de acuerdo al catálogo específico
                                ...
                                out.print("</tr>");
                                 ...
                                 out.print("<tr>");
                                   ...
                                   out.print("<td colspan='3'><input type='checkbox' name='lActivo' checked></td>");
                                 out.print("</tr>");
...
// M O D I F I C A R
                                   ...
                                   if(request.getParameter("hdBoton").compareTo("Modificar")==0){
                                     ...
                                     out.print("<tr>");
                                       ...
                                       out.print("<td class='ECampo'>" + bs.getFieldValue("iCveEmpMtto", "&nbsp;") + "</td>");
                                       out.print("<td class='EEtiqueta'>R.F.C.:</td>");
...
// V E R   D A T O S
                                     ...
                                     out.print("<tr>");
                                       out.print("<td class='EEtiqueta'>Clave:</td>");
                                       out.print("<td class='ECampo'>" + bs.getFieldValue("iCveEmpMtto", "&nbsp;") + "</td>");
                                       out.print("<input type='hidden' name='iCveEmpMtto' value='" + bs.getFieldValue("iCveEmpMtto", "&nbsp;") + "'>");
                                       out.print("<td class='EEtiqueta'>R.F.C.:</td>");
                                     ...
                                     out.print("<tr>");
                                       ...
                                       out.print("<td class='EEtiqueta'>Persona:</td>");
                                       if(bs.getFieldValue("cTpoPersona", "&nbsp;").toString().compareTo("F")==0)
                                         out.print("<td class='ECampo'>Física</td>");
                                       else
                                     ...
                                     out.print("<tr>");
                                       ...
                                       if(Integer.parseInt(""+bs.getFieldValue("lActivo"))==0)
                                         out.print("<td class='ECampo' colspan='3'>INACTIVO</td>");
                                       else
                                         out.print("<td class='ECampo' colspan='3'>ACTIVO</td>");
                                     out.print("</tr>");
                                   }
                                 }
                                 else{
