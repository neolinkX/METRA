...
<% //Variables
  ...
  TDEXPSERVPRef dEXPSERVPRef = new TDEXPSERVPRef();
           ...
           if(request.getParameter("hx1") != null){
               ...
               <%}else{ %>
                           alert("El punto de referencia Torax Anterior ha sido guardado exitosamente\n");
                   <%}%>
                            window.close();
                    }    
...
%>               
            ...
            form = document.forms[0];
                ...
                $('#preview img').css({
                    ...
                    //height: Math.round(scaleY * 300),
                            width: Math.round(scaleX * 403),
                    height: Math.round(scaleY * 273),
            ...
            <tr bgcolor="#088A08">
                <td width="572"><div align="center"><span class="Estilo4">TORAX ANTERIOR </span></div></td>
            </tr>
            <tr bgcolor="#FBFBEF">
                <td><div align="justify" class="Estilo3">TORAX ANTERIOR: EN EL DIBUJO SE DETERMINARÁ EL LUGAR EN DÓNDE SE ENCUENTRA UBICADA LA ALTERACI&Oacute;N O ANORMALIDAD ENCONTRADA, UNA VEZ QUE SEA SELECCIONADA EN AUTOM&Aacute;TICO EL SISTEMA DETERMINAR&Aacute; LAS COORDENADAS ANAT&Oacute;MICAS.</div></td>
            </tr>
            </table>
            <br>
            ...
            <div style="float: left; width: 67%;">
                ...
                <div class="frame" style="margin: 0 0.3em; width: 403px; height: 273px;">
                <img src="<%=vParametros.getPropEspecifica("RutaImgServer")%>torax.jpg" width="403" height="273" id="photo" />    </div>
            </div>
            ...
            <div style="float: left; width: 32%;">
                ...
                <div id="preview" style="width: 100px; height: 100px; overflow: hidden;">
                    <img src="<%=vParametros.getPropEspecifica("RutaImgServer")%>torax.jpg" style="width: 100px; height: 100px;" />
                </div>
                </div>

                <table style="margin-top: 1em;">
                <form name="formulario" method="post" action="CapRef70.jsp">
                <thead>
                    <tr>
