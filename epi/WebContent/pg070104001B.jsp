...
<%
  ...
  pg070104001BCFG  clsConfig = new pg070104001BCFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070104001B.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070104001B.jsp\" target=\"FRMCuerpo"); // modificar
  vEntorno.setUrlLogo("Acerca");
  vEntorno.setBtnPrincVisible(true);
  vEntorno.setArchFCatalogo("FFiltro");
  vEntorno.setArchAyuda(vEntorno.getNombrePagina());

  String cCatalogo    = "pg070104001B.jsp";       // modificar
             ...
             vPerDatos=clsConfig.findUser();
              ...
              if (request.getParameter("hdType").toString().equalsIgnoreCase("E")){
               ...
               if (request.getParameter("hdType").toString().equalsIgnoreCase("B")){
                 vPerDatos=clsConfig.DeleteExam();
                 if(vPerDatos!=null){
                     vPerDatos=clsConfig.findExamenToDelete();
                        //RESULTADOBORRADO = "NO SE PUDO BORRAR EL EXAMEN YA QUE SE TIENE UNA LICENCIA EXPEDIDA";
                          RESULTADOBORRADO = "NO SE PUDO BORRAR EL EXAMEN <br>"
                                           + "(DEBE SER  EL ULTIMO EXAMEN GENERADO, NO HABER SIDO DICTAMINADO Y SER UN EPI O UN EMO)";
                     }else{
                        RESULTADOBORRADO = "EL EXAMEN FUE BORRADO";
                     }
              }
          }
       }
...
%>
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
      ...
      <td valign="top">
        ...
        <tr><td align="center" colspan="4" class="EResalta">Busqueda de examen</td></tr>
                            <tr>
                              <td colspan="5" class="ETablaT">Examen a eliminar
                              </td>
                            </tr>
                        ...
                        <script language>
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            ...
                            <tr>
                                <td>
                                    <%out.print(vEti.clsAnclaTexto("EAncla","Borrar Examen","JavaScript:fBorrarExamen();", "Buscar Expediente",""));%>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
