...
<html>
<%
  pg070801040CFG  clsConfig = new pg070801040CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070801040.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070801040.jsp\" target=\"FRMCuerpo"); // modificar
  vEntorno.setUrlLogo("Acerca");
  vEntorno.setBtnPrincVisible(true);
  vEntorno.setArchFCatalogo("FFiltro");
  vEntorno.setArchAyuda(vEntorno.getNombrePagina());

  String cCatalogo    = "pg070801041.jsp";       // modificar
  String cDetalle    = "pg070801041.jsp";       // modificar
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
      ...
      <td valign="top">
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            <tr>
                              <td colspan="6" class="ETablaT">Áreas de los Almacenes
                              </td>
                            </tr>
                          <tr>
                                 <%
                                 ...
                                 if(request.getParameter("iCveAlmacen")==null || request.getParameter("iCveAlmacen").compareTo("")==0) {
                                   vALMAlmacen.setCDscAlmacen("Seleccione...");
                                   vALMAlmacen.setICveAlmacen(0);
                                   vcALMAlmacen.add(vALMAlmacen);
                                 }
                                 out.print(vEti.Texto("ETablaTR", "Almacén:"));
                                 out.println("<td colspan='5'>");
                                 out.println(vEti.SelectOneRowSinTD("iCveAlmacen", "document.forms[0].target='FRMDatos';document.forms[0].hdBoton.value='Primero';document.forms[0].submit();", vcALMAlmacen, "iCveAlmacen", "cDscAlmacen", request, "0"));
                                 out.println("</td>");
                                 %>
                          </tr>
                            <%
                              // modificar según listado
                               if (bs != null){
                                   ...
                                   out.print("<td class=\"ETablaT\">Tipo de Artículo</td>");
                                   ...
                                   while(bs.nextRow()){
                                     ...
                                     if(clsConfig.getLPagina(cDetalle)){
                                       ...
                                       out.print(vEti.clsAnclaTexto("EAncla","Detalle","JavaScript:fIrDetalle('" + bs.getFieldValue("iCveAlmacen") + "', '" + bs.getFieldValue("iCveArea") + "');", ""));
                                       out.print("</td>");
                                     }
                                     out.print("</tr>");
                                   }
