...
<script language="JavaScript">
  ...
  //  al directorio funciones de wwwrooting en un archivo con extensión js (vg. pg070101021.js)
...
<form method="<%= vEntorno.getMetodoForm() %>" action="<%= vEntorno.getActionForm() %>">
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                              <td colspan="6" class="ETablaT">Diagnóstico
                              </td>
            ...
            <tr>
              ...
              out.print("</tr>");
                               ...
                               if (lNuevo){ // Modificar de acuerdo al catálogo específico
                                 ...
                                 out.println("</tr>");
                                 out.println("<td class=\"EEtiqueta\">Diagnóstico:<br><p class=\"EPieR\">Caract. disponibles:<br><input type=\"text\" size=\"5\" name=\"iNoLetras2\" value=\"\" disabled></p></td>");
                                 %>
                                 <td>
                                 ...
                                 <%
                                 out.println("<tr>");
                                 out.print(vEti.EtiCampo("EEtiqueta", "Descripción Breve:", "ECampo", "text", 100, 100, "cDscBreve", "", 3, "", "fMayus(this);", false, true, lCaptura));
                                 out.println("</tr>");
                                 ...
                                 if(request.getParameter("hdBoton").compareTo("Modificar")==0){
                                   ...
                                   out.print("<tr>");
                                   out.print(vEti.Texto("EEtiqueta", "Diagnóstico:"));
                                   out.print("<td class='EEtiqueta' align='center'>");
                                 ...
                                 out.println("<tr>");
                                 out.print(vEti.EtiCampo("EEtiqueta", "Descripción Breve:", "ECampo", "text", 100, 100, "cDscBreve", ""+bs.getFieldValue("cDscBreve", "&nbsp;"), 3, "", "fMayus(this);", false, true, lCaptura));
                                 out.println("</tr>");
                                 if(request.getParameter("hdBoton").compareTo("Modificar")==0){
                                   out.print("<tr>");
                                   out.println("<td class=\"EEtiqueta\">Observaciones:<br><p class=\"EPieR\">Caract. disponibles:<br><input type=\"text\" size=\"5\" name=\"iNoLetras\" value=\"\" disabled></p></td>");
