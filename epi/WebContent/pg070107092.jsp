...
<html>
<%
  pg070107092CFG  clsConfig = new pg070107092CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070107092.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070107092.jsp\" target=\"FRMCuerpo"); // modificar
...
<link rel="stylesheet" type="text/css" href="/medprev/extjs/examples/ux/FilterRow/FilterRow.css"/>
<script type="text/javascript" src="/medprev/extjs/examples/ux/FilterRow/FilterRow.js"></script>
...
<script type="text/javascript" src="<%=vParametros.getPropEspecifica("RutaFuncs")%>pg070107092.js"></script>
</head>
