...
<html>
<%
  pg070101107CFG  clsConfig = new pg070101107CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070101107.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070101107.jsp\" target=\"FRMCuerpo"); // modificar
  vEntorno.setUrlLogo("Acerca");
  vEntorno.setBtnPrincVisible(true);
  vEntorno.setArchFCatalogo("FFiltro");
  vEntorno.setArchAyuda(vEntorno.getNombrePagina());

  String cCatalogo    = "pg070101107.jsp";       // modificar
  String cReordenar   = "pg070101108.jsp";       // modificar
...
<!--<SCRIPT LANGUAGE="JavaScript" SRC="C:\sct\MedprevInt\medprev\Archivos\funciones\pg070101107.js"></SCRIPT> -->
...
<form method="<%= vEntorno.getMetodoForm() %>" action="<%= vEntorno.getActionForm() %>">
  ...
  <!--<input type="hidden" name="iCveSintoma" value="">-->
      ...
      <td valign="top">
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            <tr>
                              <td colspan="11" class="ETablaT">Consulta de la Configuración de preguntas dependientes
                              </td>
                            </tr>
                  <%          
                      if (bs != null){
                  %>
                            <tr>
                              ...
                              <td class="ETablaT">Transporte:</td>
                    ...
                    %>
                              ...
                              <!--<td class="ETablaT">Descripción de la regla:</td>-->
                             ...
                             <% // modificar según listado
                                  ...
                                  String cGenero ="";
                                   ...
                                   while(bs.nextRow()){
                                      ...
                                      //out.print(vEti.Texto("ETabla",""+ bs.getFieldValue("cdscRegla", "&nbsp;")));
                                      ...
                                      out.println("</tr>");
                                        ...
                                        <tr>
					<td colspan="11" class="ETablaC">No existe dependencia para este síntoma.</td>
					</tr>
                               <%}
                            %>
                          </table>
