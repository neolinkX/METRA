  ...
  <div class="m-portlet__head" style="background:#f7f8fa">
     <div class="m-portlet__head-caption">
       <div class="m-portlet__head-title">
          ...
          <img src="img/servicios/report.svg" width="20" class="svg-inject signal-strong">
          </span>
          <h3 class="m-portlet__head-text m--font-primary">
             Consulta de Biom&eacute;tricos
          </h3>
       </div>
     </div>
...
<iframe width="1200" height="700" src="pg070103043-2.jsp?hdBoton=1&numExpediente=<%=session.getAttribute("id")%>" scrolling="no"  frameborder="0" allowfullscreen></iframe>