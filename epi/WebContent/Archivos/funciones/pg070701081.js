  function fValidaTodo(){
    ...
    if (form.hdBoton.value == 'Guardar' || form.hdBoton.value == 'GuardarA') {
      ...
      if((form.cTpoPersona[0].checked && form.cApPaterno.value=="") || (form.cTpoPersona[0].checked && form.cApMaterno.value==""))
        cVMsg = cVMsg + "\n - Para una persona física, escriba Nombre, Primer Apellido y Segundo Apellido.";
  ...
  function llenaSLT(opc,val1,val2,val3,objDes){
    if(objDes!=''){
      if(objDes.name!=''){
           ...
           window.parent.FRMOtroPanel.location="pg070701081P.jsp?opc=" + opc + "&val1=" + val1 + "&val2=" + val2 + "&val3=" + val3 + "&objDes=" + objDes.name + '&hdAccion=' + document.forms[0].action;
      }
      else {
