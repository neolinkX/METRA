  function fPag1(){
    ...
    cp=cp+'                 <br /><br /><br /><br />';
    cp=cp+'                 &nbsp;&nbsp;&nbsp;<input type="text" size="17" maxlength="12" name="FILUsuario" value="'+cEntrada+'"; onfocus="this.select();" onMouseOut="if (window.fOutField) window.fOutField();" onMouseOver="if (window.fOverField) window.fOverField(1);" />';
    cp=cp+'                 &nbsp;&nbsp;<input type="password" size="17" maxlength="10" name="FILContrasena" value=""; onfocus="this.select();" onKeyPress="fCheckReturn(event);" onMouseOut="if (window.fOutField) window.fOutField();" onMouseOver="if (window.fOverField) window.fOverField(2);" />';
    ...
    cp=cp+'                 <td><img src="'+cRutaImgServer+'lsct.jpg" /></td>';
    cp=cp+'             </tr>';
    cp=cp+'             <tr>';
    cp=cp+'                 <td colspan="2">';
