	...
	if (fValidaTodo()) {
     ...
     function fCompleta(forma, valor){
          ...
          var x=forma.SLSOperador.length;

          var z=forma.SLSOperador.selectedIndex;
          ...
          if (valor != x) {
             ...
             case 5:    if (x > 7){
                          ...
                          for(i=x; i > 7; i--){
                             ...
                             forma.SLSOperador.options[i-1] = null;
             ...
             case 7:    if (x > 7){
                ...
                case 8: if( x > 8){
                        ...
                        forma.SLSOperador.options[8] = null;
                        ...
                        if( x < 8){
                           ...
                           forma.SLSOperador.options[7] = opcion;
                ...
                case 9: if( x < 8){
                        ...
                        if( x < 9){
                           ...
                           forma.SLSOperador.options[8] = opcion;
     ...
     function fValida(forma, valor){
      ...
      if (forma.SLSOperador.selectedIndex != 0) {
  ...
  if(cWindow.parent.parent.FRMCuerpo){
    ...
    if (wp.FRMUpdPanel){
      ...
      if (wp.FRMOtroPanel.cambiaEstado){
        ...
        if(wp.FRMOtroPanel.fTitulo)
          wp.FRMOtroPanel.fTitulo(cAccion);
      }
    }
    if(wpp.FRMTitulo){
     ...
     if(cValor.value != ''){         
        ...
        if (Tipo == 1){
           if(!fSoloLetras(cValor.value))
             cVMsg1 = "\n - El campo '" + cNombre + "' solo permite caracteres alfab�ticos.";
        }
        if (Tipo == 2){
           if(!fSoloAlfanumericos(cValor.value))
             cVMsg1 = "\n - El campo '" + cNombre + "' solo permite caracteres alfanum�ricos.";
        }
        if (Tipo == 3){
           if(!fSoloNumeros(cValor.value))
             cVMsg1 = "\n - El campo '" + cNombre + "' solo permite caracteres num�ricos.";
        }
        if (Tipo == 4){
        ...
        if (Tipo == 6){
            //if(!fSoloNumeros(cValor.value)){
        	if (isNaN(cValor.value)) {
            	cVMsg1 = "\n - El campo '" + cNombre + "' solo permite valores de tipo fecha [aaaammdd].";
            }else{
            	if(cValor.value.length < 8){
            		cVMsg1 = "\n - El campo '" + cNombre + "' solo permite valores de tipo fecha [aaaammdd].";            		
            	}
            }
         }
