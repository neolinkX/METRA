...
function fValidaTodo(){
    ...
    if (form.hdBoton.value != 'Cancelar' && form.hdBoton.value != 'Nuevo') {
      cVMsg = '';
      if (form.iCveUniMed)
        cVMsg = cVMsg + fSinValor(form.iCveUniMed,3,'Unidadédica:', true);
      if (form.iCveModulo){
    ...
    /*if (form.cGenero){
       ...
       if (form.cGenero.value != null){ 
          cVMsg = cVMsg + fSinValor(form.(form.cGenero ,1,'G�nero', true);
       }
       else{
     ...
     if (form.cLicencia.length > 13){
         cVMsg = cVMsg + "\n - La Licencia de la Persona Física es Incorrecta. \n";
      }
      
     if (form.cLicenciaInt.length > 13){
         cVMsg = cVMsg + "\n - La Licencia Int. de la Persona Física es Incorrecta. \n";
      }
