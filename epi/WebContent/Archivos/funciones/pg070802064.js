  function llenaSLT(opc,val1,val2,val3,objDes,objDes2,objDes3){
     ...
     if(objDes!=''){
        if(objDes.name!=''){
           ...
           window.parent.FRMOtroPanel.location="pg070802060P.jsp?opc=" + opc + "&val1=" + val1 + "&val2=" + val2 + "&val3=" + val3 + "&objDes=" + objDes.name;
        } else {
       ...
       window.parent.FRMOtroPanel.location="pg070802064P.jsp?opc=" + opc + "&val1=" + val1 + "&val2=" + val2 + "&val3=" + val3 + "&objDes=" + objDes.name;
    }
  }
