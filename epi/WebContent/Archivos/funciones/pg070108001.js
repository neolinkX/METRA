...
function fValidaTodoOriginal(){
    ...
    if (form.hdBoton.value != 'Cancelar' && form.hdBoton.value != 'Nuevo') {
      ...
      if (form.cCantidad){
          if (form.cCantidad.value <= 0 || form.cCantidad.value == ""){
            cVMsg = cVMsg + " - Debe agregar la cantidad. \n";
          }
      }


      if (form.cTarifa){
          if (form.cTarifa.value <= 0 || form.cTarifa.value == ""){
             cVMsg = cVMsg + " - Debe agregar el monto. \n";
          }
      }
