    ...
    return {
        ...
        buildLayout : function() {
            ...
            var comboSistema = new Ext.form.ComboBox({
                ...
                valueField: 'lLicencia',
                displayField: 'sistema'
            });
            comboSistema.setValue(comboSistema.store.getAt(1).get('lLicencia'));
            
            // create the combo instance
            var comboSistemaModificar = new Ext.form.ComboBox({
                typeAhead: true,
                triggerAction: 'all',
                lazyRender:true,
                width:150,
                ...
                valueField: 'lLicenciaModificar',
                displayField: 'sistemaModificar'
            });
            comboSistemaModificar.setValue(comboSistemaModificar.store.getAt(1).get('lLicencia'));
         ...
         // create the combo instance
            var comboTransporte = new Ext.form.ComboBox({
                ...
                valueField: 'iTransporte',
                displayField: 'transporte'
            });
            comboTransporte.setValue(comboTransporte.store.getAt(1).get('iTransporte'));
            
            // create the combo instance
            var comboTransporteModificar = new Ext.form.ComboBox({
                typeAhead: true,
                triggerAction: 'all',
                lazyRender:true,
                width:150,
                ...
                valueField: 'iTransporteModificar',
                displayField: 'transporteModificar'
            });
            comboTransporteModificar.setValue(comboTransporteModificar.store.getAt(1).get('iTransporte'));
            ...
            var txtLLICENCIASBuscar = new Ext.form.TextField({
                fieldLabel: 'Sistema',
                width: 150,
                id : 'txtLLICENCIABuscar',
                name : 'txtLLICENCIABuscar'
            });
            
            var txtICVEMDOTRANSBuscar = new Ext.form.TextField({
                fieldLabel: 'Transporte',
                width: 150,
                id : 'txtICVEMDOTRANSBuscar',
                name : 'txtICVEMDOTRANSBuscar'
            });
            ...
            var searchUsuarioBtnHandler = function(btn) {
                ...
                if(CUSUARIO!=""||ICVEUSUARIO!=""||CNOMBRE!=""||CAP!=""||CAM!=""){
                    AdmonUsuarios.findUsuario(CUSUARIO,ICVEUSUARIO, CNOMBRE,CAP,CAM,{
            ...
            var searchExpedienteBtnHandler = function(btn) {
                ...
                if(ICVEEXPEDIENTE!=""||CRFC!=""||CNOMBRE!=""||CAP!=""||CAM!=""){
                    AdmonUsuarios.findExpediente(ICVEEXPEDIENTE,CRFC, CNOMBRE,CAP,CAM,{
                        callback : function (data){
                            if (data.success) {
                                //Ext.Msg.hide();
                                //alert("traigo datos" +  data.data);
            ...
            gridUsuarios = new Ext.grid.GridPanel({
                ...
                id : 'gridUsuarios',
                name : 'gridUsuarios',
                //title:'Resultado de la bï¿½squeda de usarios',
                ds : storeUsuarios,
                autoScroll : 'auto',
                //                        width : 500,
                height : 200,
            ...
            ventanaMod = new Ext.Window({
                ...
                items : [{
                    ...
                    align : 'center',
                    items:[searchUsuario,
                    searchExpediente,comboDedos,comboSistema,comboTransporte],
                    buttonAlign : 'center',
                    buttons: [{
                        text:'Guardar',
                        ...
                        handler: function(){
                            ...
                            AdmonUsuarios.guardaAccesoUsuario(searchUsuario.getValue(),searchExpediente.getValue(), comboDedos.getValue(),usuarioSesion,comboSistema.getValue(),comboTransporte.getValue(),{
                                callback : function (data){
                                    if (data.success) {
            ...
            ventanaModificar = new Ext.Window({
                ...
                items : [{
                    ...
                    txtICVEEXPEDIENTEModificar,comboDedosModificar, comboSistemaModificar,comboTransporteModificar],
                    buttonAlign : 'center',
                    buttons: [{
                        text:'Modificar',
                        ...
                        handler: function(){
                            var usuarioSesion = document.getElementById('iCvePersonal').value;
                            AdmonUsuarios.modificaAccesoUsuario(txtiCveUSUARIOModificar.getValue(),txtICVEEXPEDIENTEModificar.getValue(), comboDedosModificar.getValue(),usuarioSesion,comboSistemaModificar.getValue(),comboTransporteModificar.getValue(),{
                                callback : function (data){
                                    if (data.success) {
            ...
            var gridMovimientos = new Ext.grid.GridPanel({
                ...
                layout: 'fit',
                autoScroll : true,
                title:'Consulta asignaciones de acceso login por huella.',
                anchor: '100%',
                frame: true,
                //autoHeight : true,
                monitorResize: true,
                ...
                '-','-',{
                    ...
                    handler: function(){
                        ...
                        comboSistemaModificar.setValue(comboSistema.store.getAt(1).get('lLicencia'));
                        comboTransporteModificar.setValue(comboSistema.store.getAt(1).get('iTransporte'));
                        ventanaMod.show();
                    }
                },'-','-',{
                    text:'Modificar',
                    ...
                    handler:function(){
                        ...
                        if(registro != null && registro !=""){
                            ...
                            //comboSistemaModificar.setValue(comboSistemaModificar.store.getAt(registro.get('LLICENCIAS')-1).get('lLicencia'));
                            //comboTransporteModificar.setValue(comboSistemaModificar.store.getAt(registro.get('ICVEMDOTRANS')-1).get('iTransporte'));
                    ...
                    handler:function(){
                        var registro = Ext.getCmp('gridMovimientos').getSelectionModel().getSelected();
                        if(registro != null && registro !=""){
                        	if(confirm('Deseas realmente borrar este registro?')){
                            	AdmonUsuarios.deleteUsuXExpLogin(registro.get('ICVEUSUARIO'),registro.get('ICVEEXPEDIENTE'),{
                                    callback : function (data){
                                        if (data.success) {
                                            //Ext.Msg.hide();
                            ...
                            alert("Selecciona un registro de la lista para poder eliminarlo");
                        }
...
Ext.EventManager.onDocumentReady(pg070107091.init, pg070107091, true);
