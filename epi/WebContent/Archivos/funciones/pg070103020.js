  ...
  function fGetFoto(){
     ...
     if((wExp != null) && (!wExp.closed))
        wExp.focus();
           ...
           cPagina = '<HTML><title>Guardar Fotografía</title>'+cStyle+'\n'+
           ...
           '<tr><td class="ETablaT" align="center">Archivo de Fotografía<tr><td>'+
           ...
           '</td></tr>'+
           '<tr><td align="center">\n'+
           '<A HREF="javascript:fSavePict();">Guardar Fotografía</A>\n'+
           '</td></tr>\n'+
           '</table>\n'+
           '</form></body></HTML>\n';
  ...
  function fGetFirma(){
     ...
     if((wExp != null) && (!wExp.closed))
        wExp.focus();
           ...
           '      alert("Nombre" + cArchivo + " Archivo " + form.fArchivo.value );\n'+
           '    if(form.fArchivo.value != cArchivo) \n'+
           '      alert("El archivo seleccionado no es el correcto! \\n " + form.fArchivo.value + " <> " + cArchivo);\n'+
           '    else\n'+
           '      form.submit();\n'+
  ...
  function fGetHuella(iCveHuella){
     ...
     if((wExp != null) && (!wExp.closed))
        wExp.focus();
           ...
           '    if(form.fArchivo.value.toUpperCase() != cArchivo.toUpperCase()) \n'+
           '      alert("El archivo seleccionado no es el correcto! \\n " + form.fArchivo.value + " <> " + cArchivo);\n'+
           '    else\n'+
           '      form.submit();\n'+
           '  }\n'+
