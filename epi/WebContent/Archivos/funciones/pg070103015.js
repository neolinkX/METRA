...
// FUNCIï¿½N PARA VALIDAR LA INFORMACIï¿½N DEL PERSONAL
function fValidaTodo(){
   ...
   if (form.hdBoton.value == 'Guardar' || form.hdBoton.value == 'GuardarA') {
      cVMsg = '';
      if (form.iCveUniMed)
        cVMsg = cVMsg + fSinValor(form.iCveUniMed,3,'Unidad Mï¿½dica:', false);
      if (form.dtFecha)
...
/*      if (form.cGenero)
        cVMsg = cVMsg + fSinValor(form.cGenero,1,'Gï¿½nero:', false);*/
      ...
      if (form.cRFC){
         ...
         if ( fValRFC(form.cRFC.value,1) == false)
           cVMsg = cVMsg + "\n - El RFC de la Persona Fï¿½sica es Incorrecto. \n";
      }
      //if (form.cRFC)
...
// Validaciï¿½n y Generaciï¿½n del Expediente
