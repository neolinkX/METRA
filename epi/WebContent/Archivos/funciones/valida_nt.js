...
/* ****************************************************
  ...
  function fNumEntries(cCadena, cSep){
     i = 0;
     for (j = 0; j < cCadena.length; j++) {
        if(cCadena.substring(j,j+1) == cSep){
          i++;
        }
     }
     return i;
  ...
  function fEntry(iEntry, cCadena, cSep){
     i = 0; cCad2 = '';
     for (j = 0; j < cCadena.length; j++) {
        cCad2 = cCad2 + cCadena.substring(j,j+1);
        if(cCadena.substring(j,j+1) == cSep){
          i++;
          if(i == iEntry){
