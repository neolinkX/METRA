...
function fGuarda(){
    ...
    listbox_selectall2('HServicio', true);
  		form = document.forms[0];
		len = document.forms[0].HServicio.length;
		i = 0;
		//chosen = "" ;
		for (i = 0; i < len; i++) {
			if (document.forms[0].HServicio[i].selected) {
				servicios = servicios + document.forms[0].HServicio.options[i].value + "/";
			} 
		}		
...
///////////////////////////////////////////////////////////	
    ...
    form.cServicios.value = servicios;
