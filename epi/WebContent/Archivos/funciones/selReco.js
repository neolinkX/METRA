  ...
  function fLoadRecoID(){
    ...
    if(iLength > 0){
      ...
      fInsCellReco(2,'Recomendación','ETablaT',2);      
      ...
      for(i=0;i < iLength;i++){
        ...
        if(meEsp[0] == form.iCveEspecialidad2.value){
          ...
          if(lIns){
            ...
            fInsCellReco(3,'<A HREF="javascript:if(!window.opener.closed)window.opener.fSetReco('+"'"+meEsp[4]+"'"+');else{window.close();}">Selección...</A>');
            j++;
          }
        }
      }
