function fPag1(){
    var cp = '';
    cp=cp+'<!DOCTYPE html><head><SCRIPT LANGUAGE="JavaScript" SRC="'+cRutaFuncs+'toolbars.js"></SCRIPT>';
    ...
    cp=cp+'                 &nbsp;&nbsp;<input type="password" size="17" maxlength="20" name="FILContrasena" value=""; onfocus="this.select();" onKeyPress="fCheckReturn(event);" onMouseOut="if (window.fOutField) window.fOutField();" onMouseOver="if (window.fOverField) window.fOverField(2);" />';
