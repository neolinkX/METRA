...
<%
System.out.println(request.getParameter("iCvePersonal"));
System.out.println(request.getParameter("iCveExpersonal"));
...
<form action="MostrarArchivoServlet" method="get">
     ...
     <table width="700" border="0">
         ...
         String SQL = "SELECT LINTICVEDOCUMEN FROM EXPSERVARCHCM " +
                       ...
                       // " AND ICVEMULTA = "+request.getParameter("iCveMulta")+
                        " ORDER BY TSGENERADO";
		...
		while (it.hasNext()) {
			String[] values = (String[]) it.next();
                ...
                if(contadorArchivos==0){
                    ...
                    out.print("alert('No se encontraron Voucher para este expendiente');");
        ...
        //servArch.EliminaDocsFallidosNAS();
        %>
     </table>
     </form>
</body>
