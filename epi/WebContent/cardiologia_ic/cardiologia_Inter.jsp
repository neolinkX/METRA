...
session.setAttribute("servicio","65");    /////////////////////////MODIFICAR LA CLAVE DEL SERVICIO (TABLA MEDSERVICIO)/////////////////////////////////////////////
      ...
      <div class="m-portlet__head-caption">
         <div class="m-portlet__head-title">
            <span class="m-portlet__head-icon">
              <img src="<%=vParametros.getPropEspecifica("RutaImgServerExp")%>servicios/cardiologia.svg" width="20" class="svg-inject signal-strong">
            </span>
            <h3 class="m-portlet__head-text m--font-primary">
               EVALUACION  CARDIOLOGICA NOM024
            </h3>
         </div>
      </div>
...
<%@ include file="/cardiologia_ic/preguntasCardiologia_ic.jsp"%>
  </div>
