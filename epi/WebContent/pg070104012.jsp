<%-- 
    Document   : pg070104012
    Created on : 21/05/2012, 04:09:32 PM
    Author     : AG
--%>
<%/**
...
<html>
<%
  pg070104012CFG  clsConfig = new pg070104012CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070104012.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070104012.jsp\" target=\"FRMCuerpo"); // modificar
...
%>
                            ...
                            <%
                               if (bs != null){
                                   ...
                                   String exm = bs.getFieldValue("iNumExamenf","").toString();
