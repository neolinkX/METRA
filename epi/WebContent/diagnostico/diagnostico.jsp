     ...
     <div class="m-portlet__head-caption">
       <div class="m-portlet__head-title">
          ...
          <h3 class="m-portlet__head-text m--font-primary">
             Diagn&oacute;stico y Recomendaciones del Dictaminador
          </h3>
       </div>
     </div>
...
<iframe width="1200" height="1100" src="pg070105011-2.jsp" scrolling="no"  frameborder="0" allowfullscreen></iframe>