...
<html>
<%
  pg070501011CFG  clsConfig = new pg070501011CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setNombrePagina("pg070501011.jsp");                    // modificar
  vEntorno.setArchFuncs("FValida");
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070501011.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  String cCveOrdenar  = "iCveMedRecep|cDscMedRecep|";  // modificar
  String cDscFiltrar  = "Clave|Descripción|";    // modificar
  String cCveFiltrar  = "iCveMedRecep|cDscMedRecep|";  // modificar
...
<script language="JavaScript">
  ...
  //  al directorio funciones de wwwrooting en un archivo con extensión js (vg. pg070501011.js)
...
<form method="<%= vEntorno.getMetodoForm() %>" action="<%= vEntorno.getActionForm() %>">
  ...
  <%
     if (bs != null){ // Agregar tanto Hds como variables dependiendo del campo llave.
       ...
       cClave  = ""+bs.getFieldValue("iCveMedRecep", "");
     }
  %>
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                              <td colspan="6" class="ETablaT">Medio de Recepción
                              </td>
                               <%
                               if (lNuevo){ // Modificar de acuerdo al catálogo específico
                                 ...
                                 out.println("</tr>");
                                 out.println("<tr>");
                                 out.print(vEti.EtiCampo("EEtiqueta", "Descripción:", "ECampo", "text", 30, 20, "cDscMedRecep", "", 3, "", "fMayus(this);", true, true, lCaptura));
                                 out.println("</tr>");
                                 out.println("<tr>");
                                 ...
                                 if (bs != null){
                                   out.println("<tr>");
                                   out.print(vEti.EtiCampo("EEtiqueta", "Clave:", "ECampo", "text", 4, 4, "iCveMedRecep", ""+bs.getFieldValue("iCveMedRecep", "&nbsp;"), 3, "", "", true, true, false));
                                   out.println("</tr>");
                                   out.println("<tr>");
                                   out.print(vEti.EtiCampo("EEtiqueta", "Descripción:", "ECampo", "text", 30, 20, "cDscMedRecep", ""+bs.getFieldValue("cDscMedRecep", "&nbsp;"), 3, "", "fMayus(this);", true, true, lCaptura));
                                   out.println("</tr>");
