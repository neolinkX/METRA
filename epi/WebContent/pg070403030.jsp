...
<html>
<%
  pg070403030CFG  clsConfig = new pg070403030CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070403030.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070403030.jsp\" target=\"FRMCuerpo"); // modificar
                                   ...
                                   while(bs.nextRow()){
                                     ...
                                     if(!vAccidentes.isEmpty()){
                                       for(int i=0;i<vAccidentes.size();i++){
                                         ...
                                         if (VINVRegistro.getICveEstado() == new Integer(bs.getFieldValue("iCveSituacion", "").toString()).intValue()){
