...
<html>
<%
  pg0703060100CFG  clsConfig = new pg0703060100CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg0703060100.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg0703060100.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  function generaXLS(tipo) {
    ...
    if (lICveLaboratorio == true &&
        ...
        if (tipo == 1) {
            ...
            " <body>"+
            "<form method=\"post\" action=\"servXLSpg0703060100?iCveLaboratorio=" + form.iCveLaboratorio.value + "&SLSSustancia=" + getComboValue(form.SLSSustancia) + "&dtFechaI=" + form.dtFechaI.value + "&dtFechaF=" + form.dtFechaF.value + "&iCveEquipo=" + getRadioValue(form.iCveEquipo) + "\"" +
  ...
  <tr>
     ...
     <td valign="top">
        ...
        <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
          <tr><td colspan="8" class="ETablaT">Registro y Comportamiento de Controles para An&aacute;lisis Confirmatorio</td></tr>
