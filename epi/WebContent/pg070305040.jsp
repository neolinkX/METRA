...
<html>
<%
  pg070305040CFG  clsConfig = new pg070305040CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070305040.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070305040.jsp\" target=\"FRMCuerpo"); // modificar
        ...
        <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
          ...
          <tr>
             ...
             %>
                  ...
                  out.println(vEti.EtiCampo("EEtiqueta","Lote Cuantitativo:", "ETabla","text",4,4,"iCveLoteCuantita","",0,"","",true,true, true, request));
             %></tr>
            <tr><%
      ...
      <td valign="top">&nbsp;
                          ...
                          <% if (bs != null){ %>
                            <tr>
                              ...
                              <td class="ETablaT">Calibraci&oacute;n</td>
                              <td class="ETablaT">Calibración<br>Correcta</td>
                              <td class="ETablaT">An&aacute;lisis</td>
                              <td class="ETablaT">Autorizaci&oacute;n</td>
                              <td class="ETablaT">Analis.</td>
                              <td class="ETablaT">Autor.</td>
                              <td class="ETablaT">Negat.</td>
                              <td class="ETablaT">Posit.</td>
                              <td class="ETablaT" colspan="2">Analizado por</td>
                            </tr>
                             <% // modificar según listado
                             TVTOXLoteCuantDetalle Lote;
                             TFechas Fecha = new TFechas();
                             for(int i=0; i < clsConfig.VRegistros.size(); i++){
                                Lote = new TVTOXLoteCuantDetalle ();
                                Lote = (TVTOXLoteCuantDetalle) clsConfig.VRegistros.get(i);
                                out.print("<tr class=\"ETabla\">");
                                out.print(vEti.Texto("ETabla",  Lote.VLote.VSustancia.getCPrefLoteConf()));
                                out.print(vEti.Texto("ETablaR",  Lote.VLote.getiCveLoteCuantita().toString()));
                                ...
                                out.print(vEti.Texto("ETablaC",  Lote.VLote.getdtCalibracion()  != null? Lote.VLote.getlValidaCalib().intValue() == 1?"Sí":"No" : "-" ));
                                ...
                                out.print(vEti.Texto("ETablaR",  String.valueOf(Lote.getIAutorizados())));
                                out.print(vEti.Texto("ETablaR",  String.valueOf(Lote.getINegativos())));
                                out.print(vEti.Texto("ETablaR",  String.valueOf(Lote.getIPositivos())));
                                out.print(vEti.Texto("ETabla",  Lote.getCUsuAnalista() != null ? Lote.getCUsuAnalista() : "-"));
                                out.print("<td class=\"ETabla\">");
                                out.print(vEti.clsAnclaTexto("EAncla","Detalle","JavaScript:fIrpg070305041('" + Lote.VLote.getiAnio() + "', '" + Lote.VLote.getiCveLaboratorio() + "', '" + Lote.VLote.getiCveSustancia() + "', '" + Lote.VLote.getiCveLoteCuantita() + "', 'pg070305041.jsp');", ""));
                                out.print("</td>");
                                out.print("</tr>");
                             }
                            %>
