...
<!--<SCRIPT LANGUAGE="JavaScript" SRC="C:\sct\MedprevInt\medprev\Archivos\funciones\pg070102020.js"></SCRIPT>-->
                               ...
                               <%
                                 if (lNuevo){
                                   ...
                                   if (request.getParameter("hdiCvePersonal") != null && request.getParameter("hdiCvePersonal").compareTo("") != 0  ) {                                    out.println("<input type='hidden' name='iCvePersonal' value='" + request.getParameter("hdiCvePersonal")  + "'>" );
                                    ...
                                    out.println("<tr>");
                                    out.print(vEti.EtiCampo("EEtiqueta","Licencia:","ECampo","text",10,10,"", vPERDatos.getCLicencia(),0,"","fMayus(this);",false,true,false));
                                    out.println(" <input type='hidden' name='cLicencia' value='" + vPERDatos.getCLicencia() + "'>");
                                    if (vPERDatos.getCLicenciaInt() != null ){
                                    out.print(vEti.EtiCampo("EEtiqueta","Licencia Int.:","ECampo","text",10,10,"",vPERDatos.getCLicenciaInt() ,0,"","fMayus(this);",false,true,false));
                                    out.println(" <input type='hidden' name='cLicenciaInt' value='" + vPERDatos.getCLicenciaInt() + "'>");
                                    }
                                    out.println("</tr>");
                                 ...
                                 // Alta al nuevo Usuario
                                    ...
                                    out.println("<tr>");
                                    out.print(vEti.EtiCampo("EEtiqueta","Licencia:","ECampo","text",12,12,"cLicencia", "",0,"","fMayus(this);",false,true,lCaptura));
                                    out.print(vEti.EtiCampo("EEtiqueta","Licencia Int.:","ECampo","text",10,10,"cLicenciaInt","",0,"","fMayus(this);",false,true,lCaptura));
                                    out.println("</tr>");
                                  ...
                                  if (bs != null){
                                   ...
                                   // if (request.getParameter("hdBoton").compareTo("Modificar") == 0)
                                    ...
                                    out.println("<tr>");
                                    out.print(vEti.EtiCampo("EEtiqueta","Licencia:","ECampo","text",10,10,"cLicencia", bs.getFieldValue("cLicencia","&nbsp;").toString(),0,"","fMayus(this);",false,true,false));
                                    out.print(vEti.EtiCampo("EEtiqueta","Licencia Int.:","ECampo","text",10,10,"cLicenciaInt", bs.getFieldValue("cLicenciaInt","&nbsp;").toString(),0,"","fMayus(this);",false,true,false));
                                    out.println("</tr>");
