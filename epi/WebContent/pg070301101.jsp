...
<html>
<%
  pg070301101CFG  clsConfig = new pg070301101CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setNombrePagina("pg070301101.jsp");                    // modificar
  vEntorno.setArchFuncs("FValida");
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070301101.jsp\" target=\"FRMCuerpo"); // modificar
...
<form method="<%= vEntorno.getMetodoForm() %>" action="<%= vEntorno.getActionForm() %>">
  ...
  <%
     if (bs != null){ // Agregar tanto Hds como variables dependiendo del campo llave.
       ...
       cClave2  = ""+bs.getFieldValue("iCveEmpleoCalib", "");
     }
  %>
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            ...
                            %>
                             ...
                             <tr>
                             <td colspan="2" class="ETablaT">Empleo de Calibradores</td>
                             </tr>
                             ...
                             <%
                               if (lNuevo){ // Modificar de acuerdo al catálogo específico
                                //Este lo muestra cuando es nuevo
                                 ...
                                 out.println("<tr>");
                                 out.print(vEti.EtiCampo("EEtiqueta", "Descripción:", "ECampo", "text", 100, 100, "cDscEmpleoCalib", "", 4, "", "fMayus(this);", true, true, lCaptura));
                                 out.println("</tr>");
                                 out.println("<tr>");
                                 ...
                                 if (bs != null){
                                   out.println("<tr>");
                                   out.print(vEti.EtiCampo("EEtiqueta", "Clave:", "ECampo", "text", 5, 5, "iCveEmpleoCalib", bs.getFieldValue("iCveEmpleoCalib","&nbsp;").toString(), 4, "", "", true, true, false));
                                   out.println("</tr>");
                                   out.println("<tr>");
                                   out.print(vEti.EtiCampo("EEtiqueta", "Descripción:", "ECampo", "text", 100, 100, "cDscEmpleoCalib", bs.getFieldValue("cDscEmpleoCalib","&nbsp;").toString(), 4, "", "fMayus(this);", true, true, lCaptura));
                                   out.println("</tr>");
                                   out.println("<tr>");
