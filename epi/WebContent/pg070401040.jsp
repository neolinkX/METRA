 ...
 * Description: JSP para mostrar el Listado de Situación
 * Copyright: ?
...
<html>
<%
  pg070401040CFG clsConfig=new pg070401040CFG();                      // modificar
  TEntorno       vEntorno =new TEntorno();
  vEntorno.setNumModulo      (07);
  vEntorno.setNombrePagina   ("pg070401040.jsp");                     // modificar
  vEntorno.setArchTooltips   ("07_Tooltips");
  vEntorno.setOnLoad         ("fOnLoad();");
  vEntorno.setArchFuncs      ("FValida");
  vEntorno.setMetodoForm     ("POST");
  vEntorno.setActionForm     ("pg070401040.jsp\" target=\"FRMCuerpo");// modificar
  vEntorno.setUrlLogo        ("Acerca");
  vEntorno.setBtnPrincVisible(true);
  vEntorno.setArchFCatalogo  ("FFiltro");
  vEntorno.setArchAyuda      (vEntorno.getNombrePagina());

  String cCatalogo   ="pg070401041.jsp";               // modificar
...
<SCRIPT LANGUAGE="JavaScript">
  ...
  function fIrCatalogo(iCveSituacion){
    var form=document.forms[0];
    form.hdRowNum.value=iCveSituacion;
    form.hdBoton.value='Actual';
    form.target='FRMDatos';
    form.action='pg070401041.jsp';
    form.submit();
  }
</SCRIPT>
<head>
...
%>    <tr><td>&nbsp;</td></tr>
    <tr><td valign="top">
      <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3">
        <tr class="ETablaT"><td colspan="4">Situaci&oacute;n del Personal</td></tr>
        <tr class="ETablaT">
          <td>Clave</td>
...
<%    if(bs!=null){
        ...
        while(bs.nextRow()){
%>        <tr class="ECampo">
          <td><%=bs.getFieldValue("iCveSituacion","&nbsp;")%></td>
...
%>          <td><a class="EAncla" href="javascript:fIrCatalogo('<%=bs.getFieldValue("iCveSituacion","0")%>')">Detalle</a></td>
<%        }
%>        </tr>
<%      }
      }else{
