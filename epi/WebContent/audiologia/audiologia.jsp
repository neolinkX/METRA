...
session.setAttribute("servicio","68");    /////////////////////////MODIFICAR LA CLAVE DEL SERVICIO (TABLA MEDSERVICIO)/////////////////////////////////////////////
      ...
      <div class="m-portlet__head-caption">
         <div class="m-portlet__head-title">
            <span class="m-portlet__head-icon">
              <img src="<%=vParametros.getPropEspecifica("RutaImgServerExp")%>servicios/audiologia.svg" width="20" class="svg-inject signal-strong">
            </span>
...
<%@ include file="/audiologia/PreguntasAudiologia.jsp"%>
  </div>
