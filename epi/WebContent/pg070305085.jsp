...
<html>
<%
  pg070305085CFG  clsConfig = new pg070305085CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070305085.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070305085.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  String cCveOrdenar  = "EC.iCveLoteCualita|EC.dtEntrega|EC.dtProcesado|EC.dtAutorizado|";  // modificar
  ...
  <tr>
     <td valign="top">
        <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
          ...
          <tr>
             <%
                  out.println(vEti.EtiCampo("EEtiqueta","Lote Presuntivo:", "ETabla\" colspan=\"3","text",4,4,"iCveLoteCualita","",0,"","",true,true, true, request));
             %>
          </tr>
          <tr>
             <%
