<% /**
 * Title:         Registro y Comportamiento de Estandares y Controles para Análisis Presuntivo
 * Description:   Reporte
 * Copyright:     2006
...
<html>
<%
  pg0703060130CFG  clsConfig = new pg0703060130CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg0703060130.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg0703060130.jsp\" target=\"FRMCuerpo"); // modificar
...
<SCRIPT LANGUAGE="JavaScript">
  ...
  function generaXLS(tipo) {
    ...
    if (form.checkEstandar.checked || form.checkControl.checked) {
         lCheck = true;
    } else {
         alert("Seleccione Estandar o Control o ambos");
    }
    ...
    if (lICveLaboratorio == true &&
        ...
        if (tipo == 1) {
            ...
            " <body>"+
            "<form method=\"post\" action=\"servXLSpg0703060130?iCveLaboratorio=" + form.iCveLaboratorio.value + "&dtFechaI=" + form.dtFechaI.value + "&dtFechaF=" + form.dtFechaF.value + "&checkEstandar=" + getCheckValue(form.checkEstandar) + "&checkControl=" + getCheckValue(form.checkControl) + "\"" +
  ...
  <tr>
     ...
     <td valign="top">
        ...
        <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
          <tr><td colspan="8" class="ETablaT">Registro y Comportamiento de Estandares y Controles para An&aacute;lisis Presuntivo</td></tr>
          ...
          <tr><%
           ...
           <tr>
                <%
                    ...
                    out.println("<input type=\"checkbox\" name=\"checkControl\" value=\"1\">Control</td>");
                %>
           </tr>
        </table>
        <!-- ########################## -->
