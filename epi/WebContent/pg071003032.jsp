...
<html>
<%
  pg071003032CFG  clsConfig = new pg071003032CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg071003032.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg071003032.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  String cCveOrdenar  = "iCveArea|cDscArea|";  // modificar
  String cDscFiltrar  = "Clave del Area|Descripción del Area|";    // modificar
  String cCveFiltrar  = "iCveArea|cDscArea|";  // modificar
...
<form method="<%= vEntorno.getMetodoForm() %>" action="<%= vEntorno.getActionForm() %>">
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                              <td colspan="4" class="ETablaT">Asignación de Areas
                              </td>
                ...
                out.print("</select></td>");
                              ...
                              out.print("</tr>");
                                 if (bs != null && request.getParameter("iCveUniMed")!=null && Integer.parseInt(request.getParameter("iCveUniMed"))>0 && request.getParameter("iCveModulo")!=null && Integer.parseInt(request.getParameter("iCveModulo"))>0){
                                   ...
                                   while(bs.nextRow()){
                                     out.print("<tr>");
                                       out.print("<td class='ETablaR'>" + bs.getFieldValue("iCveArea") + "</td>");
                                       out.print("<td class='ETabla'>" + bs.getFieldValue("cDscArea") + "</td>");
                                       ...
                                       if(request.getParameter("iCveUniMed")!=null && request.getParameter("iCveUniMed").compareTo("")!=0 && request.getParameter("iCveModulo")!=null && request.getParameter("iCveModulo").compareTo("")!=0)
                                         vcGRLAreaModulo = dGRLAreaModulo.FindByAll(" where iCveUniMed = " + request.getParameter("iCveUniMed") + " and iCveModulo = " + request.getParameter("iCveModulo") + " and GRLAreaModulo.iCveArea = " + bs.getFieldValue("iCveArea"));
                                       if(vcGRLAreaModulo.size()>0){
                                         vGRLAreaModulo = (TVGRLAreaModulo)vcGRLAreaModulo.get(0);
                                         if(vGRLAreaModulo.getCResponsable()!=null && vGRLAreaModulo.getCResponsable().toString().compareTo("null")!=0){
                                           out.print("<td><input type='text' size='40' MaxLength=100 OnChange='fMayus(this);' name='txt" + iObjeto + "' value='" + vGRLAreaModulo.getCResponsable() + "'></td>");
                                           out.print("<input type='hidden' name='ttxt" + iObjeto + "'>");
                                         }
                                         else{
                                           out.print("<td><input type='text' size='40' MaxLength=100 OnChange='fMayus(this);' name='txt" + iObjeto + "' value=''></td>");
                                           out.print("<input type='hidden' name='ttxt" + iObjeto + "'>");
                                         }
                                         out.print("<td align='center'><input type='checkbox' value='" + bs.getFieldValue("iCveArea") + "' name='chk" + iObjeto + "' checked></td>");
                                       }
                                       else{
                                         out.print("<td><input type='text' size='40' MaxLength=100 OnChange='fMayus(this);' name='txt" + iObjeto + "' ></td>");
                                         out.print("<input type='hidden' name='ttxt" + iObjeto + "'>");
                                         out.print("<td align='center' colspan='2'><input type='checkbox' value='" + bs.getFieldValue("iCveArea") + "' name='chk" + iObjeto + "'></td>");
                                       }
                                       out.print("<input type='hidden' value='" + bs.getFieldValue("iCveArea") + "' name='hdChk" + iObjeto + "'></td>");
                                     out.print("</tr>");
                                     iObjeto++;
                                   }
