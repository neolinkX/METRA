...
<html>
<%
  pg071005020CFG  clsConfig = new pg071005020CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg071005020.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg071005020.jsp\" target=\"FRMCuerpo"); // modificar
  vEntorno.setUrlLogo("Acerca");
  vEntorno.setBtnPrincVisible(true);
  vEntorno.setArchFCatalogo("FFiltro");
  vEntorno.setArchAyuda(vEntorno.getNombrePagina());

  String cDetalle    = "pg071005021.jsp";       // modificar
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
      ...
      <td valign="top">
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                            <tr>
                              <td colspan="6" class="ETablaT">Motivos
                              </td>
                            </tr>
                               <%
                              // modificar según listado
                               if (bs != null){
                                   ...
                                   out.print("<tr>");
                                   out.print("<td class=\"ETablaT\">Clave Motivo</td>");
                                   out.print("<td class=\"ETablaT\">Descripción Motivo</td>");
                                   out.print("<td class=\"ETablaT\">Clave Proceso</td>");
                                   out.print("<td class=\"ETablaT\">Descripción Proceso</td>");
                                   ...
                                   while(bs.nextRow()){
                                     out.print("<tr>");
                                     out.print(vEti.Texto("ETablaR", bs.getFieldValue("iCveMotivo", "&nbsp;").toString()));
                                     out.print(vEti.Texto("ECampo", bs.getFieldValue("cDscMotivo", "&nbsp;").toString()));
                                     out.print(vEti.Texto("ETablaR", bs.getFieldValue("iCveProceso", "&nbsp;").toString()));
                                     out.print(vEti.Texto("ECampo", bs.getFieldValue("cDscProceso", "&nbsp;").toString()));
                                     ...
                                     if(lDetalle){
                                       ...
                                       out.print(vEti.clsAnclaTexto("EAncla","Detalle","JavaScript:fIrDetalle('" + bs.getFieldValue("iCveMotivo") + "');", ""));
                                       out.print("</td>");
                                     }
                                     out.print("</tr>");
                                   }
