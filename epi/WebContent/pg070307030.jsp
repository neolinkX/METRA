...
<html>
<%
  pg070307030CFG  clsConfig = new pg070307030CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070307030.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070307030.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  <tr><td valign="top">
            <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
              ...
              <tr>
                ...
                Vector vcGRLUniMed = vUsuario.getVUniFiltro(Integer.parseInt(vParametros.getPropEspecifica("ToxProcesoLab")));
                out.print("<td>&nbsp;</td>");
                out.print(vEti.Texto("EEtiqueta","Unidad Médica"));
                out.print("<td colspan='3'>");
                out.print(vEti.SelectOneRowSinTD("iCveUniMed","fChg();",vcGRLUniMed,"iCveUniMed","cDscUniMed",request,"",true));
                out.print("</td>");
                  String cUniMed = "";
                  try{
              ...
              <tr>
               <%
                ...
                Vector vcLotes = new Vector();
                vcLotes =dTOXCtrolCalibra.FindByCustomWhere("where iCveLaboratorio = " + cUniMed);
                out.print("<td>&nbsp;</td>");
                out.print(vEti.Texto("EEtiqueta", "Lote:"));
                out.print("<td colspan='3'>");
                out.print(vEti.SelectOneRowSinTD("cLote","",vcLotes,"cLote","cLote",request,"",true));
                out.print("</td>");
                %>
...
/*
              ...
              <tr>
                <%
                out.println("<td>");
                out.println("<input type=\"checkbox\" name=\"lFecha\" value=\"1\" >");
                out.println("</td>");
                %>
                <%out.print(vEti.EtiCampo("EEtiqueta","Fecha Inicio:","ECampo","text",10,10,"dtFechaI","",0,"","",true,true,true,request));%>
                <%out.print(vEti.EtiCampo("EEtiqueta","Fecha Fin:","ECampo","text",10,10,"dtFechaF","",0,"","",true,true,true,request));%>
               </tr>
              <tr>
                <%
                 /*
              ...
              <tr><td colspan="6" align="center">
                <%
                out.print(vEti.clsAnclaTexto("EAncla","Buscar","JavaScript:if(fBuscar());", "Buscar...",""));
                %>
              </td></tr>
            </table>
  </td></tr>
