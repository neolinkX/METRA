...
<html>
<%
  pg070107090CFG  clsConfig = new pg070107090CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070107090.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070107090.jsp\" target=\"FRMCuerpo"); // modificar
...
<script type="text/javascript" src="<%=vParametros.getPropEspecifica("RutaFuncs")%>pg070107090.js"></script>
</head>
