...
<%  
TEntorno    vEntorno3      = new TEntorno();
vEntorno3.setNumModulo(07);
TParametro  vParametros3 = new TParametro(vEntorno3.getNumModuloStr());
    ...
    <div class="modal-dialog modal-lg" role="document" style="max-width: 1200px !important;">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modal_content" style="overflow-y: auto;">
              ...
              <%@ include file='signosVitales2.jsp' %>
              <!-- <%=vParametros3.getPropEspecifica("URL_APP")%>/resultados/somatometria/panel_container.jsp -->
