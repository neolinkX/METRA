...
session.setAttribute("servicio","63");    /////////////////////////MODIFICAR LA CLAVE DEL SERVICIO (TABLA MEDSERVICIO)/////////////////////////////////////////////
      ...
      <div class="m-portlet__head-caption">
         <div class="m-portlet__head-title">
            <span class="m-portlet__head-icon">
              <img src="<%=vParametros.getPropEspecifica("RutaImgServerExp")%>interconsultas/nutricion.svg" width="20" class="svg-inject signal-strong">
            </span>
            <h3 class="m-portlet__head-text m--font-primary">
              EVALUACION NUTRICION NOM 024
            </h3>
         </div>
      </div>
...
<%@ include file="/nutricion_ic/preguntasNutricion_ic.jsp"%>
  </div>
