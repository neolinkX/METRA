...
<%@ page import="gob.sct.medprev.dao.TDEXPExamAplica"%>
    ...
    session.setAttribute("resservicio", "4");
    ...
    %>
  <h2 class="text-center"><img src="<%=vParametros2.getPropEspecifica("URL_APP")%>img/servicios/rayosx.svg" width="25" class="svg-inject signal-strong"> Resultados - 	Servicio de Rayos X</h2>
            ...
            <div class="tab-pane active" id="nuevo_doc_digital" role="tabpanel">
             ...
             <%
              System.out.println("Concluido-="+Concluido);
                  if(Concluido > 0){
                	  %>
  					<%@ include file="res_rayosx_data.jsp"%> 
               <%   }else{
              %>
              <div class="row">
                  ...
                  <div class="m-alert m-alert--outline alert alert-danger alert-dismissible fade show" role="alert">
                      ...
                      <strong>
                        Sin Captura!
                          ...
                          No existe ning&uacute;n registro de Rayos X para este episodio.
                    </div>
                </div>
              </div>
              <%
