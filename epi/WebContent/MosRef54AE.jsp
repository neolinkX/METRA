...
%>                   
                        ...
                        <head>
                            ...
                            <title>AMPUTACI&Oacute;N DE EXTREMIDADES</title>
            ...
            <form name="formulario" method="post" action="MosRef54AE.jsp">
                    ...
                    <input type="hidden" name="iorden" value="<%=request.getParameter("iorden")%>">
                        ...
                        <tr>
                            <td bgcolor="#088A08"><span class="Estilo6">Punto<%=iorden%> de referencia de AMPUTACI&Oacute;N DE EXTREMIDADES</span><br></td>
                        </tr>
                        <tr>
                            <td bgcolor="#FBFBEF">&nbsp;<span class="Estilo5">
                        <img src="<%=vParametros.getPropEspecifica("RutaImgServer")%>AmpExt.jpg" alt="abdomen" name="abdomen" id="abdomen"
...
<%         
      ...
      %>
                ...
                <table width="400" border="1">  
                <tr>
                    <td bgcolor="#088A08"><span class="Estilo6">No existen puntos de referencia de AMPUTACI&Oacute;N DE EXTREMIDADES</span><br></td>
                </tr>
           ...
           <script> 
            ...
            <body bgcolor="" topmargin="0" leftmargin="0" >
                <form name="formulario" method="post" action="MosRef54AE.jsp">
                    ...
                    <table width="400" border="1">
                    <tr>
                        <td bgcolor="#088A08"><span class="Estilo6">Consulta de puntos de referencia de AMPUTACI&Oacute;N DE EXTREMIDADES</span><br></td>
                    </tr>
                    <%
                    for(int i=0;i<resultados.size();i++){
                        vEXPSERVPRef = (TVEXPSERVPRef) resultados.get(i);
