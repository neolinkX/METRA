...
<html>
<%
  pg070403010CFG  clsConfig = new pg070403010CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070403010.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070403010.jsp\" target=\"FRMCuerpo"); // modificar
                                   ...
                                   while(bs.nextRow()){
                                     ...
                                     if(!vAccidentes.isEmpty()){
                                       for(int i=0;i<vAccidentes.size();i++){
                                         ...
                                         if (VINVRegistro.getICveUniMed() == new Integer(bs.getFieldValue("iCveUniMed", "").toString()).intValue()){
