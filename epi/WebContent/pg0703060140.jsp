<% /**
 * Title:         Registro y Comportamiento del Reactivo y Soluciones para Análisis Confirmatorio
 * Description:   Reporte
 * Copyright:     2006
...
<html>
<%
  pg0703060140CFG  clsConfig = new pg0703060140CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg0703060140.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg0703060140.jsp\" target=\"FRMCuerpo"); // modificar
...
<SCRIPT LANGUAGE="JavaScript">
  ...
  function generaXLS(tipo) {
    ...
    if (form.checkSolucion.checked || form.checkReactivo.checked) {
         lCheck = true;
    } else {
         alert("Seleccione Solucion o Reactivo o ambos");
    }
    ...
    if (lICveLaboratorio == true &&
        ...
        if (tipo == 1) {
            ...
            " <body>"+
            "<form method=\"post\" action=\"servXLSpg0703060140?iCveLaboratorio=" + form.iCveLaboratorio.value + "&dtFechaI=" + form.dtFechaI.value + "&dtFechaF=" + form.dtFechaF.value + "&checkSolucion=" + getCheckValue(form.checkSolucion) + "&checkReactivo=" + getCheckValue(form.checkReactivo) + "\"" +
  ...
  <tr>
     ...
     <td valign="top">
        ...
        <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
          <tr><td colspan="8" class="ETablaT">Registro y Comportamiento del Reactivo y Soluciones para An&aacute;lisis Confirmatorio</td></tr>
          ...
          <tr><%
           ...
           <tr>
                <%
                    ...
                    out.println("<td class=\"ETabla\"><input type=\"checkbox\" name=\"checkSolucion\" value=\"1\">Solucion");
                    out.println("<input type=\"checkbox\" name=\"checkReactivo\" value=\"1\">Reactivo</td>");
                %>
           </tr>
        </table>
        <!-- ########################## -->
