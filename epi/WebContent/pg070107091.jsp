...
<html>
<%
  pg070107091CFG  clsConfig = new pg070107091CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070107091.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070107091.jsp\" target=\"FRMCuerpo"); // modificar
...
//  String cEstatusIR   = "Imprimir";            // modificar
  ...
  ///Comprobando y cargando usuarios faltantes en medprev
  clsConfig.CombpruebaUsuarios();
...
<link rel="stylesheet" type="text/css" href="./extjs/resources/css/Ingresos.css" >
...
<script type='text/javascript' src='./dwr/interface/MedPredDwr.js'></script>
<script type='text/javascript' src='./dwr/interface/AdmonUsuarios.js'></script>
...
<script type="text/javascript" src="<%=vParametros.getPropEspecifica("RutaFuncs")%>pg070107091.js"></script>
</head>
...
<body bgcolor="<%= vParametros.getPropEspecifica("ColorFondoPagina") %>" topmargin="0" leftmargin="0" onLoad="<%= vEntorno.getOnLoad() %>">
  ...
  <input type="hidden" name="iCvePersonal" value="<%=((TVUsuario)request.getSession(true).getAttribute("UsrID")).getICveusuario()%>">
