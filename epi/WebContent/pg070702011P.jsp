  ...
  if (request.getParameter("opc") != null){
     ...
     switch(new Integer(request.getParameter("opc")).intValue()) {
        case 1:
              ...
              String cFiltro = " WHERE VEHModelo.iCveMarca = " + request.getParameter("val1");
              ...
              if (vModelo.size()>0){
                 ...
                 for (int i = 0; i < vModelo.size(); i++){
                    j = j + 1;
                    vVEHModelo = (TVVEHModelo)vModelo.get(i);
                    out.println("i=form." + ObjetoDes + ".length + 1;");
                    out.println("form." + ObjetoDes + ".length=i;");
                    out.println("form." + ObjetoDes + "[" + j  + "].text=" + "\"" + vVEHModelo.getCDscBreve() + "\"" +";");
                    out.println("form." + ObjetoDes + "[" + j + "].value="+ "\"" + vVEHModelo.getICveModelo() + "\"" +";");
                 }
              }else{
                 out.println("form." + ObjetoDes + ".length=1;");
