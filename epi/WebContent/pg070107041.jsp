...
<html>
<%
  pg070107041CFG  clsConfig = new pg070107041CFG();               // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setNombrePagina("pg070107041.jsp");                    // modificar
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setArchFuncs("FValida");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg070107041.jsp\" target=\"FRMCuerpo"); // modificar
...
function Migrar(Expediente1, Examen1){
                var r=confirm("¡La información después de eliminar el expediente se perderá! \n ¿Estás seguro que deseas eliminar el expediente?");
                if(r==true){
                	var  macAddress = "";
                	var ipAddress = "";
                	var computerName = "";
...
%>    <tr><td>&nbsp;</td></tr>
    <tr><td valign="top">
      <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="4">
       <tr>
          <td colspan="5" class="ETablaT">ELIMINACIÓN DE EXPEDIENTE</td>
        </tr>

        <tr>
          <td class="EEtiqueta"><div align="center">Expediente:</div></td>
...
<table border=1  class="ETablaInfo" align="center" cellspacing="0" cellpadding="3">
                 <td colspan="5" class="ETablaT">Informaci&oacute;n del Expediente </td>
             <tr>
	     ...
	     <tr>
             ...
             <tr>
               <td colspan="5" class="EEtiqueta"><div align="center"><a class="EAnclaC" name="Buscar" href="javascript:Migrar(Expediente1=<%=vPerDatos.getICveExpediente()%>,Examen1 = <%=vPerDatos.getINumExamen()%>);">Eliminar Expediente</a></div></td>
             </tr>
             <%}else{
                        if(request.getParameter("hdBoton").equals("Migrar")){
                                Resultado = clsConfig.MigrandoExp(vPerDatos.getICveExpediente(), vPerDatos.getINumExamen());
                                %>
...
%>
    <table border=1  class="ETablaInfo" align="center" cellspacing="0" cellpadding="3">
                 <td width="370" class="ETablaT">Informaci&oacute;n de Expediente </td>
		 <tr>
