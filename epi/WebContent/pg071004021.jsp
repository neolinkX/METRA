...
<html>
<%
  pg071004021CFG  clsConfig = new pg071004021CFG();                 // modificar

  TEntorno    vEntorno      = new TEntorno();
  vEntorno.setNumModulo(07);
  vEntorno.setOnLoad("fOnLoad();");
  vEntorno.setNombrePagina("pg071004021.jsp");                    // modificar
  vEntorno.setArchFuncs("FValida");
  vEntorno.setArchTooltips("07_Tooltips");
  vEntorno.setMetodoForm("POST");
  vEntorno.setActionForm("pg071004021.jsp\" target=\"FRMCuerpo"); // modificar
  ...
  String cCveOrdenar  = "iCveCategoria|cDscCategoria|";  // modificar
  String cDscFiltrar  = "Clave|Descripción|";    // modificar
  String cCveFiltrar  = "iCveCategoria|cDscCategoria|";  // modificar
...
<script language="JavaScript">
  ...
  //  al directorio funciones de wwwrooting en un archivo con extensión js (vg. pg071004021.js)
...
<form method="<%= vEntorno.getMetodoForm() %>" action="<%= vEntorno.getActionForm() %>">
  ...
  <%
     if (bs != null){ // Agregar tanto Hds como variables dependiendo del campo llave.
       ...
       cClave  = ""+bs.getFieldValue("iCveCategoria", "");
     }
  %>
  ...
  <tr><td><input type="hidden" name="hdBoton" value="">
                          ...
                          <table border="1" class="ETablaInfo" align="center" cellspacing="0" cellpadding="3"><% // Inicio de Datos %>
                              <td colspan="6" class="ETablaT">Categoría
                              </td>
            ...
            <tr>
              ...
              out.print("</tr>");
                               ...
                               if (lNuevo){ // Modificar de acuerdo al catálogo específico
                                 ...
                                 out.println("<tr>");
                                 out.print(vEti.EtiCampo("EEtiqueta", "Descripción:", "ECampo", "text", 50, 100, "cDscCategoria", "", 3, "", "fMayus(this);", true, true, lCaptura));
                                 out.println("</tr>");
                                 ...
                                 out.println("<tr>");
                                 out.print(vEti.Texto("EEtiqueta", "Reexpedición:"));
                                 out.print("<td>");
                                 out.print("<input type='text' size=2 maxlength=2 name='iTmpoReexp' CHECKED>");
                                 out.print("</td>");
                                 out.println("</tr>");
                                 ...
                                 if (bs != null){
                                   out.println("<tr>");
                                   out.print(vEti.EtiCampo("EEtiqueta", "Clave:", "ECampo", "text", 4, 4, "iCveCategoria", ""+bs.getFieldValue("iCveCategoria", "&nbsp;"), 3, "", "", true, true, false));
                                   out.println("</tr>");
                                   out.println("<tr>");
                                   out.print(vEti.EtiCampo("EEtiqueta", "Descripción:", "ECampo", "text", 50, 100, "cDscCategoria", ""+bs.getFieldValue("cDscCategoria", "&nbsp;"), 3, "", "fMayus(this);", true, true, lCaptura));
                                   out.println("</tr>");
                                   out.println("<tr>");
                                   ...
                                   out.println("<tr>");
                                   out.print(vEti.EtiCampo("EEtiqueta", "Reexpedición:", "ECampo", "text", 2, 2, "iTmpoReexp", bs.getFieldValue("iTmpoReexp", "0").toString(), 3, "", "", true, true, lCaptura));
                                   out.println("</tr>");
