...
/**
 * Definici�n de objetos HTML con caracter�sticas generales.
 * <p>
...
public class TEtiCampoR {
	...
	/**
	 * Constructor por omisi�n uso: new TEtiCampo()
	 */
	public TEtiCampoR() {
	}
	...
	private void Etiqueta(String cEstiloE, String cEtiqueta) {
		sbRes.append("<td  colspan=\"3\" class=\"" + cEstiloE + "\">"
				+ cEtiqueta + "</td>\n");
	}
	...
	private void Etiqueta2(String cEstiloE, String cEtiqueta) {
		sbRes.append("<td  colspan=\"1\" class=\"" + cEstiloE + "\">"
				+ cEtiqueta + "</td>\n");
	}
	...
	private void Etiqueta4(String cEstiloE, String cEtiqueta) {
		sbRes.append("<td  colspan=\"4\" class=\"" + cEstiloE + "\">"
				+ cEtiqueta + "</td>\n");
	}
	 ...
	 * campo con las caracter�sticas proporcionadas.
	 * 
	 * @param cEstiloC
	 ...
	 * @param iMaxLen
	 *            N�mero m�ximo de caracteres que se permitir� de captura en un
	 *            campo.
	 * @param cName
	 ...
	 * @param iTooltip
	 *            N�mero de tooltip que le corresponde del archivo.
	 * @param cOnChange
	 *            Funci�n de JavaScript que se ejecutar� cuando el campo cambie
	 *            de valor.
	 * @param cOnBlur
	 *            Funci�n de JavaScript que se ejecutar� cuando se abandone el
	 *            campo.
	 ...
	 * el objeto textarea de HTML con las caracter�sticas proporcionadas en los
	 * parametros.
	 * 
	 * @param cEstiloC
	 *            Estilo que se asignara a la celda del campo.
	 * @param iCol
	 *            N�mero de columnas que tendr� el textarea como propiedad.
	 * @param iReng
	 *            N�mero de renglones que tendr� el textarea como propiedad.
	 * @param cName
	 ...
	 *            N�mero de tooltip que le corresponde del archivo.
	 * @param cOnChange
	 *            Funci�n de JavaScript que se ejecutar� cuando el objeto cambie
	 *            de valor.
	 * @param cOnBlur
	 *            Funci�n de JavaScript que se ejecutar� cuando se abandone el
	 *            objeto.
	 ...
	 *            N�mero de renglones que tendr� el textarea como propiedad.
	 * @param iSpan
	 *            N�mero de espacios para darle formato dentro de una tabla.
	 * @param cName
	 *            Nombre del objeto HTML para su uso en JavaScript.
	 * @param cValue
	 *            Valor inicial del textarea para su despliegue.
	 ...
	 * @param cTexto
	 *            Texto que se desplegar� en la celda.
	 ...
	 * @return Texto generado por el Metodo Etiqueta.
	 */
	public StringBuffer Texto4(String cEstiloE, String cTexto) {
		sbRes = new StringBuffer("");
		this.Etiqueta4(cEstiloE, cTexto);
		return sbRes;
	}
	 ...
	 *            Estilo que se asignara a la celda de la etiqueta.
	 * @param cEtiqueta
	 *            Etiqueta que se desplegar� en la celda de etiqueta.
	 * @param cEstiloC
	 *            Estilo que se asignara a la celda del campo.
	 * @param cTipo
	 ...
	 * @param iMaxLen
	 *            M�ximo n�mero de caracteres que se permitir� capturar en este
	 *            campo.
	 * @param cName
	 *            Nombre del objeto HTML, mismo que se emplear� en JavaScript y
	 *            proceso de formularios
	 * @param cValue
	 *            Valor inicial que se le dar� al campo.
	 * @param iTooltip
	 *            N�mero de tooltip que le corresponde del archivo.
	 * @param cOnChange
	 *            Funci�n de JavaScript que se desea ejecutar cuando cambie el
	 *            valor del campo.
	 * @param cOnBlur
	 *            Funci�n de JavaScript que se desea ejecutar al abandonar el
	 *            campo.
	 * @param lSelectonFocus
	 ...
	 * @param cOnClick
	 *            Funci�n de JavaScript que se ejecutar� cuando el usuario haga
	 *            click con el mouse.
	 * @param iTooltip
	 *            N�mero de tooltip que le corresponde del archivo.
	 * @param lCampo
	 ...
	 * @param cValTrue
	 *            Indica el valor que se desplegar� en caso de no ser campo con
	 ...
	 *            campo.
	 * @param cValTrue
	 *            Cadena que se desplegar� en caso de ser un valor 1
	 *            (verdadero).
	 * @param cValFalse
	 *            Cadena que se desplegar� en caso de ser un valor 0 (falso).
	 * @return Cadena que se debe desplegar en el JSP, correspondiente a dos
	 *         celdas.
	 */
	 ...
	 * @param cEtiqueta
	 *            Etiqueta que se desplegar� para que el usuario (texto entre
	 *            <A> y </A>.
	 * @param cRef
	 ...
	 * @param iCol
	 *            N�mero de columnas que emplear� el �rea de texto.
	 * @param iReng
	 *            N�mero de renglones que emplear� el �rea de texto.
	 * @param cName
	 ...
	 *            N�mero de tooltip que le corresponde del archivo.
	 * @param cOnChange
	 *            Funci�n de JavaScript que se ejecutar� cuando se cambie el
	 *            valor del campo.
	 * @param cOnBlur
	 *            Funci�n de JavaScript que se ejecutar� cuando se abandone el
	 *            campo.
	 ...
	 * 
	 * @param cEstiloC
	 *            Nombre del estilo que se dar� a la celda.
	 * @param cNombre
	 *            Nombre que se dar� al objeto de HTML.
	 * @param cOnChange
	 ...
	 * @param cCampoDsc
	 *            Nombre del campo descripci�n para extraer el valor a desplegar
	 *            en la secci�n option del select.
	 * @param HttpServletRequest
	 * @return Valor por omisi�n del Select.
	 */
	 ...
	 *            secci�n value del select.
	 * @param cValActual
	 *            Valor que se desea tener por omisi�n seleccionado en el objeto
	 *            select.
	 * @param vCampoDsc
	 *            Vector con los nombres de campos descripci�n para extraer el
	 ...
	 *            adelante.
	 * @return Cadena que se desplegar� en el JSP, correspondiente al HTML del
	 *         select.
	 */
	 ...
	 * 
	 * @param cEstiloC
	 *            Nombre del estilo que se dar� a la celda del despliegue.
	 * @param cNombre
	 ...
	 * @param cTexto
	 *            Indica el texto que se ver� asociado al radio.
	 * @param cSelected
	 ...
	 *            click con el mouse.
	 * @param cOnBlur
	 *            Funci�n de JavaScript que se ejecutar� cuando el usuario salga
	 *            del objeto.
	 * @param cOnFocus
	 *            Funci�n de JavaScript que se ejecutar� cuando el foco llegue
	 *            al objeto.
	 * @param iTooltip
	 *            N�mero de tooltip que le corresponde del archivo.
	 * @param lCampo
	 ...
	 * 
	 * @param cEstiloE
	 *            Nombre del estilo que se dar� a la celda de la etiqueta.
	 * @param cEtiqueta
	 *            Tecto que tendr� la etiqueta.
	 * @param cEstiloC
	 ...
	 * @param cEstiloC
	 *            Nombre del estilo que se dar� a la celda del select.
	 * @param cNombre
	 *            Nombre que se dar� al objeto tipo select de HTML.
	 * @param cValue
	 ...
	 * @param cOmision
	 *            Valor por omisi�n del Select en caso de no encontrarlo en el
	 *            request.
	 * @param lActivo
