...
public class DigitalizarDocumentoServiceLocator extends
		org.apache.axis.client.Service implements
		gob.sct.documentos.DigitalizarDocumentoService {
	...
	public DigitalizarDocumentoServiceLocator(java.lang.String wsdlLoc,
	...
	// private java.lang.String DigitalizarDocumentoSoapPort_address =
	// "http://10.33.169.117:7001/Documentos/DigitalizarDocumento";
	// private java.lang.String DigitalizarDocumentoSoapPort_address =
	// "http://10.33.141.252:7010/Documentos/DigitalizarDocumento";
	...
	public void setDigitalizarDocumentoSoapPortWSDDServiceName(
			java.lang.String name) {
		DigitalizarDocumentoSoapPortWSDDServiceName = name;
	}

	public gob.sct.documentos.DigitalizarDocumento getDigitalizarDocumentoSoapPort()
			throws javax.xml.rpc.ServiceException {
	...
	public gob.sct.documentos.DigitalizarDocumento getDigitalizarDocumentoSoapPort(
		...
		try {
			gob.sct.documentos.DigitalizarDocumentoServiceSoapBindingStub _stub = new gob.sct.documentos.DigitalizarDocumentoServiceSoapBindingStub(
					portAddress, this);
	...
	public void setDigitalizarDocumentoSoapPortEndpointAddress(
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (gob.sct.documentos.DigitalizarDocumento.class
					.isAssignableFrom(serviceEndpointInterface)) {
				gob.sct.documentos.DigitalizarDocumentoServiceSoapBindingStub _stub = new gob.sct.documentos.DigitalizarDocumentoServiceSoapBindingStub(
						new java.net.URL(DigitalizarDocumentoSoapPort_address),
						this);
				_stub.setPortName(getDigitalizarDocumentoSoapPortWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://gob/sct/documentos",
				"DigitalizarDocumentoService");
	}
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName(
					"http://gob/sct/documentos", "DigitalizarDocumentoSoapPort"));
		}
