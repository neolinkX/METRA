 ...
 * @version 1.0
 */
public class TVGRLCONVIGSINT implements HashBeanInterface {
	private BeanPK pk;
	...
	private int iCveReglaVigencia;
	private int iCveJerarquia;
	...
	public HashMap toHashMap() {
		...
		hmfieldsTable.put("iCveReglaVigencia", "" + iCveReglaVigencia);
		hmfieldsTable.put("iCveJerarquia", "" + iCveJerarquia);
	...
	public int getICveReglaVigencia() {
		return iCveReglaVigencia;
	}

	public void setICveReglaVigencia(int iCveReglaVigencia) {
		this.iCveReglaVigencia = iCveReglaVigencia;
	}
	
	public void setICveJerarquia(int iCveJerarquia) {
		this.iCveJerarquia = iCveJerarquia;
	}

	public int getICveJerarquia() {
		return iCveSintoma;
	}
