 ...
 * @author <dd>AG SA
 */
public class pg070201012CFG extends CFGListBase2 {
	...
	public void Guardar() {
		...
		/*
		 * la funcionalidad original de este Método se ha cambiado para tomar
		 * la acci�n pertinente, seg�n las condiciones definidas en la regla
		 * de negocios durante la ejecuci�n del Método getTableValues().
		 */
	 ...
	 * <p>
	 * El Método hace una b�squeda en la tabla correspondiente al tipo de
	...
	/**
	 * Método que eval�a los par�metros recibidos y asigna cadenas vac�as
	 * en caso de ser null.
	 * 
	 * @author Romeo S�nchez
	 */
	...
	/**
	 * Método que busca los datos b�sicos del personal especificado. El
	...
	/**
	 * Método que devuelve todos los m�dulos correspondientes a la unidad
	...
	/**
	 * Método que devuelve todos los m�dulos correspondientes a la unidad
	 * m�dica indicada en el par�metro que recibe el Método.
	 * 
	 * @return un Vector con los m�dulos
	 */
	...
	/**
	 * Método que devuelve la descripci�n correspondiente al n�mero de
	 * proceso.
	 * 
	 * @param param
	...
	/**
	 * Método que convierte la colecci�n de servicios recibida como HashMap
	 * en un Vector
	 * 
	 * @param hm
	...
	private int getTableValues() {
		...
		while (stToken.hasMoreTokens()) {
			...
			String[] ccaracter2 = request.getParameterValues("cCaracter_"
					+ cTemp);
			int count = 0;
			...
			case SI_NO:
				...
				System.out.println("llogico "+llogico);
				
					if(cTemp.equals("987") && llogico.equals("0")){
						if(request.getParameter("hdUsaLentes").equals("3")){
							System.out.println("Regla Lentes");
							v.setDValorIni(3);
						}
					}
	 ...
	 * //Regresa Motivo
	 */
	public String getNegativaExamen() {
		TDEXPExamAplica dEXPExamAplica = new TDEXPExamAplica();
