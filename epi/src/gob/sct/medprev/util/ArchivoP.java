 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class ArchivoP extends Dictamen {
	...
	public ArchivoP() {
		try {
			report = (JasperReport) JRLoader
					.loadObjectFromLocation("gob/sct/medprev/util/ArchivoP.jasper");
		} catch (JRException e) {
	 ...
	 *            The A�olec to set.
	 */
	public void setAnolec(String anolec) {

		if (anolec == null) {
			anolec = "";
		}
		parametros.put("anolec", anolec);
	}
	 ...
	 *            The A�olec to set.
	 */
	public void setNidum(String nidum) {

		if (nidum == null) {
			nidum = "";
		}
		parametros.put("nidum", nidum);
	}
