...
public class AdministradorContenidosServletJuridico extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	//private TParametro VParametros = new TParametro("7");
	private TParametro  VParametros = new TParametro("42");
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String NombreDocumento = ""+wrapper.getParameter("cnombredoc");
		String PathDocumento = VParametros.getPropEspecifica("RutaDOCS")+""+wrapper.getParameter("cnombredoc");
		System.out.println(NombreDocumento);
		System.out.println(VParametros.getPropEspecifica("RutaDOCS"));
		File archivo = File.createTempFile(NombreDocumento, ".pdf", new File(VParametros.getPropEspecifica("RutaDOCS")));
		...
		try {
			try {
				...
				//File.writeByteArrayToFile(new File(PathDocumento), fileItem.getContentType());
				try {
	...
	public void guardaReferenciaArchivo(int idArchivo, FileUploadWrapper wrapper) {
		DBObject db = new DBObject();
