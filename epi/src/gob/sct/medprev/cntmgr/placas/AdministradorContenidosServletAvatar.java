...
public class AdministradorContenidosServletAvatar extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println(VParametros.getPropEspecifica("RutaNASAvatar")+"myfile");
		System.out.println("archivo ="+request.getParameter("archivo"));
		
		//File archivo = File.createTempFile("myfile", ".tmp");
		File archivo = File.createTempFile("myfile", ".tmp", new File(VParametros.getPropEspecifica("RutaNASAvatar")));
		...
		AdministradorContenidosAvatar content = new AdministradorContenidosAvatar();
