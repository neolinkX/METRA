 ...
 */
public class pg070105021CFG extends CFGListBase2 {
	public pg070105021CFG() {
	...
	public void fillVector() {
		try {
			vDespliega = new TDEXPResultado()
					.FindResultadoServicioRama(getParameters());
	...
	public HashMap getParameters() {
		...
		cTmp = request.getParameter("hdICveServicio");
		hmTmp.put("iCveServicio", cTmp != null ? cTmp : "0");
		return hmTmp;
	}
