...
public class pg070802062CFG extends CFGListBase2 {
	int iCveSistema = 07;
	...
	public void fillVector() {
		...
		if (!articulo.equals("0") && !articulo.equals("")) {
			try {
		...
		if (!articulo.equals("0") && !articulo.equals("") && ivFamilia != 0
			...
			if (!cCondicion.equals("")) {
				cCondicion = " where iCveAlmacen = " + ivAlmacen + " and "
						+ cCondicion + " and iCveArticulo = " + articulo + " ";
			} else {
				cCondicion = " where iCveAlmacen = " + ivAlmacen
						+ " and iCveArticulo = " + articulo + " ";
			}
			// Orden
			...
			try {
				vDespliega = DALMLote.FindByAll(cCondicion);
			} catch (Exception e) {
