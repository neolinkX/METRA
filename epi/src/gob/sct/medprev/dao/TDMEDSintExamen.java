...
/**
 * <p>
 * Title: Data Acces Object de MEDSintExamen DAO
 * </p>
 * <p>
...
public class TDMEDSintExamen extends DAOBase {
	private TParametro VParametros = new TParametro("07");
	private String dataSourceName = VParametros
			.getPropEspecifica("ConDBModulo");

	public TDMEDSintExamen() {
	}
	...
	public Vector FindByAll(String cWhere) throws DAOException {
		...
		try {
			...
			cSQL = " select " + " iCveProceso,  " + " iCveMotivo,   "
					...
					+ " iCveMdoTrans  " + " from MEDSintExamen " + cWhere + " ";
	...
	public Vector FindDSerRama(String cWhere) throws DAOException {
		...
		try {
			...
			int count;
			cSQL = "select "
					+ "distinct(MEDSintExamen.iCveServicio), "
					+ "MEDSintExamen.iCveRama,  "
					+ "MEDSintExamen.iCveProceso "
					+ "from MEDSintExamen "
					+ "join MEDRama on MEDRama.iCveServicio = MEDSintExamen.iCveServicio "
					+ "and MEDRama.iCveRama = MEDSintExamen.iCveRama "
	 ...
	 * Metodo FindDSerRama
	 */
	public Vector FindDSerRamaTMP(String cWhere) throws DAOException {
		DbConnection dbConn = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
	...
	public Object delete(Connection conGral, Object obj) throws DAOException {
		...
		try {
			...
			conn.setAutoCommit(false);
			conn.setTransactionIsolation(2);
			cSQL = " delete from MEDSintExamen "
					+ " where iCveProceso = ?     "
					+ "   and iCveMotivo = ?      "
					+ "   and iCveServicio= ?     "
					+ "   and iCveRama = ?        "
			...
			try {
				...
				warn("delete.closeMEDSintExamen", ex2);
			}
			return cClave;
		}
	}
	...
	public Object insert(Connection conGral, Object obj) throws DAOException {
		...
		try {
			...
			conn.setAutoCommit(false);
			conn.setTransactionIsolation(2);
			cSQL = " insert into MEDSintExamen( " + " iCveProceso, "
	...
	public Vector FindAllExam2(StringBuffer cWhere) throws DAOException {
		...
		try {
			...
			cSQL = "select distinct(S.iCveSintoma), SN.iCveRama, SN.iCveServicio, SN.cValRef "
			 ...
			 //System.out.println("FindAllExam2 = "+cSQL);
			pstmt = conn.prepareStatement(cSQL);
			rset = pstmt.executeQuery();
			while (rset.next()) {
				vMEDSintExamen = new TVMEDSintExamen();
	 ...
	 * Metodo FindAllExam
	 */
	public int FindAllExam2Count(StringBuffer cWhere) throws DAOException {
		DbConnection dbConn = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		...
		try {
			...
			conn.setTransactionIsolation(2);
			int count;
			cSQL = "select count((S.iCveSintoma)) "
					+ "from MEDSintExamenTMP S "
					+ "inner join MEDServicio SR on SR.iCveServicio = S.iCveServicio "
					+ "                    and SR.lActivo = 1 "
					+ "inner join MEDRama R on R.iCveServicio = S.iCveServicio "
			...
			//System.out.println("FindAllExam2Count = "+cSQL);
			pstmt = conn.prepareStatement(cSQL);
			rset = pstmt.executeQuery();
			while (rset.next()) {
	 ...
	 * Metodo FindAllExam
	 */
	public int FindAllExam3Count(StringBuffer cWhere) throws DAOException {
		DbConnection dbConn = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		...
		try {
			...
			conn.setTransactionIsolation(2);
			int count;
			cSQL = "Select Count(icvesintoma) from (" 
					+ "select S.icveservicio, s.icverama, S.iCveSintoma "
					+ "from MEDSintExamenTMP S "
					+ "inner join MEDServicio SR on SR.iCveServicio = S.iCveServicio "
					+ "                    and SR.lActivo = 1 "
					+ "inner join MEDRama R on R.iCveServicio = S.iCveServicio "
					...
					+ "                       and SN.iCveSintoma  = S.iCveSintoma "
					+ "                       and SN.lActivo      = 1 "
					+ cWhere+" group by  S.iCveSintoma, S.icveservicio, s.icverama)";

			//System.out.println("FindAllExam3Count = "+cSQL);
			pstmt = conn.prepareStatement(cSQL);
			rset = pstmt.executeQuery();
			while (rset.next()) {
				Regresa = rset.getInt(1);
	...
	public Vector FindAllServ2(StringBuffer cWhere) throws DAOException {
		...
		try {
			...
			cSQL = "select distinct(SN.iCveServicio) "
					...
					+ "                       and SN.lActivo      = 1 "
					+ cWhere;
			// System.out.println("FindAllServ2 = "+cSQL);
			pstmt = conn.prepareStatement(cSQL);
			rset = pstmt.executeQuery();
			while (rset.next()) {
				vMEDSintExamen = new TVMEDSintExamen();
	 ...
	 * Metodo FindAllServ
	 */
	public int FindAllServ2Count(StringBuffer cWhere) throws DAOException {
		DbConnection dbConn = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		...
		try {
			...
			conn.setTransactionIsolation(2);
			int count;
			cSQL = "select count(distinct(SN.iCveServicio)) "
					+ "from MEDSintExamenTMP S "
					+ "inner join MEDServicio SR on SR.iCveServicio = S.iCveServicio "
					+ "                    and SR.lActivo = 1 "
					+ "inner join MEDRama R on R.iCveServicio = S.iCveServicio "
					...
					+ "                       and SN.lActivo      = 1 "
					+ cWhere;
			// System.out.println("FindAllServ2Count = "+cSQL);
			pstmt = conn.prepareStatement(cSQL);
			rset = pstmt.executeQuery();
			while (rset.next()) {
				Regresa = rset.getInt(1);
	...
	public Vector FindAllRama2(StringBuffer cWhere) throws DAOException {
		...
		try {
			...
			cSQL = "select distinct(SN.iCveRama), SN.iCveServicio "
					...
					+ "                       and SN.lActivo      = 1 "
					+ cWhere;
			// System.out.println("FindAllRama2="+cSQL);
			pstmt = conn.prepareStatement(cSQL);
			rset = pstmt.executeQuery();
			while (rset.next()) {
				vMEDSintExamen = new TVMEDSintExamen();
	 ...
	 * Metodo FindAllRama
	 */
	public int FindAllRama2Count(StringBuffer cWhere) throws DAOException {
		DbConnection dbConn = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		...
		try {
			...
			cSQL = "select distinct(SN.iCveRama), SN.iCveServicio "
					...
					+ "                       and SN.lActivo      = 1 "
					+ cWhere;
			// System.out.println("FindAllRama2Count="+cSQL);
			pstmt = conn.prepareStatement(cSQL);
			rset = pstmt.executeQuery();
			while (rset.next()) {
				Regresa++;
