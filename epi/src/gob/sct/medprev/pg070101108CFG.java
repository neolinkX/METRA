 ...
 * @author <dd>AG SA
 *         <p>
 *         <img src='pg070101108CFG.png'>
 */
public class pg070101108CFG extends CFGCatBase2 {
	int iCveRama = 0;
	int iCveServicio = 0;

	public pg070101108CFG() {
	...
	public void Guardar() {
		...
		try {
			cClave = (String) dMEDREGSIN.insert2(null, this.getInputs());
			// cAccion = "Ultimo";
		} catch (Exception ex) {
	...
	public Object getInputs() throws CFGException {
		...
		try {
			...
			// System.out.println("dictamen ="
			// +request.getParameter("SintomaDep2"));
			cCampo = "" + request.getParameter("SintomaDep2");
			if (cCampo.compareTo("null") != 0 && cCampo.compareTo("") != 0) {
				iCampo = Integer.parseInt(cCampo, 10);
			} else {
				iCampo = 0;
			}
			vMEDREGSIN.setSintomaDep(iCampo);
