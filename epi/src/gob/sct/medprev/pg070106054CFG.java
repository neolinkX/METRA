 ...
 */
public class pg070106054CFG extends CFGListBase2 {
	public pg070106054CFG() {
	 ...
	 * Metodo findExpediente
	 */
	public Vector findExamenToReglas() {
		Vector vEXPRegSin = new Vector();
		try {
			String cExpediente = ""+request.getParameter("iCveExpediente");
			String cInumExamen = ""+request.getParameter("iNumExamen");
			vEXPRegSin = new TDEXPRegSint().FindByAllRegSin(cExpediente, cInumExamen);
		} catch (Exception ex) {
			error("findUser", ex); 
		}
		return vEXPRegSin;
