...
/**
 * * Clase de configuracion para Generales - Puestos
 * <p>
 ...
 */
public class pg071004041CFG extends CFGCatBase2 {
	public pg071004041CFG() {
	...
	public Object getInputs() throws CFGException {
		...
		try {
			...
			vGRLPuesto.setICveModoTrans(iCampo);
			...
			vGRLPuesto.setICveCategoria(iCampo);
			...
			vGRLPuesto.setICvePuesto(iCampo);

			cCampo = "" + request.getParameter("cDscPuesto");
			if (cCampo.compareTo("null") == 0) {
				cCampo = "";
			}
			vGRLPuesto.setCDscPuesto(cCampo);
			...
			vGRLPuesto.setLActivo(iCampo);

			cCampo = "" + request.getParameter("iEdadMinima");
			if (cCampo.compareTo("null") != 0 && cCampo.compareTo("") != 0) {
				iCampo = Integer.parseInt(cCampo, 10);
			}
			vGRLPuesto.setIEdadMinima(iCampo);
			/*
			 * cCampo = "" + request.getParameter("iCveGrupo"); if
			 * (cCampo.compareTo("null") == 0) { iCampo =
			 * Integer.parseInt(cCampo,10); } else iCampo = 1;
			 */
			vGRLPuesto.setICveGrupo(1);
