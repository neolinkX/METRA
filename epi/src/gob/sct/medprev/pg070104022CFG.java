...
/* @author AG SA
 * <p>
 * @see <small><a href="JavaScript:alert('Consulte los archivos:\n-pg070104020.jsp.jsp');">Click para lista de JSP's</a></small>
 * </dd>
 * <p></p><dt><strong>Diagrama de Clase:</strong>
 * <p><img src='pg070104022.jsp.png'>
 */
public class pg070104022CFG extends CFGListBase2 {
	...
	public pg070104022CFG() {
		this.vParametros = new TParametro("07");
		// cPaginas = "pg070104023.jsp"; // Ir a...
	}

	public void fillVector() {
		System.out.println("ejecutando fillVector");
		log("fillVector()");
	...
	public String getProceso(String param) {
		...
		try {
			...
			error("Error al convertir el número de proceso", ex);
		}
		String proceso = "";
